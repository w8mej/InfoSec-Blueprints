...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mitmAP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mitmAP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001394", label="Incident ID", disabled=True)
