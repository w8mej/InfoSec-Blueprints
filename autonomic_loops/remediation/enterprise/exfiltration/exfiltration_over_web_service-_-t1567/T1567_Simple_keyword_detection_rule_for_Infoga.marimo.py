...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Infoga
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Infoga tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006108", label="Incident ID", disabled=True)
