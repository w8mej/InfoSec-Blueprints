...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PyExfil
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PyExfil tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005504", label="Incident ID", disabled=True)
