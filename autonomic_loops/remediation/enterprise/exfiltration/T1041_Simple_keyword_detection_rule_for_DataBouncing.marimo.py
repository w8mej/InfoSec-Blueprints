...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DataBouncing
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DataBouncing tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005476", label="Incident ID", disabled=True)
