...
def bluf(mo):
    mo.md(
        r"""
        # Google VPC Service Controls Violation for Storage Bucket Access
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when access attempt blocked by VPC Service Controls
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="702648", label="Incident ID", disabled=True)
