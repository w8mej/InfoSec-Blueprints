...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for megatools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on megatools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001632", label="Incident ID", disabled=True)
