...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GeoProxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GeoProxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006263", label="Incident ID", disabled=True)
