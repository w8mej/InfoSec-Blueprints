...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for omg-payloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on omg-payloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901019", label="Incident ID", disabled=True)
