...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FREE VPN DEWELOPMENT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FREE VPN DEWELOPMENT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003206", label="Incident ID", disabled=True)
