...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LNKUp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LNKUp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003757", label="Incident ID", disabled=True)
