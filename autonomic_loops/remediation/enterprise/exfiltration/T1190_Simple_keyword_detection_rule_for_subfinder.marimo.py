...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for subfinder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on subfinder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007968", label="Incident ID", disabled=True)
