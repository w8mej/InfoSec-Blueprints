...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dploot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dploot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000963", label="Incident ID", disabled=True)
