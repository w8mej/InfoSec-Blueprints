...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Adblock Office VPN Proxy Server
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Adblock Office VPN Proxy Server tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007870", label="Incident ID", disabled=True)
