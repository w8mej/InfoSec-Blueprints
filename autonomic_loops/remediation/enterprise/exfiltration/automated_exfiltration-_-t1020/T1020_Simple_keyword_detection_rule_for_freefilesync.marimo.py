...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for freefilesync
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on freefilesync tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004393", label="Incident ID", disabled=True)
