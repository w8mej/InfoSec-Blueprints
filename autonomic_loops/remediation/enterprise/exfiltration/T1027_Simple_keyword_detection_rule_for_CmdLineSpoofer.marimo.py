...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CmdLineSpoofer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CmdLineSpoofer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007493", label="Incident ID", disabled=True)
