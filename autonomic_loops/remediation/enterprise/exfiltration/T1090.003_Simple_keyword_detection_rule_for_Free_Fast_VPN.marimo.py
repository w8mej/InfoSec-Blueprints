...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free Fast VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free Fast VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004258", label="Incident ID", disabled=True)
