...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001287", label="Incident ID", disabled=True)
