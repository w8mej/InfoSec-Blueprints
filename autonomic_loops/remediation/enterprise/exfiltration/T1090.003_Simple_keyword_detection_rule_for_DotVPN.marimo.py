...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DotVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DotVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007296", label="Incident ID", disabled=True)
