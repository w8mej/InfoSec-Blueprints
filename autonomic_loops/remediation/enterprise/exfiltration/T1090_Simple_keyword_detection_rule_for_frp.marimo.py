...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for frp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on frp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908573", label="Incident ID", disabled=True)
