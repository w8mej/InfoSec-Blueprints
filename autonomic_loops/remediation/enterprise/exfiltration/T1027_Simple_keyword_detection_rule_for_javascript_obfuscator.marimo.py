...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for javascript-obfuscator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on javascript-obfuscator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009257", label="Incident ID", disabled=True)
