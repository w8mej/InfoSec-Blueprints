...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Executable_Files
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Executable_Files tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005078", label="Incident ID", disabled=True)
