...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bittorent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bittorent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003735", label="Incident ID", disabled=True)
