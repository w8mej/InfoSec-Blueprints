...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hola Free VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hola Free VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002784", label="Incident ID", disabled=True)
