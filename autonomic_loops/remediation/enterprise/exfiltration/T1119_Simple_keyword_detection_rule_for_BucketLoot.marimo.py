...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BucketLoot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BucketLoot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901957", label="Incident ID", disabled=True)
