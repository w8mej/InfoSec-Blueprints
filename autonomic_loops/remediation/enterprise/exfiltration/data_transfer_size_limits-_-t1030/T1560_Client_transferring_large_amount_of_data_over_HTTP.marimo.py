...
def bluf(mo):
    mo.md(
        ...
        >
        > Client sending over 5GBs via HTTP. It is uncommon for a client to send this much traffic to a server over HTTP. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="107147", label="Incident ID", disabled=True)
