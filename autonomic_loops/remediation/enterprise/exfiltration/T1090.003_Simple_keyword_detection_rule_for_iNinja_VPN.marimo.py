...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for iNinja VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on iNinja VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908229", label="Incident ID", disabled=True)
