...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RusVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RusVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003435", label="Incident ID", disabled=True)
