...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for blackcat ransomware
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on blackcat ransomware tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005295", label="Incident ID", disabled=True)
