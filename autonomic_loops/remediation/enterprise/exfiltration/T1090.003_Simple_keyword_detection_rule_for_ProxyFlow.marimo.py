...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ProxyFlow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ProxyFlow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003100", label="Incident ID", disabled=True)
