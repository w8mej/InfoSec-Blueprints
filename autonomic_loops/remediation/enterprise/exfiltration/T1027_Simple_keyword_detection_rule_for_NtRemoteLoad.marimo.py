...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NtRemoteLoad
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NtRemoteLoad tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000783", label="Incident ID", disabled=True)
