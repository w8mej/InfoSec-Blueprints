...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cloakify
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cloakify tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006395", label="Incident ID", disabled=True)
