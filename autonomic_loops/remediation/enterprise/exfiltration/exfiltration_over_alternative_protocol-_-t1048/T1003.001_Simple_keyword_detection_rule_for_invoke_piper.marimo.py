...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for invoke-piper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on invoke-piper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008212", label="Incident ID", disabled=True)
