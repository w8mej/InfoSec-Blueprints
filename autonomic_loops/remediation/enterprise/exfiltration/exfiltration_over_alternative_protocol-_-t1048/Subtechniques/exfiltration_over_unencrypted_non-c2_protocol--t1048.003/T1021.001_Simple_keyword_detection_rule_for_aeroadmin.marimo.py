...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for aeroadmin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on aeroadmin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005404", label="Incident ID", disabled=True)
