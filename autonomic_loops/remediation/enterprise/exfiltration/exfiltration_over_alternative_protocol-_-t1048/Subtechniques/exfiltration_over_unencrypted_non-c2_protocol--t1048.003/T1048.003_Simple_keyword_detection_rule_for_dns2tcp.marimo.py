...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dns2tcp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dns2tcp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009563", label="Incident ID", disabled=True)
