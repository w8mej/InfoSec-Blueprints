...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for utorrent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on utorrent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000942", label="Incident ID", disabled=True)
