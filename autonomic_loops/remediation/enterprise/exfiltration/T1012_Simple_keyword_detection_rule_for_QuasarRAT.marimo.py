...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for QuasarRAT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on QuasarRAT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009712", label="Incident ID", disabled=True)
