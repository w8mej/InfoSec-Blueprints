...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for evilrdp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on evilrdp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009561", label="Incident ID", disabled=True)
