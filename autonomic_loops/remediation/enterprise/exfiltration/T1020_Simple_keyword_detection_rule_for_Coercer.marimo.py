...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Coercer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Coercer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007858", label="Incident ID", disabled=True)
