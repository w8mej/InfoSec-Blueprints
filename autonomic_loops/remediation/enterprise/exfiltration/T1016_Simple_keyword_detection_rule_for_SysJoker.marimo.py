...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SysJoker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SysJoker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005147", label="Incident ID", disabled=True)
