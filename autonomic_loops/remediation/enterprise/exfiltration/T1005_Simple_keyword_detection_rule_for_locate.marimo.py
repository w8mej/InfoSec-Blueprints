...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for locate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on locate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009523", label="Incident ID", disabled=True)
