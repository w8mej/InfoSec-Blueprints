...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for awesome-static-analysis
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on awesome-static-analysis tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000467", label="Incident ID", disabled=True)
