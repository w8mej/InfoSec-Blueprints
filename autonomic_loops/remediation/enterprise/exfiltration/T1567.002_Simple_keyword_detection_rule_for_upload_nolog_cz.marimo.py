...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for upload.nolog.cz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on upload.nolog.cz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001491", label="Incident ID", disabled=True)
