...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Unblock Websites
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Unblock Websites tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906004", label="Incident ID", disabled=True)
