...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tcpdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tcpdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000640", label="Incident ID", disabled=True)
