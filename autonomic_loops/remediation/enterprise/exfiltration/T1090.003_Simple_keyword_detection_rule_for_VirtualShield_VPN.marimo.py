...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VirtualShield VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VirtualShield VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004620", label="Incident ID", disabled=True)
