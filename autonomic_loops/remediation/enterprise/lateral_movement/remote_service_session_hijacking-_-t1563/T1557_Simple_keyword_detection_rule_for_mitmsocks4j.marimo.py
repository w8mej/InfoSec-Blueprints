...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mitmsocks4j
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mitmsocks4j tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005110", label="Incident ID", disabled=True)
