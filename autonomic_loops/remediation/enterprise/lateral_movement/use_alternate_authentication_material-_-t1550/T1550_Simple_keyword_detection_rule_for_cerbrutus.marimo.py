...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cerbrutus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cerbrutus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006288", label="Incident ID", disabled=True)
