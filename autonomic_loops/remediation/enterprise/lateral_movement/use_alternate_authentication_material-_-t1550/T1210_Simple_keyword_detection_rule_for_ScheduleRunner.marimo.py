...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ScheduleRunner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ScheduleRunner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008973", label="Incident ID", disabled=True)
