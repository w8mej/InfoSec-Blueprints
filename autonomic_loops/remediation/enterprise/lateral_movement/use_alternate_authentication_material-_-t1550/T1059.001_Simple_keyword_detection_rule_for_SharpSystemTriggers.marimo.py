...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSystemTriggers
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSystemTriggers tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008395", label="Incident ID", disabled=True)
