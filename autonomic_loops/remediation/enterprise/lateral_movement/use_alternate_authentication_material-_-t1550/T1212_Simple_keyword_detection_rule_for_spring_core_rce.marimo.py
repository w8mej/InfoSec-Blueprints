...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for spring-core-rce
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on spring-core-rce tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905871", label="Incident ID", disabled=True)
