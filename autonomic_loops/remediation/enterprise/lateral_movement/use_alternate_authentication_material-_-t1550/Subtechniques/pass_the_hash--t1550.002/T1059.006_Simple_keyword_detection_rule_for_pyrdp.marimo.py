...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pyrdp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pyrdp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004148", label="Incident ID", disabled=True)
