...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DFSCoerce
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DFSCoerce tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009464", label="Incident ID", disabled=True)
