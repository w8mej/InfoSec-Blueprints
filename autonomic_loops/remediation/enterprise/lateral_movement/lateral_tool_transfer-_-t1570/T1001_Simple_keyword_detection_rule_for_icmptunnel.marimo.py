...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for icmptunnel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on icmptunnel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009808", label="Incident ID", disabled=True)
