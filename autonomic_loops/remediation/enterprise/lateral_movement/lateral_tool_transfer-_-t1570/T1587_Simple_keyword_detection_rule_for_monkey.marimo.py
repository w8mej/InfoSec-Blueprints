...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for monkey
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on monkey tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003092", label="Incident ID", disabled=True)
