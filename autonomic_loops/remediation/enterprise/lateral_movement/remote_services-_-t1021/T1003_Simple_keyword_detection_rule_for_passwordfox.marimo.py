...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for passwordfox
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on passwordfox tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000847", label="Incident ID", disabled=True)
