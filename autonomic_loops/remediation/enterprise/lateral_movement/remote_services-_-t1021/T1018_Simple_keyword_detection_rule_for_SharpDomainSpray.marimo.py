...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpDomainSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpDomainSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005726", label="Incident ID", disabled=True)
