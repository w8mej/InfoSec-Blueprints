...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetSupport
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetSupport tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007751", label="Incident ID", disabled=True)
