...
def bluf(mo):
    mo.md(
        ...
        >
        > Advesaries may use adminstrative shares to place files used for lateral movement remotely. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="109542", label="Incident ID", disabled=True)
