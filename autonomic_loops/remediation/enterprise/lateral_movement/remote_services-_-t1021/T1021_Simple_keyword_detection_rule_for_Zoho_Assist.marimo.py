...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Zoho Assist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Zoho Assist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005050", label="Incident ID", disabled=True)
