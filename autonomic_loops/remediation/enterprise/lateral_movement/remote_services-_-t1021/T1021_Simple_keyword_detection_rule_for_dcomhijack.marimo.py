...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dcomhijack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dcomhijack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902660", label="Incident ID", disabled=True)
