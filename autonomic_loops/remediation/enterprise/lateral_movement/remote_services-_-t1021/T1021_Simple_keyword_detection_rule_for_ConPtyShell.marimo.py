...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ConPtyShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ConPtyShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007834", label="Incident ID", disabled=True)
