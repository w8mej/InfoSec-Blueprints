...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gateway-finder-imp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gateway-finder-imp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907543", label="Incident ID", disabled=True)
