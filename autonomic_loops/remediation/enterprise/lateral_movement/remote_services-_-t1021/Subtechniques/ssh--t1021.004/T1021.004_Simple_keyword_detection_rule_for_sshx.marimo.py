...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sshx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sshx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906778", label="Incident ID", disabled=True)
