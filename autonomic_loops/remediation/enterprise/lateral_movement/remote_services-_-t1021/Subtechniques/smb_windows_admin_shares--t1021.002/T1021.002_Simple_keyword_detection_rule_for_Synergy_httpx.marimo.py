...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Synergy-httpx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Synergy-httpx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003199", label="Incident ID", disabled=True)
