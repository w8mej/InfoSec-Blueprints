...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for powershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on powershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001659", label="Incident ID", disabled=True)
