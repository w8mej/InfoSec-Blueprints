...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OffensiveLua
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OffensiveLua tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001729", label="Incident ID", disabled=True)
