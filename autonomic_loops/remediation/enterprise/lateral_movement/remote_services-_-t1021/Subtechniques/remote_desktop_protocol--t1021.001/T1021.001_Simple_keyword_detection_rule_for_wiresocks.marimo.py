...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wiresocks
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wiresocks tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007621", label="Incident ID", disabled=True)
