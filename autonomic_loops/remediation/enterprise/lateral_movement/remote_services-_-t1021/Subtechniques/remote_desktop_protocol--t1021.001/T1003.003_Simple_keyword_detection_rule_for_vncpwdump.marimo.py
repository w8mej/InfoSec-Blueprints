...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vncpwdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vncpwdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004156", label="Incident ID", disabled=True)
