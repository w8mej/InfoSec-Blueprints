...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSocks
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSocks tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003472", label="Incident ID", disabled=True)
