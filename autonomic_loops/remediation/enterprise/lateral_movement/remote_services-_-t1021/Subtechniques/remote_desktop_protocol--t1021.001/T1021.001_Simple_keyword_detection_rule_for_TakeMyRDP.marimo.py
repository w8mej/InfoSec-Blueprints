...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TakeMyRDP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TakeMyRDP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008174", label="Incident ID", disabled=True)
