...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpRDP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpRDP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001401", label="Incident ID", disabled=True)
