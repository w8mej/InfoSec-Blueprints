...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for golang_c2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on golang_c2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005346", label="Incident ID", disabled=True)
