...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for php
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on php tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001264", label="Incident ID", disabled=True)
