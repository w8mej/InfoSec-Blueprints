...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gsocket
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gsocket tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008831", label="Incident ID", disabled=True)
