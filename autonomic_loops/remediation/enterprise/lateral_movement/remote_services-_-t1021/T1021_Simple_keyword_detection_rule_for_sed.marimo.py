...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sed
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sed tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006590", label="Incident ID", disabled=True)
