...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smbcrawler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smbcrawler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007895", label="Incident ID", disabled=True)
