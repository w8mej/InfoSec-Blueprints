...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RDPHijack-BOF
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RDPHijack-BOF tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009370", label="Incident ID", disabled=True)
