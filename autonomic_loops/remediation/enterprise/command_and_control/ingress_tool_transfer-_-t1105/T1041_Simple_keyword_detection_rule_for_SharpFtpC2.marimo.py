...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpFtpC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpFtpC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000334", label="Incident ID", disabled=True)
