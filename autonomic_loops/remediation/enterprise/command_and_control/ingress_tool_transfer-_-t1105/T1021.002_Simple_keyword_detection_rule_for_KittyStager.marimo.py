...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KittyStager
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KittyStager tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008192", label="Incident ID", disabled=True)
