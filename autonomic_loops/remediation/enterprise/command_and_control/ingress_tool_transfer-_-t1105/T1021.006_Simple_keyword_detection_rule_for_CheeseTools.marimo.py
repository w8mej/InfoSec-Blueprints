...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CheeseTools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CheeseTools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005212", label="Incident ID", disabled=True)
