...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for b374k
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on b374k tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907928", label="Incident ID", disabled=True)
