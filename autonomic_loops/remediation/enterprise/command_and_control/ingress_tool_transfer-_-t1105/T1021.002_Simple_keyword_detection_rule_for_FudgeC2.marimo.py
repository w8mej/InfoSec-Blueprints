...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FudgeC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FudgeC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904350", label="Incident ID", disabled=True)
