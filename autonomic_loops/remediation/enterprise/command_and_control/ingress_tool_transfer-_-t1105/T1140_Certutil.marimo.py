...
def bluf(mo):
    mo.md(
        ...
        >
        > 使用诸如“decode”子命令之类的子命令检测可疑的Microsoft certutil执行，该子命令有时用于使用内置的certutil实用程序
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306028", label="Incident ID", disabled=True)
