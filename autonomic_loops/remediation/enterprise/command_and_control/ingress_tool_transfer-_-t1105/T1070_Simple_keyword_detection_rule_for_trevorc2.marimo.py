...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for trevorc2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on trevorc2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008998", label="Incident ID", disabled=True)
