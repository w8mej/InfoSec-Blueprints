...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for shell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on shell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004497", label="Incident ID", disabled=True)
