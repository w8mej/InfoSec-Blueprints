...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerStager
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerStager tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006992", label="Incident ID", disabled=True)
