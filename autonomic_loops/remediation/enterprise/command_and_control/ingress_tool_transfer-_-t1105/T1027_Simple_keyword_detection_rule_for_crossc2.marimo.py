...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for crossc2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on crossc2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008744", label="Incident ID", disabled=True)
