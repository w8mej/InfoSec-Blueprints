...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for elite-proxy-finder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on elite-proxy-finder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001730", label="Incident ID", disabled=True)
