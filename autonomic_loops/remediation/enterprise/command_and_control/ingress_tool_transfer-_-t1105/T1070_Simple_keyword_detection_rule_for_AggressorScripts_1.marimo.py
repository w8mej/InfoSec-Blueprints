...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AggressorScripts-1
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AggressorScripts-1 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004409", label="Incident ID", disabled=True)
