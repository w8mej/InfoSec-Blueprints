...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for transfert-my-files.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on transfert-my-files.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007023", label="Incident ID", disabled=True)
