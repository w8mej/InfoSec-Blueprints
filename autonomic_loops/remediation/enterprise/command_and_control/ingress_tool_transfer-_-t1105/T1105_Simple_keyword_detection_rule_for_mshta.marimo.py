...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mshta
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mshta tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002481", label="Incident ID", disabled=True)
