...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpShooter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpShooter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007128", label="Incident ID", disabled=True)
