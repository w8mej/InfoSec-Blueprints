...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Nsight RMM
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Nsight RMM tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002567", label="Incident ID", disabled=True)
