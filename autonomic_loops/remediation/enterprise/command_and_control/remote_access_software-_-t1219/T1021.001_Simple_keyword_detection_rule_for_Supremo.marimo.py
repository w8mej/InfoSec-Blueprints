...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Supremo
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Supremo tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002137", label="Incident ID", disabled=True)
