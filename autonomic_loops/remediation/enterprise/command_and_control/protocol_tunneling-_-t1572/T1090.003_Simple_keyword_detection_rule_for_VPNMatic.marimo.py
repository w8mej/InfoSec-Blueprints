...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPNMatic
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPNMatic tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006764", label="Incident ID", disabled=True)
