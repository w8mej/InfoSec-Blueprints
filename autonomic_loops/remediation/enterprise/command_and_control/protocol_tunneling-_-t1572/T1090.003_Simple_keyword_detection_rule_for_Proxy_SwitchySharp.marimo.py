...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Proxy SwitchySharp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Proxy SwitchySharp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001672", label="Incident ID", disabled=True)
