...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for My Browser Vpn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on My Browser Vpn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005315", label="Incident ID", disabled=True)
