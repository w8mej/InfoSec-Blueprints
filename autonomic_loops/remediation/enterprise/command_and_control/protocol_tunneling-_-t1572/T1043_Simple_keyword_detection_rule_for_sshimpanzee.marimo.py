...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sshimpanzee
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sshimpanzee tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008029", label="Incident ID", disabled=True)
