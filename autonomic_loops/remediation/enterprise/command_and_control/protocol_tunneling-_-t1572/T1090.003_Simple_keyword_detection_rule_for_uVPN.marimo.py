...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for uVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on uVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902981", label="Incident ID", disabled=True)
