...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for westwind
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on westwind tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000713", label="Incident ID", disabled=True)
