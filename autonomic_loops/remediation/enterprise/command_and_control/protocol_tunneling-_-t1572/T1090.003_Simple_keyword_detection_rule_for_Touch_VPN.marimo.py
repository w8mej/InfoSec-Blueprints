...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Touch VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Touch VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004595", label="Incident ID", disabled=True)
