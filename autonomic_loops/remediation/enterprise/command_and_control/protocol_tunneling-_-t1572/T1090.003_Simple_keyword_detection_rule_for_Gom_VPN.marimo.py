...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Gom VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Gom VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006676", label="Incident ID", disabled=True)
