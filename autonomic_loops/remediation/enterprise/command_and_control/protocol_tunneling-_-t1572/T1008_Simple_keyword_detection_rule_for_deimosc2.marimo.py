...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for deimosc2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on deimosc2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005046", label="Incident ID", disabled=True)
