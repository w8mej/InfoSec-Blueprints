...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SetupVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SetupVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001834", label="Incident ID", disabled=True)
