...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ptunnel-ng
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ptunnel-ng tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006806", label="Incident ID", disabled=True)
