...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CyberGhost VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CyberGhost VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003053", label="Incident ID", disabled=True)
