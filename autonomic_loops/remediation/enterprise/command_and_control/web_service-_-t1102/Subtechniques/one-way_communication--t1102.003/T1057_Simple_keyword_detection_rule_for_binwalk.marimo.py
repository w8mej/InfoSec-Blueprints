...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for binwalk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on binwalk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003785", label="Incident ID", disabled=True)
