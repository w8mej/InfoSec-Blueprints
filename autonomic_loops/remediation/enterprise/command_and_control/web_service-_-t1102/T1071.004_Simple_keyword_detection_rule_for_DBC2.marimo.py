...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DBC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DBC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006939", label="Incident ID", disabled=True)
