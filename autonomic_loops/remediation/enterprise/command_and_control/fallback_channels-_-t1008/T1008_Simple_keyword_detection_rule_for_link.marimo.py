...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for link
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on link tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009074", label="Incident ID", disabled=True)
