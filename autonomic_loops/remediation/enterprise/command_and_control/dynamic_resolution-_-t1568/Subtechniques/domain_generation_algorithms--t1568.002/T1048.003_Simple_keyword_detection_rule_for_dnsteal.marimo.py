...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnsteal
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnsteal tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008229", label="Incident ID", disabled=True)
