...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnsmorph
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnsmorph tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007282", label="Incident ID", disabled=True)
