...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RedPeanut
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RedPeanut tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007612", label="Incident ID", disabled=True)
