...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Proxy SwitchyOmega
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Proxy SwitchyOmega tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008382", label="Incident ID", disabled=True)
