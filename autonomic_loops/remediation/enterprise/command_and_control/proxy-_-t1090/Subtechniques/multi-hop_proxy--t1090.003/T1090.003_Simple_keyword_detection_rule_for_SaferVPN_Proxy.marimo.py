...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SaferVPN Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SaferVPN Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004130", label="Incident ID", disabled=True)
