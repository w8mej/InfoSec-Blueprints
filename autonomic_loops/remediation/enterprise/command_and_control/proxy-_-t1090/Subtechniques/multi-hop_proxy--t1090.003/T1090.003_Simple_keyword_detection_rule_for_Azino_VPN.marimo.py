...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Azino VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Azino VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009386", label="Incident ID", disabled=True)
