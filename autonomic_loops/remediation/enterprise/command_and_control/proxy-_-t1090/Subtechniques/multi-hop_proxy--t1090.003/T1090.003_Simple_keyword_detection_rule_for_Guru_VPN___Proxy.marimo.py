...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Guru VPN & Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Guru VPN & Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902387", label="Incident ID", disabled=True)
