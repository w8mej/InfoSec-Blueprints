...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free Avira Phantom VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free Avira Phantom VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003410", label="Incident ID", disabled=True)
