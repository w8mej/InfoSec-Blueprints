...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Wachee VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Wachee VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008072", label="Incident ID", disabled=True)
