...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Muscle VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Muscle VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000894", label="Incident ID", disabled=True)
