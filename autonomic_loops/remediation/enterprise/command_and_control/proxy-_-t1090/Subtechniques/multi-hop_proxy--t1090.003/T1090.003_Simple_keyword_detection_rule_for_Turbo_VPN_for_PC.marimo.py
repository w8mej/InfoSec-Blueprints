...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Turbo VPN for PC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Turbo VPN for PC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001053", label="Incident ID", disabled=True)
