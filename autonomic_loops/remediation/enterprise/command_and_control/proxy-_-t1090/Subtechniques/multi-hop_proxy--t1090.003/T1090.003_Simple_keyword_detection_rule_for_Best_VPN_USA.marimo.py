...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Best VPN USA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Best VPN USA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003796", label="Incident ID", disabled=True)
