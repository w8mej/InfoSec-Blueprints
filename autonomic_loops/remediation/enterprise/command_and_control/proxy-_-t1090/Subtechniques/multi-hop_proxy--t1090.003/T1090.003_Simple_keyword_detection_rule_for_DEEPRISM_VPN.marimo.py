...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DEEPRISM VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DEEPRISM VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001789", label="Incident ID", disabled=True)
