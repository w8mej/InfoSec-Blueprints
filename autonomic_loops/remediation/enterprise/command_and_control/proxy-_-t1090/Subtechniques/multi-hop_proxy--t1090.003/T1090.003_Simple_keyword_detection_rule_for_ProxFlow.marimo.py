...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ProxFlow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ProxFlow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001487", label="Incident ID", disabled=True)
