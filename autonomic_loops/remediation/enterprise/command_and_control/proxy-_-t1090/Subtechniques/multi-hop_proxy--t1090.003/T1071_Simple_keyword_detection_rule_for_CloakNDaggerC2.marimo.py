...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CloakNDaggerC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CloakNDaggerC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007872", label="Incident ID", disabled=True)
