...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for IPBurger Proxy & VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on IPBurger Proxy & VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008034", label="Incident ID", disabled=True)
