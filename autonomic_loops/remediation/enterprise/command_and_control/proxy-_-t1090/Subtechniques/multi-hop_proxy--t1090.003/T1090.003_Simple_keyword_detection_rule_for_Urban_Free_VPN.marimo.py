...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Urban Free VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Urban Free VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007402", label="Incident ID", disabled=True)
