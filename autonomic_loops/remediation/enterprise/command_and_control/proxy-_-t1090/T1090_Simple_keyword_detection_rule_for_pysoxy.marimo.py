...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pysoxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pysoxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005834", label="Incident ID", disabled=True)
