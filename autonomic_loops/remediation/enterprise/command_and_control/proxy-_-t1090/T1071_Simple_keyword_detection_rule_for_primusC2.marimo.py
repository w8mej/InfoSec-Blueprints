...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for primusC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on primusC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007235", label="Incident ID", disabled=True)
