...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ligolo-ng
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ligolo-ng tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000264", label="Incident ID", disabled=True)
