...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MaccaroniC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MaccaroniC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907804", label="Incident ID", disabled=True)
