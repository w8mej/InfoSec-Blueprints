...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AzureC2Relay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AzureC2Relay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008216", label="Incident ID", disabled=True)
