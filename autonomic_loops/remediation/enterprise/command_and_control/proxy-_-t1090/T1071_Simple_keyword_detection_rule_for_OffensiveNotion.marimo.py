...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OffensiveNotion
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OffensiveNotion tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000926", label="Incident ID", disabled=True)
