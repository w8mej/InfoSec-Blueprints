...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for anydesk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on anydesk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006686", label="Incident ID", disabled=True)
