...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for octopus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on octopus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005814", label="Incident ID", disabled=True)
