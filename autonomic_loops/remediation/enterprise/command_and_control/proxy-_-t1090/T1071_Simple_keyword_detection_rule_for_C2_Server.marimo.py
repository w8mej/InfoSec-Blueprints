...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for C2_Server
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on C2_Server tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004242", label="Incident ID", disabled=True)
