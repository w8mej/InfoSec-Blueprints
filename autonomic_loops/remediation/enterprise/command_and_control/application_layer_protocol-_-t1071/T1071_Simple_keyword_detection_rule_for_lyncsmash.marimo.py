...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for lyncsmash
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on lyncsmash tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002757", label="Incident ID", disabled=True)
