...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnslog.cn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnslog.cn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009080", label="Incident ID", disabled=True)
