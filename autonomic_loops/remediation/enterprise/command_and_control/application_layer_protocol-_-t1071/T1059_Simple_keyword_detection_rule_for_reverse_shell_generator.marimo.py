...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for reverse-shell-generator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on reverse-shell-generator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007098", label="Incident ID", disabled=True)
