...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for action1
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on action1 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902105", label="Incident ID", disabled=True)
