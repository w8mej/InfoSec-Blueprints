...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for goZulipC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on goZulipC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006036", label="Incident ID", disabled=True)
