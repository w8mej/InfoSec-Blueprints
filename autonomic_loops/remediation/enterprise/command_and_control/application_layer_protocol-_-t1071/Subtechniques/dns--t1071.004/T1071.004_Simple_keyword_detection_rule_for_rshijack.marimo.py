...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rshijack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rshijack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009913", label="Incident ID", disabled=True)
