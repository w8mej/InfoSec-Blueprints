...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gcat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gcat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008976", label="Incident ID", disabled=True)
