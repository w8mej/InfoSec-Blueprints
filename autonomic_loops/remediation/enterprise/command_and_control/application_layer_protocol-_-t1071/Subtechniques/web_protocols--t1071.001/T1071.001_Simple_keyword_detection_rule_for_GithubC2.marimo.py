...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GithubC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GithubC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000754", label="Incident ID", disabled=True)
