...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ip-api.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ip-api.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003541", label="Incident ID", disabled=True)
