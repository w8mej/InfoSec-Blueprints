...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for securesocketfunneling
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on securesocketfunneling tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006567", label="Incident ID", disabled=True)
