...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for C2concealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on C2concealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004510", label="Incident ID", disabled=True)
