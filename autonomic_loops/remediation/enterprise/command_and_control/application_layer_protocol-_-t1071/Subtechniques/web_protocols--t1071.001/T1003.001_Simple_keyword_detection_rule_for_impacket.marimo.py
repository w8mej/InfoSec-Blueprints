...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for impacket
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on impacket tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001884", label="Incident ID", disabled=True)
