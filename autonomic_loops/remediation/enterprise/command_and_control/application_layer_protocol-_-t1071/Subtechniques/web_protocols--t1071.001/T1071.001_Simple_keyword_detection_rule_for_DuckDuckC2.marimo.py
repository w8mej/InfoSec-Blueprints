...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DuckDuckC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DuckDuckC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008936", label="Incident ID", disabled=True)
