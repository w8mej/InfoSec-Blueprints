...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BabyShark
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BabyShark tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006871", label="Incident ID", disabled=True)
