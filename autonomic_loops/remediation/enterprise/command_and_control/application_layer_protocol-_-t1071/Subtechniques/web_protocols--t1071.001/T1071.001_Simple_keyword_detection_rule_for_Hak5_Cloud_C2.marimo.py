...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hak5 Cloud C2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hak5 Cloud C2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001459", label="Incident ID", disabled=True)
