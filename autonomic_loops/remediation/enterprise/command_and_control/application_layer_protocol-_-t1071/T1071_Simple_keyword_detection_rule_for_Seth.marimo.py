...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Seth
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Seth tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000702", label="Incident ID", disabled=True)
