...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LogMeIn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LogMeIn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008473", label="Incident ID", disabled=True)
