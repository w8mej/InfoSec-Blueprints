...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnscat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnscat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005954", label="Incident ID", disabled=True)
