...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HardHatC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HardHatC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008509", label="Incident ID", disabled=True)
