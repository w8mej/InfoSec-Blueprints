...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bypasswaf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bypasswaf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005070", label="Incident ID", disabled=True)
