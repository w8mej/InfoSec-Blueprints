...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for iodine
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on iodine tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009407", label="Incident ID", disabled=True)
