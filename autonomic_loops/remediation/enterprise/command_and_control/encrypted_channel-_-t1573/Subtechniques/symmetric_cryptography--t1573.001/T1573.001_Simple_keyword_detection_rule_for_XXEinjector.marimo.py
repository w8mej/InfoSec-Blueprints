...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for XXEinjector
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on XXEinjector tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006507", label="Incident ID", disabled=True)
