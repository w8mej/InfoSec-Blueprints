...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mssqlproxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mssqlproxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000063", label="Incident ID", disabled=True)
