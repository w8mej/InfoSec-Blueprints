...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pupy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pupy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008141", label="Incident ID", disabled=True)
