...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BaRMIe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BaRMIe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000490", label="Incident ID", disabled=True)
