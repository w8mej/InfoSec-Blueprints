...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SysWhispers3
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SysWhispers3 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001773", label="Incident ID", disabled=True)
