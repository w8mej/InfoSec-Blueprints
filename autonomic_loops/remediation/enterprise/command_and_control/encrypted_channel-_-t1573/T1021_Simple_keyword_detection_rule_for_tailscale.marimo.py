...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tailscale
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tailscale tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007699", label="Incident ID", disabled=True)
