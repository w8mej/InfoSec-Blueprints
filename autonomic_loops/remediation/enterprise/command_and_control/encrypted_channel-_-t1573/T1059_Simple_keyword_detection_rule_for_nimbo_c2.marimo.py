...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nimbo-c2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nimbo-c2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001644", label="Incident ID", disabled=True)
