...
def bluf(mo):
    mo.md(
        ...
        >
        > Client is making a request mimicking a legitimate browser but is possibly powershell or other programming library that would not normally have that Browser User Agent
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="104421", label="Incident ID", disabled=True)
