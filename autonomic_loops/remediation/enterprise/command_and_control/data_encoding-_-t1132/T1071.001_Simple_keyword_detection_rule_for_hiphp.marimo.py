...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hiphp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hiphp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001314", label="Incident ID", disabled=True)
