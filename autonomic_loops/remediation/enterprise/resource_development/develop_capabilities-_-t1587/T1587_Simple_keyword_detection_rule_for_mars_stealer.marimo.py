...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mars stealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mars stealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004334", label="Incident ID", disabled=True)
