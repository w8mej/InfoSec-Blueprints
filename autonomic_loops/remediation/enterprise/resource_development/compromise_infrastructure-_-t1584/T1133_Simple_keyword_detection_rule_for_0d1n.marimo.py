...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for 0d1n
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on 0d1n tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005266", label="Incident ID", disabled=True)
