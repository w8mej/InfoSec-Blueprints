...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for requestbin.net
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on requestbin.net tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004000", label="Incident ID", disabled=True)
