...
def bluf(mo):
    mo.md(
        r"""
        # Usage of Suspicious Sysinternals Tools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects the usage of Suspicious Sysinternals Tools such as PsExec, Procdump...etc via the "accepteula" key being added to Registry
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308186", label="Incident ID", disabled=True)
