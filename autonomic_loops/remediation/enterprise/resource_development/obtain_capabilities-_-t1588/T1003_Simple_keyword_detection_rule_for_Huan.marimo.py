...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Huan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Huan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001251", label="Incident ID", disabled=True)
