...
def bluf(mo):
    mo.md(
        r"""
        # Usage of Renamed Sysinternals Tools
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects the "accepteula" key related to sysinternals tools being created from non sysinternals tools
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307685", label="Incident ID", disabled=True)
