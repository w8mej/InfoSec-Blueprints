...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LALIN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LALIN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006341", label="Incident ID", disabled=True)
