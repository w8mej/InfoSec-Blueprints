...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chisel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chisel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008542", label="Incident ID", disabled=True)
