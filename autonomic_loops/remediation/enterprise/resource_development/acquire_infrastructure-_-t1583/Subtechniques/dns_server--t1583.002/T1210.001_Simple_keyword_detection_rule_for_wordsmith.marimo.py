...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wordsmith
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wordsmith tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008076", label="Incident ID", disabled=True)
