...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for S3Scanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on S3Scanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906879", label="Incident ID", disabled=True)
