...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Gitleaks
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Gitleaks tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005854", label="Incident ID", disabled=True)
