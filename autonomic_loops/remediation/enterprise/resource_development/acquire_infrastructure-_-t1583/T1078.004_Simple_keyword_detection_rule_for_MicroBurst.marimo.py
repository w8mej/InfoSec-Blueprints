...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MicroBurst
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MicroBurst tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900172", label="Incident ID", disabled=True)
