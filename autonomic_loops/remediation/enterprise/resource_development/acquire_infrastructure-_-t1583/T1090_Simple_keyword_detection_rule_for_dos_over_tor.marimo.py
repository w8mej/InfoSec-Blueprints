...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dos-over-tor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dos-over-tor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000544", label="Incident ID", disabled=True)
