...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for getsploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on getsploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002395", label="Incident ID", disabled=True)
