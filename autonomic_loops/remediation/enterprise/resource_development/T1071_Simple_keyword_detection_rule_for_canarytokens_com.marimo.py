...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for canarytokens.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on canarytokens.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901994", label="Incident ID", disabled=True)
