...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for qu.ax
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on qu.ax tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002500", label="Incident ID", disabled=True)
