...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Jomungand
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Jomungand tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003387", label="Incident ID", disabled=True)
