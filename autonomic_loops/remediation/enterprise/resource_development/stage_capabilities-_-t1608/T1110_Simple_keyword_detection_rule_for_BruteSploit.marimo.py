...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BruteSploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BruteSploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009147", label="Incident ID", disabled=True)
