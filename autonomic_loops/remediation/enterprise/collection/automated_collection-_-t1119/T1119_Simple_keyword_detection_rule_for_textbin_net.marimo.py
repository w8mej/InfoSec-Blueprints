...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for textbin.net
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on textbin.net tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906504", label="Incident ID", disabled=True)
