...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pastebin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pastebin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003662", label="Incident ID", disabled=True)
