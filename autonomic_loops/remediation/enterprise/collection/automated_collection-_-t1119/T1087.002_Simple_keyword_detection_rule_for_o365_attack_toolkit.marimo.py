...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for o365-attack-toolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on o365-attack-toolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902727", label="Incident ID", disabled=True)
