...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for passphrase-wordlist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on passphrase-wordlist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008505", label="Incident ID", disabled=True)
