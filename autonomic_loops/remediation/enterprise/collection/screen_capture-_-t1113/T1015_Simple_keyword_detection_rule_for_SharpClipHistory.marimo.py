...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpClipHistory
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpClipHistory tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000654", label="Incident ID", disabled=True)
