...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AsyncRAT-C-Sharp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AsyncRAT-C-Sharp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004018", label="Incident ID", disabled=True)
