...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for 7zip
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on 7zip tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003096", label="Incident ID", disabled=True)
