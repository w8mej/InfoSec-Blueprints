...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AzureADLateralMovement
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AzureADLateralMovement tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008083", label="Incident ID", disabled=True)
