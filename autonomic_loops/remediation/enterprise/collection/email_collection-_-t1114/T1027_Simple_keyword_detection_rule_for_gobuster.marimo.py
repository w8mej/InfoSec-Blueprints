...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gobuster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gobuster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005419", label="Incident ID", disabled=True)
