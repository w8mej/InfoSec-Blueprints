...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpCloud
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpCloud tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000261", label="Incident ID", disabled=True)
