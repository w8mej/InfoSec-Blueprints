...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpGmailC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpGmailC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003013", label="Incident ID", disabled=True)
