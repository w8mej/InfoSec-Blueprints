...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SessionSearcher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SessionSearcher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901846", label="Incident ID", disabled=True)
