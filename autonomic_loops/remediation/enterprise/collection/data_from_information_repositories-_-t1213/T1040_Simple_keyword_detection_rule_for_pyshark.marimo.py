...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pyshark
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pyshark tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005653", label="Incident ID", disabled=True)
