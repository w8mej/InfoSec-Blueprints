...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EQGR
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EQGR tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008804", label="Incident ID", disabled=True)
