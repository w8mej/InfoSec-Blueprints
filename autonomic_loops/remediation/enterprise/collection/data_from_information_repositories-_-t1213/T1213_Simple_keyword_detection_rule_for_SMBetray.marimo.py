...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SMBetray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SMBetray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901956", label="Incident ID", disabled=True)
