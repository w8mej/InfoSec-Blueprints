...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for anymailfinder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on anymailfinder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902845", label="Incident ID", disabled=True)
