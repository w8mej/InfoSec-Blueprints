...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for grep
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on grep tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009127", label="Incident ID", disabled=True)
