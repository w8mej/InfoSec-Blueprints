...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ATPMiniDump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ATPMiniDump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008411", label="Incident ID", disabled=True)
