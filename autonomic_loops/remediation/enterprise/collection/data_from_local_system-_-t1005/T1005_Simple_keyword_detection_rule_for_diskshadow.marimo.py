...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for diskshadow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on diskshadow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009564", label="Incident ID", disabled=True)
