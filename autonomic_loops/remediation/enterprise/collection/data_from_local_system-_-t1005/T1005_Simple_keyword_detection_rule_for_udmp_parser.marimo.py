...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for udmp-parser
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on udmp-parser tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003334", label="Incident ID", disabled=True)
