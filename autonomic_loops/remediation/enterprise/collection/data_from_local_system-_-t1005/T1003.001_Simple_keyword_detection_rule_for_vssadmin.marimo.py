...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vssadmin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vssadmin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000038", label="Incident ID", disabled=True)
