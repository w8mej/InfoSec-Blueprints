...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Volumiser
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Volumiser tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006421", label="Incident ID", disabled=True)
