...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WheresMyImplant
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WheresMyImplant tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008325", label="Incident ID", disabled=True)
