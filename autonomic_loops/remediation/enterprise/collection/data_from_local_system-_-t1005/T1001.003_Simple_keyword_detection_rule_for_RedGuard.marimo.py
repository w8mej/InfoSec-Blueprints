...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RedGuard
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RedGuard tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003532", label="Incident ID", disabled=True)
