...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Compress-Archive
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Compress-Archive tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008397", label="Incident ID", disabled=True)
