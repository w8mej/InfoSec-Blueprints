...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for domain_analyzer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on domain_analyzer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001471", label="Incident ID", disabled=True)
