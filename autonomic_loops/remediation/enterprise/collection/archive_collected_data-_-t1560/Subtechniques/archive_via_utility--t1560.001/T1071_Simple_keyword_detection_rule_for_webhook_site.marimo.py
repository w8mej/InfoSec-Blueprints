...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for webhook.site
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on webhook.site tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008627", label="Incident ID", disabled=True)
