...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PickleC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PickleC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007288", label="Incident ID", disabled=True)
