...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WiFi-Pumpkin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WiFi-Pumpkin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009284", label="Incident ID", disabled=True)
