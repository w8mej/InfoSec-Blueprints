...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fiddler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fiddler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008864", label="Incident ID", disabled=True)
