...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for burpsuite
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on burpsuite tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004601", label="Incident ID", disabled=True)
