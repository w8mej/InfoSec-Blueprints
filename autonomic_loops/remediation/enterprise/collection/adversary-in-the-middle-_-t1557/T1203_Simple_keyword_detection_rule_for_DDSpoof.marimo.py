...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DDSpoof
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DDSpoof tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003183", label="Incident ID", disabled=True)
