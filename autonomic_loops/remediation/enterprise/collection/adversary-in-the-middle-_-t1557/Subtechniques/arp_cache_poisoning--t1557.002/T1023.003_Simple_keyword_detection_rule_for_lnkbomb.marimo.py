...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for lnkbomb
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on lnkbomb tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004340", label="Incident ID", disabled=True)
