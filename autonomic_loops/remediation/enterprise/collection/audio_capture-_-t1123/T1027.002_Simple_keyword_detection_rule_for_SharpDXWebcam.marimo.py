...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpDXWebcam
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpDXWebcam tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000688", label="Incident ID", disabled=True)
