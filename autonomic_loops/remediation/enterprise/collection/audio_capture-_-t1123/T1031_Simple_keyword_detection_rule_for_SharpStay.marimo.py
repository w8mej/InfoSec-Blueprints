...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpStay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpStay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005725", label="Incident ID", disabled=True)
