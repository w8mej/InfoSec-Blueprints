...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Python-Wordlist-Generator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Python-Wordlist-Generator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902891", label="Incident ID", disabled=True)
