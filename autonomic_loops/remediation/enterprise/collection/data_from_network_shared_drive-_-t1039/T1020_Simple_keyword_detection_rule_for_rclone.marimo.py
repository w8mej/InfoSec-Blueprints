...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rclone
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rclone tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902000", label="Incident ID", disabled=True)
