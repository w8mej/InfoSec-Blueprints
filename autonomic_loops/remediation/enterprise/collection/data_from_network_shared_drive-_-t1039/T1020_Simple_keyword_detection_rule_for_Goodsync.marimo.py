...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Goodsync
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Goodsync tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007520", label="Incident ID", disabled=True)
