...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BlazeStealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BlazeStealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009331", label="Incident ID", disabled=True)
