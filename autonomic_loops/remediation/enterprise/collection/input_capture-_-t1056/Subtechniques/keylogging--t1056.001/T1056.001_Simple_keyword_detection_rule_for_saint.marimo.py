...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for saint
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on saint tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002054", label="Incident ID", disabled=True)
