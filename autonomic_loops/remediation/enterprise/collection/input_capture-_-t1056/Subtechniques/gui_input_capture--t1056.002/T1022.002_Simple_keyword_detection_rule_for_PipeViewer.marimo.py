...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PipeViewer 
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PipeViewer  tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004792", label="Incident ID", disabled=True)
