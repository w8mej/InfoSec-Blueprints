...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pateensy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pateensy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007436", label="Incident ID", disabled=True)
