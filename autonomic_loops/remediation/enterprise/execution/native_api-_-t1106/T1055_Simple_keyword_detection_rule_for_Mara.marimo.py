...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Mara
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Mara tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002638", label="Incident ID", disabled=True)
