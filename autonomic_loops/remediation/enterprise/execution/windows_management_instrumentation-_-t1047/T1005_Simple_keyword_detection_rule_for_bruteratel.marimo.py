...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bruteratel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bruteratel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006289", label="Incident ID", disabled=True)
