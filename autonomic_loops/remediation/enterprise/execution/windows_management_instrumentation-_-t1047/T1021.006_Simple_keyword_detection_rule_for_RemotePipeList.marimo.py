...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RemotePipeList
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RemotePipeList tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008151", label="Incident ID", disabled=True)
