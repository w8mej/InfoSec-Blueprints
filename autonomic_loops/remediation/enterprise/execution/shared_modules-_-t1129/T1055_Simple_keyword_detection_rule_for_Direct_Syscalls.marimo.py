...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Direct-Syscalls
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Direct-Syscalls tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002714", label="Incident ID", disabled=True)
