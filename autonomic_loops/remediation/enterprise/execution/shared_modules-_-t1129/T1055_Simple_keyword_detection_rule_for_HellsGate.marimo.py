...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HellsGate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HellsGate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007096", label="Incident ID", disabled=True)
