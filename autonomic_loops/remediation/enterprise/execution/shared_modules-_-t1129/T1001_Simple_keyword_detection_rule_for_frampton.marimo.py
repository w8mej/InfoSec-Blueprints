...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for frampton
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on frampton tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002826", label="Incident ID", disabled=True)
