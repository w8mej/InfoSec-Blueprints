...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ShadowForgeC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ShadowForgeC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904809", label="Incident ID", disabled=True)
