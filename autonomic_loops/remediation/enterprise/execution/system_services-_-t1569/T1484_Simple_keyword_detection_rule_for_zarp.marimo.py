...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for zarp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on zarp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006321", label="Incident ID", disabled=True)
