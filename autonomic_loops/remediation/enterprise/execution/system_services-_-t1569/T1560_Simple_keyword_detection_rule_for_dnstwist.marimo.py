...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnstwist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnstwist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008343", label="Incident ID", disabled=True)
