...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for infernal-twin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on infernal-twin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001282", label="Incident ID", disabled=True)
