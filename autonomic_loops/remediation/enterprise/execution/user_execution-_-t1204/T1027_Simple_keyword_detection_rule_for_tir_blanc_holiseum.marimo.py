...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tir_blanc_holiseum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tir_blanc_holiseum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009794", label="Incident ID", disabled=True)
