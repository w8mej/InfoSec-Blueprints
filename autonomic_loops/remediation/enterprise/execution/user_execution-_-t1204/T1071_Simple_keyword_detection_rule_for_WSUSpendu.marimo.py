...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WSUSpendu
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WSUSpendu tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002084", label="Incident ID", disabled=True)
