...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BeeLogger
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BeeLogger tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008755", label="Incident ID", disabled=True)
