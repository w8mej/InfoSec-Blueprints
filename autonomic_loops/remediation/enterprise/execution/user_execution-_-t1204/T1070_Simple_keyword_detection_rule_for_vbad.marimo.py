...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vbad
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vbad tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008241", label="Incident ID", disabled=True)
