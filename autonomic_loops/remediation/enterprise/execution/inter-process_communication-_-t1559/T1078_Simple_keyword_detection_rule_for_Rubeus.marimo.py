...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Rubeus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Rubeus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003285", label="Incident ID", disabled=True)
