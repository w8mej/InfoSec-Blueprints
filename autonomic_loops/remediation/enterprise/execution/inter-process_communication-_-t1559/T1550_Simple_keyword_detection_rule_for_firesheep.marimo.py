...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for firesheep
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on firesheep tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002206", label="Incident ID", disabled=True)
