...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for socat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on socat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006330", label="Incident ID", disabled=True)
