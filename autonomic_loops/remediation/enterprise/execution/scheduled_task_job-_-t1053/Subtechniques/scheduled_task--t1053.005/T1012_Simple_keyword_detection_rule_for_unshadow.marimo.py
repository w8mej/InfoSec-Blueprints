...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for unshadow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on unshadow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009502", label="Incident ID", disabled=True)
