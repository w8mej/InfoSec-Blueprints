...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for regreeper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on regreeper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002091", label="Incident ID", disabled=True)
