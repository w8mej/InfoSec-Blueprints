...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-Phant0m
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-Phant0m tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003116", label="Incident ID", disabled=True)
