...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for luckystrike
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on luckystrike tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005273", label="Incident ID", disabled=True)
