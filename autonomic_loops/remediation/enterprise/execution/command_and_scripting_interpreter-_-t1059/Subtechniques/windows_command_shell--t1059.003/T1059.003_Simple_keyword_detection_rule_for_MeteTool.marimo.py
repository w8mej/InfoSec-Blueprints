...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MeteTool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MeteTool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900163", label="Incident ID", disabled=True)
