...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001032", label="Incident ID", disabled=True)
