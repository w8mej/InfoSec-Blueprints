...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PrivKit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PrivKit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001870", label="Incident ID", disabled=True)
