...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Conti Ranwomware
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Conti Ranwomware tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005408", label="Incident ID", disabled=True)
