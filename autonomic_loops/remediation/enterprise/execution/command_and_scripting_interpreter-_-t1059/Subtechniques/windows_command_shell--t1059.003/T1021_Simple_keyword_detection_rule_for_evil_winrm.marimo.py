...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for evil-winrm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on evil-winrm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007989", label="Incident ID", disabled=True)
