...
def bluf(mo):
    mo.md(
        r"""
        # Gamaredon/InvisiMole Activity
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects artefacts associated with InvisiMole TCP downloader delivered by Gamaredon group, as reported in June 2020
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307315", label="Incident ID", disabled=True)
