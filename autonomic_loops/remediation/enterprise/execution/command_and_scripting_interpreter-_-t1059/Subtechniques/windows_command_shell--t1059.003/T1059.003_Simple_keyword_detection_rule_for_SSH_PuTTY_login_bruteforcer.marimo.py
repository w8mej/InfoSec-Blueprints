...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SSH-PuTTY-login-bruteforcer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SSH-PuTTY-login-bruteforcer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004750", label="Incident ID", disabled=True)
