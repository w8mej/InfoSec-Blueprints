...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GIUDA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GIUDA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008539", label="Incident ID", disabled=True)
