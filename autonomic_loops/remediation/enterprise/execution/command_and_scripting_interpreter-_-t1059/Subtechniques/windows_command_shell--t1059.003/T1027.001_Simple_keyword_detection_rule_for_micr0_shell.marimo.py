...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for micr0_shell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on micr0_shell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000724", label="Incident ID", disabled=True)
