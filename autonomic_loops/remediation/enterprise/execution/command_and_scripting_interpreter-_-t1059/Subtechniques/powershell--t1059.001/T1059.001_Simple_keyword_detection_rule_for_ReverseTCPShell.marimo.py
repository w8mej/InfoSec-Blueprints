...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ReverseTCPShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ReverseTCPShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000957", label="Incident ID", disabled=True)
