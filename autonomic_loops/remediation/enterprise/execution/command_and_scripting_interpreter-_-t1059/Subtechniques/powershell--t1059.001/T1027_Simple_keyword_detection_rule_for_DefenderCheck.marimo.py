...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DefenderCheck
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DefenderCheck tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000107", label="Incident ID", disabled=True)
