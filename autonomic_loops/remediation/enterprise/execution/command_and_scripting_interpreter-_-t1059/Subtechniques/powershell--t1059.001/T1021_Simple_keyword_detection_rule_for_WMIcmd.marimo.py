...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WMIcmd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WMIcmd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008122", label="Incident ID", disabled=True)
