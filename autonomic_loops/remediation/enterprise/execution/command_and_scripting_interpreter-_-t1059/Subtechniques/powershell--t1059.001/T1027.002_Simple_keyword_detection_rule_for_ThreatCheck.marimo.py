...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ThreatCheck
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ThreatCheck tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000429", label="Incident ID", disabled=True)
