...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for the-backdoor-factory
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on the-backdoor-factory tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007091", label="Incident ID", disabled=True)
