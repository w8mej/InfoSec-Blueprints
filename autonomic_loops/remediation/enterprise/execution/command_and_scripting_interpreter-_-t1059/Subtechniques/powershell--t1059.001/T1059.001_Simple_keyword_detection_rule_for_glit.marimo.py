...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for glit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on glit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005064", label="Incident ID", disabled=True)
