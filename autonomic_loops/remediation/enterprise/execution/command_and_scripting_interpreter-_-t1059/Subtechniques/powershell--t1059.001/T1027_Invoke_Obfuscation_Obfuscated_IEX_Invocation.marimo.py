...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects all variations of obfuscated powershell IEX invocation code generated by Invoke-Obfuscation framework from the following code block — https://github.com/danielbohannon/Invoke-Obfuscation/blob/master/Out-ObfuscatedStringCommand.ps1#L873-L888
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305170", label="Incident ID", disabled=True)
