...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Net-GPPPassword
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Net-GPPPassword tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000858", label="Incident ID", disabled=True)
