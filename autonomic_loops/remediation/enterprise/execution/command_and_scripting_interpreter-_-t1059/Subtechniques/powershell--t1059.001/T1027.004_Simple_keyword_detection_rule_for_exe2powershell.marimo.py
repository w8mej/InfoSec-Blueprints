...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for exe2powershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on exe2powershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005957", label="Incident ID", disabled=True)
