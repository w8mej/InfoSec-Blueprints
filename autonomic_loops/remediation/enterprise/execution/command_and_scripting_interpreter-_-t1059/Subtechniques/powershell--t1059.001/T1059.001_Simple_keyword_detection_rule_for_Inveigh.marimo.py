...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Inveigh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Inveigh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909548", label="Incident ID", disabled=True)
