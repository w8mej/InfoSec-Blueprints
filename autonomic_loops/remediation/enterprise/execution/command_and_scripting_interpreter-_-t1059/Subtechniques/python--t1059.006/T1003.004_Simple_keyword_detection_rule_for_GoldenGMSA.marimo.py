...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GoldenGMSA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GoldenGMSA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001827", label="Incident ID", disabled=True)
