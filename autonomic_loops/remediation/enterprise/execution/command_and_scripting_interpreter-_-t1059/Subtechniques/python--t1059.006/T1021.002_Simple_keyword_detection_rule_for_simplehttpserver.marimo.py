...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for simplehttpserver
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on simplehttpserver tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001663", label="Incident ID", disabled=True)
