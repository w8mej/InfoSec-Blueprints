...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for shellcodetester
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on shellcodetester tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000295", label="Incident ID", disabled=True)
