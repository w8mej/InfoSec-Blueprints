...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pyshell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pyshell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002688", label="Incident ID", disabled=True)
