...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpDoor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpDoor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004149", label="Incident ID", disabled=True)
