...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pazuzu
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pazuzu tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004254", label="Incident ID", disabled=True)
