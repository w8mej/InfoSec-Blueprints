...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Zloader
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Zloader tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000056", label="Incident ID", disabled=True)
