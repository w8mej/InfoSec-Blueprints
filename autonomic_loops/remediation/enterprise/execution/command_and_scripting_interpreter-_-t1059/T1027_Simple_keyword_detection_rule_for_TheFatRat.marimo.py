...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TheFatRat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TheFatRat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002123", label="Incident ID", disabled=True)
