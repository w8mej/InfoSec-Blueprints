...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chcp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chcp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006449", label="Incident ID", disabled=True)
