...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gtfobins
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gtfobins tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007251", label="Incident ID", disabled=True)
