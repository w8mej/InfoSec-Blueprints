...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for supershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on supershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003629", label="Incident ID", disabled=True)
