...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for xspy -display
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on xspy -display tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003746", label="Incident ID", disabled=True)
