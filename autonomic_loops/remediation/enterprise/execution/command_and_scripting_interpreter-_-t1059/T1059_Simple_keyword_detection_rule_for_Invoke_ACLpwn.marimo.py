...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-ACLpwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-ACLpwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006159", label="Incident ID", disabled=True)
