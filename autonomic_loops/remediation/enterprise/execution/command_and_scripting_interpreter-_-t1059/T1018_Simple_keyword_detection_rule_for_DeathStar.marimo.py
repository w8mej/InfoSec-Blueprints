...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DeathStar
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DeathStar tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006663", label="Incident ID", disabled=True)
