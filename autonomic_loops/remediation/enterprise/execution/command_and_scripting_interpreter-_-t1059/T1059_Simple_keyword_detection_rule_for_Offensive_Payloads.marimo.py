...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Offensive-Payloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Offensive-Payloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908057", label="Incident ID", disabled=True)
