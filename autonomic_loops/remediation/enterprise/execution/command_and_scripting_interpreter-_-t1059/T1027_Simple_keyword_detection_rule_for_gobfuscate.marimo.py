...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gobfuscate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gobfuscate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904192", label="Incident ID", disabled=True)
