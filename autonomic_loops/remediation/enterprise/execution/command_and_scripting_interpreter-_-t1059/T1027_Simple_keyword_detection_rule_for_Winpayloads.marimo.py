...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Winpayloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Winpayloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003537", label="Incident ID", disabled=True)
