...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wmiexec2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wmiexec2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004762", label="Incident ID", disabled=True)
