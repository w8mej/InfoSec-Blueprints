...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for o365enum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on o365enum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001447", label="Incident ID", disabled=True)
