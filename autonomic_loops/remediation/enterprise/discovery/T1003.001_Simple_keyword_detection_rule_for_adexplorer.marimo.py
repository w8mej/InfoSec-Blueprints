...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adexplorer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adexplorer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007411", label="Incident ID", disabled=True)
