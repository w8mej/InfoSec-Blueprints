...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for reGeorg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on reGeorg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007679", label="Incident ID", disabled=True)
