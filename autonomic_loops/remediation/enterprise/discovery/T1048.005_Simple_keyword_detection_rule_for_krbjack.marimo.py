...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for krbjack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on krbjack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000338", label="Incident ID", disabled=True)
