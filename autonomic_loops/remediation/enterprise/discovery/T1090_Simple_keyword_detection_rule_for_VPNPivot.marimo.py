...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPNPivot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPNPivot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000262", label="Incident ID", disabled=True)
