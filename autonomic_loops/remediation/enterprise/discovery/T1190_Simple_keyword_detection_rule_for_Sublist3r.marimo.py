...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Sublist3r
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Sublist3r tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002403", label="Incident ID", disabled=True)
