...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for modDetective
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on modDetective tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003719", label="Incident ID", disabled=True)
