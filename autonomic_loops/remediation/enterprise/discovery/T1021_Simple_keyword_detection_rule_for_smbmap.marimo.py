...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smbmap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smbmap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007784", label="Incident ID", disabled=True)
