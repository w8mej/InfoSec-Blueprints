...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mimikittenz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mimikittenz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007657", label="Incident ID", disabled=True)
