...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Getcap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Getcap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009146", label="Incident ID", disabled=True)
