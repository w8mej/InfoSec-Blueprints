...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerShellArsenal
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerShellArsenal tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008577", label="Incident ID", disabled=True)
