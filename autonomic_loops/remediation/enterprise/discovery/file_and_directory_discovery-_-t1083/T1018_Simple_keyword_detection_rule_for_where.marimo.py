...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for where
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on where tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009068", label="Incident ID", disabled=True)
