...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for getent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on getent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006954", label="Incident ID", disabled=True)
