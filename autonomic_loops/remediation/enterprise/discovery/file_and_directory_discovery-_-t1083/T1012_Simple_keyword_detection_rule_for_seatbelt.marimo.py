...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for seatbelt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on seatbelt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004832", label="Incident ID", disabled=True)
