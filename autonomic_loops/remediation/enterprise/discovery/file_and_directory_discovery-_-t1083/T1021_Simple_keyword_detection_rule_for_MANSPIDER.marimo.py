...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MANSPIDER
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MANSPIDER tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007264", label="Incident ID", disabled=True)
