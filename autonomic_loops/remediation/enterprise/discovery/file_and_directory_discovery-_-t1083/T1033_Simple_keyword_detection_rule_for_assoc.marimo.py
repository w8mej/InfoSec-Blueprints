...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for assoc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on assoc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004661", label="Incident ID", disabled=True)
