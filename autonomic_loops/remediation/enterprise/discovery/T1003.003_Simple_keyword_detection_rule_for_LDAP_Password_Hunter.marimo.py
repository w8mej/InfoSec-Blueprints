...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LDAP-Password-Hunter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LDAP-Password-Hunter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006206", label="Incident ID", disabled=True)
