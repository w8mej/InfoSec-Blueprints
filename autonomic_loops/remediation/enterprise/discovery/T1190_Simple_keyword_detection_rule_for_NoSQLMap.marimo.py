...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NoSQLMap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NoSQLMap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000755", label="Incident ID", disabled=True)
