...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UnquotedPath
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UnquotedPath tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007417", label="Incident ID", disabled=True)
