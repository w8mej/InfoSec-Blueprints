...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for warberry
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on warberry tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001504", label="Incident ID", disabled=True)
