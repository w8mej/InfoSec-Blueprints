...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009693", label="Incident ID", disabled=True)
