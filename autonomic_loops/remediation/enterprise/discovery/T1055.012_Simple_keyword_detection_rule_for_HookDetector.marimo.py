...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HookDetector
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HookDetector tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004666", label="Incident ID", disabled=True)
