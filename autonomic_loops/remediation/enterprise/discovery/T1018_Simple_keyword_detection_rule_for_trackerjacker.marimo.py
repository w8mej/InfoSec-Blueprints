...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for trackerjacker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on trackerjacker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902214", label="Incident ID", disabled=True)
