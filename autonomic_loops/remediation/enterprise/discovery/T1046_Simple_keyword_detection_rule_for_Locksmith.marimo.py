...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Locksmith
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Locksmith tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000474", label="Incident ID", disabled=True)
