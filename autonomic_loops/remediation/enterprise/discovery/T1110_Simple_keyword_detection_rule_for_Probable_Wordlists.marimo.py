...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Probable-Wordlists
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Probable-Wordlists tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000390", label="Incident ID", disabled=True)
