...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mspass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mspass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008765", label="Incident ID", disabled=True)
