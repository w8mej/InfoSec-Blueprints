...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects SharpLdapWhoami, a whoami alternative by asking the LDAP service on a domain controller
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305006", label="Incident ID", disabled=True)
