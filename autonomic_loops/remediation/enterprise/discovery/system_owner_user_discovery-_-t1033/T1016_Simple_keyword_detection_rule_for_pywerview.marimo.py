...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pywerview
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pywerview tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001972", label="Incident ID", disabled=True)
