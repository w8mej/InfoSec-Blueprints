...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CheckPlease
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CheckPlease tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009299", label="Incident ID", disabled=True)
