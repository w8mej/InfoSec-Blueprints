...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for torproject
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on torproject tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005597", label="Incident ID", disabled=True)
