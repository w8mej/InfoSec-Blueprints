...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sam-the-admin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sam-the-admin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002520", label="Incident ID", disabled=True)
