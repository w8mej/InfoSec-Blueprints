...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wapiti
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wapiti tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007949", label="Incident ID", disabled=True)
