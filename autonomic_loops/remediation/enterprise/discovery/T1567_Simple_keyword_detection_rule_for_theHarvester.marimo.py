...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for theHarvester
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on theHarvester tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004057", label="Incident ID", disabled=True)
