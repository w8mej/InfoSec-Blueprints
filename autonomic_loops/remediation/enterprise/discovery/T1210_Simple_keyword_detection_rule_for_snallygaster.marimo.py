...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for snallygaster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on snallygaster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007518", label="Incident ID", disabled=True)
