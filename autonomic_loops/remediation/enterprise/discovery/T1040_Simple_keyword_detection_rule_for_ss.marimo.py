...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ss
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ss tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906712", label="Incident ID", disabled=True)
