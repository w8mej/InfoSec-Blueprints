...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSQLPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSQLPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002515", label="Incident ID", disabled=True)
