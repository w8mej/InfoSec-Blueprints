...
def bluf(mo):
    mo.md(
        r"""
        # Enumeration of Access Control List Permissions
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects enumeration of DACL permissions on the AdminSDHolder or Domain Root objects
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305171", label="Incident ID", disabled=True)
