...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for msldapdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on msldapdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006161", label="Incident ID", disabled=True)
