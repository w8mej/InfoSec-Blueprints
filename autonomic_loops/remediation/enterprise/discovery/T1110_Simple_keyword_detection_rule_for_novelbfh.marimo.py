...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for novelbfh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on novelbfh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007783", label="Incident ID", disabled=True)
