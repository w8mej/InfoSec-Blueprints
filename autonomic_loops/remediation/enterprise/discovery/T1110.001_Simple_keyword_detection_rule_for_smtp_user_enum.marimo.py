...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smtp-user-enum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smtp-user-enum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009075", label="Incident ID", disabled=True)
