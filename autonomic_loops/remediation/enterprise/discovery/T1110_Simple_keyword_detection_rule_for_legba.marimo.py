...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for legba
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on legba tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000011", label="Incident ID", disabled=True)
