...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RustHound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RustHound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008522", label="Incident ID", disabled=True)
