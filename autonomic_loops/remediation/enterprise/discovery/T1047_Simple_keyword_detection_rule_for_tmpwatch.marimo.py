...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tmpwatch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tmpwatch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900441", label="Incident ID", disabled=True)
