...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GhostTask
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GhostTask tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900041", label="Incident ID", disabled=True)
