...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for badtouch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on badtouch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008482", label="Incident ID", disabled=True)
