...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpShares
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpShares tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005747", label="Incident ID", disabled=True)
