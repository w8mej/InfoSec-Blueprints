...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CMLoot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CMLoot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008223", label="Incident ID", disabled=True)
