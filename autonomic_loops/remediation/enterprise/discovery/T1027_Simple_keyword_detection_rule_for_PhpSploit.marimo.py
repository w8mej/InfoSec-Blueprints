...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PhpSploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PhpSploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008598", label="Incident ID", disabled=True)
