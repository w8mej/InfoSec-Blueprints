...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Github Username
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Github Username tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002324", label="Incident ID", disabled=True)
