...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for linWinPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on linWinPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002818", label="Incident ID", disabled=True)
