...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ipv4.myip.wtf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ipv4.myip.wtf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003309", label="Incident ID", disabled=True)
