...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-ProcessScan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-ProcessScan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005879", label="Incident ID", disabled=True)
