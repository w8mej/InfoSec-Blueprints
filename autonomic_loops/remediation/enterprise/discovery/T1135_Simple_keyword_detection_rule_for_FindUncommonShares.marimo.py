...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FindUncommonShares
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FindUncommonShares tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008198", label="Incident ID", disabled=True)
