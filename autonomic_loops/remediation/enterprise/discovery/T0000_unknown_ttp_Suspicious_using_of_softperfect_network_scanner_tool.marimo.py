...
def bluf(mo):
    mo.md(
        ...
        >
        > attacker can abuse legitemnt tool like softperfect network scanner to avoid detection in network
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306101", label="Incident ID", disabled=True)
