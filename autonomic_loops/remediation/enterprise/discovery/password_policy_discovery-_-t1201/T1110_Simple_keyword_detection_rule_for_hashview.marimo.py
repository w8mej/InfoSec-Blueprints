...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hashview
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hashview tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000247", label="Incident ID", disabled=True)
