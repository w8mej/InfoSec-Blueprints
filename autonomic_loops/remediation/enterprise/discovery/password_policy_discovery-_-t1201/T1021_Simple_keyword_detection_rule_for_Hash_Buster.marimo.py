...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hash-Buster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hash-Buster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006761", label="Incident ID", disabled=True)
