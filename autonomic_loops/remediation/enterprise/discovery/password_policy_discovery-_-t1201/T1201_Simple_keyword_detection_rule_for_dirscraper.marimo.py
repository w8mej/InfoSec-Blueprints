...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dirscraper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dirscraper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003898", label="Incident ID", disabled=True)
