...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ftype
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ftype tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001012", label="Incident ID", disabled=True)
