...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for COMHunter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on COMHunter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002113", label="Incident ID", disabled=True)
