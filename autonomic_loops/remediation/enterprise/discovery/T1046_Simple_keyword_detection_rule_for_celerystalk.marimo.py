...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for celerystalk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on celerystalk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008024", label="Incident ID", disabled=True)
