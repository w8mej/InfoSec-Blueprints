...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pspy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pspy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005037", label="Incident ID", disabled=True)
