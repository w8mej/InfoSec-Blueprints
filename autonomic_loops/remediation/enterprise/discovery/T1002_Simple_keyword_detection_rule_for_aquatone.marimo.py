...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for aquatone
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on aquatone tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005146", label="Incident ID", disabled=True)
