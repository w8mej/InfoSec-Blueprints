...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hakrawler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hakrawler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005856", label="Incident ID", disabled=True)
