...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Get-RBCD-Threaded
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Get-RBCD-Threaded tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005632", label="Incident ID", disabled=True)
