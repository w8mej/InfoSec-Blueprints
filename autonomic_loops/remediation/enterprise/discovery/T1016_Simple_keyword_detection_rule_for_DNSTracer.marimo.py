...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DNSTracer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DNSTracer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007873", label="Incident ID", disabled=True)
