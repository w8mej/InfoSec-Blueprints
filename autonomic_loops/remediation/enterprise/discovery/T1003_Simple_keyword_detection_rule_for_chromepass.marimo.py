...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chromepass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chromepass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009685", label="Incident ID", disabled=True)
