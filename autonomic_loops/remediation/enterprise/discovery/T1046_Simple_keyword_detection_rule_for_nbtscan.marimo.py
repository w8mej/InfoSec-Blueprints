...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nbtscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nbtscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007730", label="Incident ID", disabled=True)
