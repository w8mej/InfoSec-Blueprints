...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for movfuscator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on movfuscator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006952", label="Incident ID", disabled=True)
