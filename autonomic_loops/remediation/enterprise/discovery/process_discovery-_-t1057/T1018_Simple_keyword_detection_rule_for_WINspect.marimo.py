...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WINspect
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WINspect tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003517", label="Incident ID", disabled=True)
