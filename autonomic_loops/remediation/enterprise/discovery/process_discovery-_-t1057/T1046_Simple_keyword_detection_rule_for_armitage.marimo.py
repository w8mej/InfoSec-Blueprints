...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for armitage
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on armitage tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002640", label="Incident ID", disabled=True)
