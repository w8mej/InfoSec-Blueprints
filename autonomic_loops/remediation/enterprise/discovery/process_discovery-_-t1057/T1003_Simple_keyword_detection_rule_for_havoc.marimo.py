...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for havoc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on havoc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005178", label="Incident ID", disabled=True)
