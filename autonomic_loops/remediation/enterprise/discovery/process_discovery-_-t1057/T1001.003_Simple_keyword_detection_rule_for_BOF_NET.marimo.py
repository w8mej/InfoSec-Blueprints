...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BOF.NET
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BOF.NET tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906717", label="Incident ID", disabled=True)
