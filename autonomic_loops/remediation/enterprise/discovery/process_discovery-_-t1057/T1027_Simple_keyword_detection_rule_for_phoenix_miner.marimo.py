...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for phoenix miner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on phoenix miner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008052", label="Incident ID", disabled=True)
