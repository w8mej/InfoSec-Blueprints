...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RedHunt-OS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RedHunt-OS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003497", label="Incident ID", disabled=True)
