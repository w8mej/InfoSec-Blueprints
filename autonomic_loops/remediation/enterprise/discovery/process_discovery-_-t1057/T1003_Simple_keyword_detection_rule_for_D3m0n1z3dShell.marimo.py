...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for D3m0n1z3dShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on D3m0n1z3dShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003928", label="Incident ID", disabled=True)
