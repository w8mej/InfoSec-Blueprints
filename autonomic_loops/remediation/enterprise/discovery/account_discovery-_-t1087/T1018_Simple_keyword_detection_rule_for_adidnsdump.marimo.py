...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adidnsdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adidnsdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006101", label="Incident ID", disabled=True)
