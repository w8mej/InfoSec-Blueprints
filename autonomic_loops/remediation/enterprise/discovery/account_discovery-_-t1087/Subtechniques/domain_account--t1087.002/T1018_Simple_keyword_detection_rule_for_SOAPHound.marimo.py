...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SOAPHound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SOAPHound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002845", label="Incident ID", disabled=True)
