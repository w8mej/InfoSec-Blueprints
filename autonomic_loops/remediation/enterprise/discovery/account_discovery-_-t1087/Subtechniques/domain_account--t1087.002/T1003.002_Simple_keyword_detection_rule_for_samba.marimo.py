...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for samba
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on samba tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001384", label="Incident ID", disabled=True)
