...
def bluf(mo):
    mo.md(
        r"""
        # LDAP Reconnaissance / Account Enumeration
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects possible Active Directory account enumeration via LDAP
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303200", label="Incident ID", disabled=True)
