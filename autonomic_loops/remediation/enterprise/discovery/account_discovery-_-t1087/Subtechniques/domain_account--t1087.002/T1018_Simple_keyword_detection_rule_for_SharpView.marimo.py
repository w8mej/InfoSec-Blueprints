...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpView
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpView tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902838", label="Incident ID", disabled=True)
