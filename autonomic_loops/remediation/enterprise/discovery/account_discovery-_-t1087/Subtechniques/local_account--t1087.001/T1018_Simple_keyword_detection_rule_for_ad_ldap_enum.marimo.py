...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ad-ldap-enum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ad-ldap-enum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009243", label="Incident ID", disabled=True)
