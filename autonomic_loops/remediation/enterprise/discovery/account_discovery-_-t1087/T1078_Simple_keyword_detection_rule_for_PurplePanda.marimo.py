...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PurplePanda
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PurplePanda tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004167", label="Incident ID", disabled=True)
