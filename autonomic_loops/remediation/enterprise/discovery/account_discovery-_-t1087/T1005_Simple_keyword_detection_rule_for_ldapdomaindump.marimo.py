...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldapdomaindump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldapdomaindump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006718", label="Incident ID", disabled=True)
