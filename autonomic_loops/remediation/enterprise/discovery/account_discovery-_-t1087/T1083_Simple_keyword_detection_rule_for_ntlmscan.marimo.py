...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ntlmscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ntlmscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008696", label="Incident ID", disabled=True)
