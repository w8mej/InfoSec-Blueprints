...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AD_Enumeration_Hunt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AD_Enumeration_Hunt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009835", label="Incident ID", disabled=True)
