...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for empire
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on empire tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006127", label="Incident ID", disabled=True)
