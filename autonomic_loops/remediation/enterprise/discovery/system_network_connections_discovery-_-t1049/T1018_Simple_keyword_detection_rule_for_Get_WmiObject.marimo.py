...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Get-WmiObject
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Get-WmiObject tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003050", label="Incident ID", disabled=True)
