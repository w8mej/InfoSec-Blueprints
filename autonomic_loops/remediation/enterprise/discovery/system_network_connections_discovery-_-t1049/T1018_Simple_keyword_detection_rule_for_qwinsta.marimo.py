...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for qwinsta
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on qwinsta tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005900", label="Incident ID", disabled=True)
