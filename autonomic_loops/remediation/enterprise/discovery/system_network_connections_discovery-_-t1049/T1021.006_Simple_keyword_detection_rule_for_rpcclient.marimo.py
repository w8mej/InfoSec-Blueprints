...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rpcclient
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rpcclient tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906256", label="Incident ID", disabled=True)
