...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tcpreplay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tcpreplay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004730", label="Incident ID", disabled=True)
