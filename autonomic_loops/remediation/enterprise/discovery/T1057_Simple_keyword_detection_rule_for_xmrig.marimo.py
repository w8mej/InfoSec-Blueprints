...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for xmrig
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on xmrig tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004463", label="Incident ID", disabled=True)
