...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BloodHound.py
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BloodHound.py tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001842", label="Incident ID", disabled=True)
