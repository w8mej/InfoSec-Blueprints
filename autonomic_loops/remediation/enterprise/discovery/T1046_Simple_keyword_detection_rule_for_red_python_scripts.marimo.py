...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for red-python-scripts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on red-python-scripts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001767", label="Incident ID", disabled=True)
