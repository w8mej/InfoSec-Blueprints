...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for teamstracker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on teamstracker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008876", label="Incident ID", disabled=True)
