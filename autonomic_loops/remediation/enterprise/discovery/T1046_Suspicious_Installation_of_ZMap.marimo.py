...
def bluf(mo):
    mo.md(
        r"""
        # Suspicious Installation of ZMap
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects suspicious installation of ZMap
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1409039", label="Incident ID", disabled=True)
