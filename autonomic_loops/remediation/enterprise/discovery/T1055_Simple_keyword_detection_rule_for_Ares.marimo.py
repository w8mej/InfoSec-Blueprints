...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Ares
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Ares tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001178", label="Incident ID", disabled=True)
