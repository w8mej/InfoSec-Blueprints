...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for archerysec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on archerysec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007398", label="Incident ID", disabled=True)
