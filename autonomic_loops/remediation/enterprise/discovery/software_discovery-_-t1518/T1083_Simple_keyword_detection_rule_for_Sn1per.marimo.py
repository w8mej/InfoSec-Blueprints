...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Sn1per
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Sn1per tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002343", label="Incident ID", disabled=True)
