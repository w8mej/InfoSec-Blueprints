...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for whatlicense
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on whatlicense tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006227", label="Incident ID", disabled=True)
