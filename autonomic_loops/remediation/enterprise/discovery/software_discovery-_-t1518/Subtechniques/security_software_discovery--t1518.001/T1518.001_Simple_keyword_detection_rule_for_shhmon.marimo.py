...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for shhmon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on shhmon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002176", label="Incident ID", disabled=True)
