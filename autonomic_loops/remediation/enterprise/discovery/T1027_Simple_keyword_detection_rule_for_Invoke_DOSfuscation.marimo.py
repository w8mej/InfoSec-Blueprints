...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-DOSfuscation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-DOSfuscation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006907", label="Incident ID", disabled=True)
