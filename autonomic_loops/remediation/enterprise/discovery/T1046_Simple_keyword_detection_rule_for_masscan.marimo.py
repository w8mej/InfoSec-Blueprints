...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for masscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on masscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005510", label="Incident ID", disabled=True)
