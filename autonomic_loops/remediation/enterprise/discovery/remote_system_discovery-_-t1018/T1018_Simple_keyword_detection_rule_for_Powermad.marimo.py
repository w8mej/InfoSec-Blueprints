...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Powermad
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Powermad tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003869", label="Incident ID", disabled=True)
