...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpLDAP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpLDAP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001759", label="Incident ID", disabled=True)
