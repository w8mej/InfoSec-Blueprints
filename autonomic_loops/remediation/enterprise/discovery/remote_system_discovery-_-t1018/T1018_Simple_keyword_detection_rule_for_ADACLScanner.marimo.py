...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ADACLScanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ADACLScanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002718", label="Incident ID", disabled=True)
