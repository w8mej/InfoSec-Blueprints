...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nltest
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nltest tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007866", label="Incident ID", disabled=True)
