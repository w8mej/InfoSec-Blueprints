...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for onesixtyone
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on onesixtyone tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002739", label="Incident ID", disabled=True)
