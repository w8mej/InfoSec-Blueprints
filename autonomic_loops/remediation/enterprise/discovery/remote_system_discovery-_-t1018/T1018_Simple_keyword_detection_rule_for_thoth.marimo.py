...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for thoth
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on thoth tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007143", label="Incident ID", disabled=True)
