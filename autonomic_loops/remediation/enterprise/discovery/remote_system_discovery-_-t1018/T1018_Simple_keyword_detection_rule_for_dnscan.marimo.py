...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007433", label="Incident ID", disabled=True)
