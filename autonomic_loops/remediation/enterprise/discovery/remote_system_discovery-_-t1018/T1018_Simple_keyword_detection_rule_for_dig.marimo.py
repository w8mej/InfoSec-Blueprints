...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dig
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dig tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003521", label="Incident ID", disabled=True)
