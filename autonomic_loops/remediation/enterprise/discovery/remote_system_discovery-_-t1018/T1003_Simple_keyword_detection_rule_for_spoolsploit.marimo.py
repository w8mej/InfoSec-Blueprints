...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for spoolsploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on spoolsploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902809", label="Incident ID", disabled=True)
