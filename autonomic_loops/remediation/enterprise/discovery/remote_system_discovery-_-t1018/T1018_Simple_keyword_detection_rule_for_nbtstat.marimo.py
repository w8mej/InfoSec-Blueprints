...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nbtstat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nbtstat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004624", label="Incident ID", disabled=True)
