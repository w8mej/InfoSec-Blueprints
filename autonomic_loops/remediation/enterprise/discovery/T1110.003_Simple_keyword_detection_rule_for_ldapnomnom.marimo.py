...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldapnomnom
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldapnomnom tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003065", label="Incident ID", disabled=True)
