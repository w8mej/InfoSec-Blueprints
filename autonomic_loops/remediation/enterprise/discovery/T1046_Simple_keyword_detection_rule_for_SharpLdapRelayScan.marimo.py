...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpLdapRelayScan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpLdapRelayScan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006862", label="Incident ID", disabled=True)
