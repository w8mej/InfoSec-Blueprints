...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for https-portal
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on https-portal tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003250", label="Incident ID", disabled=True)
