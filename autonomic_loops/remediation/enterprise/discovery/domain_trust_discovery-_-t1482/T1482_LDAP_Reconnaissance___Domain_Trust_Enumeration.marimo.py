...
def bluf(mo):
    mo.md(
        r"""
        # LDAP Reconnaissance / Domain Trust Enumeration
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects possible Active Directory domain trust enumeration via LDAP
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303236", label="Incident ID", disabled=True)
