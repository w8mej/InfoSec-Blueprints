...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for softperfect networkscanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on softperfect networkscanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903992", label="Incident ID", disabled=True)
