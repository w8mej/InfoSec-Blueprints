...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for myexternalip.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on myexternalip.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009961", label="Incident ID", disabled=True)
