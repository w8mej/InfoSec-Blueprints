...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hping
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hping tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005961", label="Incident ID", disabled=True)
