...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Neo4j
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Neo4j tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003568", label="Incident ID", disabled=True)
