...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kalitorify
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kalitorify tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909160", label="Incident ID", disabled=True)
