...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Crassus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Crassus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002832", label="Incident ID", disabled=True)
