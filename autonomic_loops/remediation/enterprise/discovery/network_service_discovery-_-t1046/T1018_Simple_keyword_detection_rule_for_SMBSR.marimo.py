...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SMBSR
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SMBSR tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007303", label="Incident ID", disabled=True)
