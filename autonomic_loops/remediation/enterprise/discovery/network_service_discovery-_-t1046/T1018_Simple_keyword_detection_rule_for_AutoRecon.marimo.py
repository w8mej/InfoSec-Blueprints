...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AutoRecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AutoRecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009412", label="Incident ID", disabled=True)
