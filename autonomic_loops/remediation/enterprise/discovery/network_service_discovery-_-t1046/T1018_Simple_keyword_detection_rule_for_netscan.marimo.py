...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for netscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on netscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009302", label="Incident ID", disabled=True)
