...
def bluf(mo):
    mo.md(
        r"""
        # LDAP Reconnaissance / System Enumeration
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects possible Active Directory system enumeration via LDAP
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300956", label="Incident ID", disabled=True)
