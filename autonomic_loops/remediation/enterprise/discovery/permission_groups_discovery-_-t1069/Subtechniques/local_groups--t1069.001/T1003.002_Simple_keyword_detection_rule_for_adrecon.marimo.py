...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adrecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adrecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003647", label="Incident ID", disabled=True)
