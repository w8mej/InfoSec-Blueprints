...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker attempts to enumerate sensitive domain group settings and membership.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307366", label="Incident ID", disabled=True)
