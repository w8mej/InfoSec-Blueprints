...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker attempts to enumerate sensitive domain users/groups settings and membership.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1301254", label="Incident ID", disabled=True)
