...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LAPSToolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LAPSToolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001187", label="Incident ID", disabled=True)
