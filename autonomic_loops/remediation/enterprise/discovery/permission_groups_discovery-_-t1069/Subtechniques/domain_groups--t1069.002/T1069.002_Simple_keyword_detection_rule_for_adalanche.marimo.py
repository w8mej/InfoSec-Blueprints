...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adalanche
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adalanche tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002296", label="Incident ID", disabled=True)
