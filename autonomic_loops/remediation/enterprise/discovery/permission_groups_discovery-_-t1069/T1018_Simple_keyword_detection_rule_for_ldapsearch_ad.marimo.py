...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldapsearch-ad
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldapsearch-ad tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007041", label="Incident ID", disabled=True)
