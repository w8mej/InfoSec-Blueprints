...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for red-team-scripts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on red-team-scripts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008972", label="Incident ID", disabled=True)
