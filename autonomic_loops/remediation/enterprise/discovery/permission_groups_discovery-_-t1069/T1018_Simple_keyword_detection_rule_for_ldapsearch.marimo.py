...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldapsearch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldapsearch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008465", label="Incident ID", disabled=True)
