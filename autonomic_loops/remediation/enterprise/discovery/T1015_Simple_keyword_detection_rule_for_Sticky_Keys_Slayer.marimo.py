...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Sticky-Keys-Slayer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Sticky-Keys-Slayer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009931", label="Incident ID", disabled=True)
