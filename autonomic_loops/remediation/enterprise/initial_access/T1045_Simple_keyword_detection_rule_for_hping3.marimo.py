...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hping3
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hping3 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002626", label="Incident ID", disabled=True)
