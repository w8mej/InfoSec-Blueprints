...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SigPloit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SigPloit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009064", label="Incident ID", disabled=True)
