...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Crowbar
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Crowbar tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900539", label="Incident ID", disabled=True)
