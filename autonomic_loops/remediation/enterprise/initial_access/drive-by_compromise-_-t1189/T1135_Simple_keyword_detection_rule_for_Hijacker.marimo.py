...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hijacker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hijacker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001574", label="Incident ID", disabled=True)
