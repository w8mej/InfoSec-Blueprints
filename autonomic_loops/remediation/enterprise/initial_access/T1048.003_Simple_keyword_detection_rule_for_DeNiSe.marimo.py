...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DeNiSe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DeNiSe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003020", label="Incident ID", disabled=True)
