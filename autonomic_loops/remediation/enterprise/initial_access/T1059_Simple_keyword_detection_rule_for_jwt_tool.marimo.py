...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for jwt_tool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on jwt_tool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004118", label="Incident ID", disabled=True)
