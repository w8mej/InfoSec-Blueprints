...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for injectify
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on injectify tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005700", label="Incident ID", disabled=True)
