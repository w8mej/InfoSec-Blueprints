...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ssh-auditor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ssh-auditor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001463", label="Incident ID", disabled=True)
