...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for catspin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on catspin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008262", label="Incident ID", disabled=True)
