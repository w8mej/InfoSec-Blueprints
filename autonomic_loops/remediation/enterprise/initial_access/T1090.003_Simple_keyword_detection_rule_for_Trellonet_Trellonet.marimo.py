...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Trellonet Trellonet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Trellonet Trellonet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008032", label="Incident ID", disabled=True)
