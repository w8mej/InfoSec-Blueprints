...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Droopscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Droopscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901436", label="Incident ID", disabled=True)
