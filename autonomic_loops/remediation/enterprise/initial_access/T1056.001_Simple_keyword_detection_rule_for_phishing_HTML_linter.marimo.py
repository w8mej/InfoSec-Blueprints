...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for phishing-HTML-linter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on phishing-HTML-linter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008142", label="Incident ID", disabled=True)
