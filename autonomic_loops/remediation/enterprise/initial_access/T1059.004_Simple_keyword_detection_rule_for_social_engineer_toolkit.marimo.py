...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for social-engineer-toolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on social-engineer-toolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004366", label="Incident ID", disabled=True)
