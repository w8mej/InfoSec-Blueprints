...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hashcat-rule
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hashcat-rule tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005662", label="Incident ID", disabled=True)
