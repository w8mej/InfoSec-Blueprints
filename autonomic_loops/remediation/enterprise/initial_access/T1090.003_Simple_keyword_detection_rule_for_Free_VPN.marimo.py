...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007889", label="Incident ID", disabled=True)
