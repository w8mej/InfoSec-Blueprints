...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RandomPS-Scripts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RandomPS-Scripts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007683", label="Incident ID", disabled=True)
