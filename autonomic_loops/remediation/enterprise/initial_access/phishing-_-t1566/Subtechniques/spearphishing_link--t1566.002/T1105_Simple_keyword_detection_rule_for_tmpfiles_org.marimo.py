...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tmpfiles.org
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tmpfiles.org tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005588", label="Incident ID", disabled=True)
