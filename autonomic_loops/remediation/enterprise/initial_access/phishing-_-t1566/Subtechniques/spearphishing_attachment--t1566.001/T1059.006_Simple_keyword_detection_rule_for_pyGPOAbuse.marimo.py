...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pyGPOAbuse
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pyGPOAbuse tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906897", label="Incident ID", disabled=True)
