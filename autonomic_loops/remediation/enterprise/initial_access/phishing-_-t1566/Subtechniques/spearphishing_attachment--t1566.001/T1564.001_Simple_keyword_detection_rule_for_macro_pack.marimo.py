...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for macro_pack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on macro_pack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005003", label="Incident ID", disabled=True)
