...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for phishery
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on phishery tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009372", label="Incident ID", disabled=True)
