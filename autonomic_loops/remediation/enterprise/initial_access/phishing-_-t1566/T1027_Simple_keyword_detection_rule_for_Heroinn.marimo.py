...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Heroinn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Heroinn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000169", label="Incident ID", disabled=True)
