...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for windows-login-phish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on windows-login-phish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009230", label="Incident ID", disabled=True)
