...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for avet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on avet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008106", label="Incident ID", disabled=True)
