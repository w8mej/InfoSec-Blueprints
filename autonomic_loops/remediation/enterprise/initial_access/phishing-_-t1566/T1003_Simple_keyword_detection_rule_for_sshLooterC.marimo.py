...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sshLooterC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sshLooterC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008460", label="Incident ID", disabled=True)
