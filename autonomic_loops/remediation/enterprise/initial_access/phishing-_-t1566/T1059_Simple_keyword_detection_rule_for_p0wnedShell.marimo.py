...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for p0wnedShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on p0wnedShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009788", label="Incident ID", disabled=True)
