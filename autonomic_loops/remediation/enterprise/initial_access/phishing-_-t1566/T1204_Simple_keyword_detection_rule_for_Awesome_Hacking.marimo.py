...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Awesome-Hacking
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Awesome-Hacking tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008617", label="Incident ID", disabled=True)
