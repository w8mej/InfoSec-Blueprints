...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ReelPhish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ReelPhish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003097", label="Incident ID", disabled=True)
