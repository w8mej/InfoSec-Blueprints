...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HTMLSmuggler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HTMLSmuggler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006807", label="Incident ID", disabled=True)
