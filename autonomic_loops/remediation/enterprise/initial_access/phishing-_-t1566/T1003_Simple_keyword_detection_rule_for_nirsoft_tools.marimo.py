...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nirsoft tools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nirsoft tools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909390", label="Incident ID", disabled=True)
