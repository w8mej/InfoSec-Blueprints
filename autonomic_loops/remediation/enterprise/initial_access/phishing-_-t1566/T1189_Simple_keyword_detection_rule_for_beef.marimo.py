...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for beef
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on beef tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002899", label="Incident ID", disabled=True)
