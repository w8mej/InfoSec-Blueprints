...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FastStunnel VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FastStunnel VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900126", label="Incident ID", disabled=True)
