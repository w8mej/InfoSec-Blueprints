...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SpringCore0day
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SpringCore0day tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007408", label="Incident ID", disabled=True)
