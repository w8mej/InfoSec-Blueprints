...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nsa-rules
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nsa-rules tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008590", label="Incident ID", disabled=True)
