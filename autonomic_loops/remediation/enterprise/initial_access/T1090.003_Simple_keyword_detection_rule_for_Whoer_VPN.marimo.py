...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Whoer VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Whoer VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904954", label="Incident ID", disabled=True)
