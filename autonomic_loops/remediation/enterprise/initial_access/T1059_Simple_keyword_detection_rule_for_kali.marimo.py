...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kali
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kali tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903687", label="Incident ID", disabled=True)
