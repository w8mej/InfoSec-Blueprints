...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for interactsh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on interactsh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007210", label="Incident ID", disabled=True)
