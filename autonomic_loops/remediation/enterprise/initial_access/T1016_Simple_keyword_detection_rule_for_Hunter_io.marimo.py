...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hunter.io
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hunter.io tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007925", label="Incident ID", disabled=True)
