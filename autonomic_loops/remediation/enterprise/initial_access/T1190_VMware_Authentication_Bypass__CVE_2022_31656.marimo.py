...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects (CVE-2022-31656 exploitation attempt against VMware Authentication.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009238", label="Incident ID", disabled=True)
