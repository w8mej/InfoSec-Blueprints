...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for boko
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on boko tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006936", label="Incident ID", disabled=True)
