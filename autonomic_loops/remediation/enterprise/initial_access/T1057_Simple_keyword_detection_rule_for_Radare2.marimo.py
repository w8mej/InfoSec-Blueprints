...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Radare2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Radare2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007831", label="Incident ID", disabled=True)
