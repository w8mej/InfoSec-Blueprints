...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for teamsphisher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on teamsphisher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907806", label="Incident ID", disabled=True)
