...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MAAD-AF
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MAAD-AF tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000452", label="Incident ID", disabled=True)
