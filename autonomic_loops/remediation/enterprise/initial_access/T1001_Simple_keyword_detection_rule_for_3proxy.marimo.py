...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for 3proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on 3proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007133", label="Incident ID", disabled=True)
