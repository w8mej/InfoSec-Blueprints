...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for routerpasswords.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on routerpasswords.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000573", label="Incident ID", disabled=True)
