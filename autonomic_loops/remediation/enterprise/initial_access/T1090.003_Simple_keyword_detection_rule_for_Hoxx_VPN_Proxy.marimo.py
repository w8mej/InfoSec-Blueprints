...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hoxx VPN Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hoxx VPN Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008616", label="Incident ID", disabled=True)
