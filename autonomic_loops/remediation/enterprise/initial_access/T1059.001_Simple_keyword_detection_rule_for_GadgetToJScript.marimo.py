...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GadgetToJScript
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GadgetToJScript tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001985", label="Incident ID", disabled=True)
