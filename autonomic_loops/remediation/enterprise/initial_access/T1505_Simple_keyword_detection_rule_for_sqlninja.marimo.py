...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sqlninja
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sqlninja tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004707", label="Incident ID", disabled=True)
