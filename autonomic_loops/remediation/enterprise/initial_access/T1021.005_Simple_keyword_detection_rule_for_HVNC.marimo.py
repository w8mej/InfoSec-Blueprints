...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HVNC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HVNC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001281", label="Incident ID", disabled=True)
