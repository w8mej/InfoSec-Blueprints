...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TREVORspray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TREVORspray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003081", label="Incident ID", disabled=True)
