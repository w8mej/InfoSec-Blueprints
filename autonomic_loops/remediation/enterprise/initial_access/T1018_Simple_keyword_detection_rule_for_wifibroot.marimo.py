...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wifibroot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wifibroot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009725", label="Incident ID", disabled=True)
