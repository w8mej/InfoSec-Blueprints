...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MITMf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MITMf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007190", label="Incident ID", disabled=True)
