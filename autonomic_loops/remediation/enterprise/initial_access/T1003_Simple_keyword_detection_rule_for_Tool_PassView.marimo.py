...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Tool-PassView
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Tool-PassView tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004039", label="Incident ID", disabled=True)
