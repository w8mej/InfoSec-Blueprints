...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AdGuard VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AdGuard VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004796", label="Incident ID", disabled=True)
