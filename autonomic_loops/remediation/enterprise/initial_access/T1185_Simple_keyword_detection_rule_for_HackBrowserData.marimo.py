...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HackBrowserData
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HackBrowserData tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006168", label="Incident ID", disabled=True)
