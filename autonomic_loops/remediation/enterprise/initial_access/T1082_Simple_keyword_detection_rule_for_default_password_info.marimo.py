...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for default-password.info
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on default-password.info tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004372", label="Incident ID", disabled=True)
