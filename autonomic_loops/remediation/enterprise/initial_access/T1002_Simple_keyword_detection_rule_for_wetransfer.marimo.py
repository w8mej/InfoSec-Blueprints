...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wetransfer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wetransfer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003218", label="Incident ID", disabled=True)
