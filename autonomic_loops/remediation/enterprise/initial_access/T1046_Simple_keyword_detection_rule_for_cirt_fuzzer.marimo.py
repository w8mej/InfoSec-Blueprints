...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cirt-fuzzer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cirt-fuzzer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009172", label="Incident ID", disabled=True)
