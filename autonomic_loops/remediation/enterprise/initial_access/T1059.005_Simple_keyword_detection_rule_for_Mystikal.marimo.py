...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Mystikal
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Mystikal tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007916", label="Incident ID", disabled=True)
