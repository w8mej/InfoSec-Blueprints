...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for evilqr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on evilqr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008421", label="Incident ID", disabled=True)
