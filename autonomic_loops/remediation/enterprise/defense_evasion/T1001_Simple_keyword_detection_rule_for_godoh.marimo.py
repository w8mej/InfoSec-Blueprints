...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for godoh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on godoh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006532", label="Incident ID", disabled=True)
