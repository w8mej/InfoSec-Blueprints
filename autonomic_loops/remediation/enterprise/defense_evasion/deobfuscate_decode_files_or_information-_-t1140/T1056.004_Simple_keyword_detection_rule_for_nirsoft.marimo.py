...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nirsoft
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nirsoft tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003745", label="Incident ID", disabled=True)
