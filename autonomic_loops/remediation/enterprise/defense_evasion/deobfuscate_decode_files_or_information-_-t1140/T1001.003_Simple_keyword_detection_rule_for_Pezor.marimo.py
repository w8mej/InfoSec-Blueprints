...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pezor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pezor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002516", label="Incident ID", disabled=True)
