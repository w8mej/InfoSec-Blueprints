...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ADFSRelay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ADFSRelay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003705", label="Incident ID", disabled=True)
