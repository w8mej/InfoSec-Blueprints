...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for responder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on responder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004325", label="Incident ID", disabled=True)
