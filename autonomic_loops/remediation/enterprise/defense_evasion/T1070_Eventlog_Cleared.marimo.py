...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects a cleared Windows Eventlog as e.g. caused by "wevtutil cl" command execution
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309447", label="Incident ID", disabled=True)
