...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Phant0m
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Phant0m tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000870", label="Incident ID", disabled=True)
