...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SSRFmap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SSRFmap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004042", label="Incident ID", disabled=True)
