...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for zeroday-powershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on zeroday-powershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009101", label="Incident ID", disabled=True)
