...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Internal-Monologue
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Internal-Monologue tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000723", label="Incident ID", disabled=True)
