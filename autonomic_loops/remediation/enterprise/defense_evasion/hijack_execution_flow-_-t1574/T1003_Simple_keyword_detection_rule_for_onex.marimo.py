...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for onex
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on onex tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004214", label="Incident ID", disabled=True)
