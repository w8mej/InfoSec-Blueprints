...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pron VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pron VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005984", label="Incident ID", disabled=True)
