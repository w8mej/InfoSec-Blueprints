...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ssfd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ssfd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004767", label="Incident ID", disabled=True)
