...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for $index_allocation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on $index_allocation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000335", label="Incident ID", disabled=True)
