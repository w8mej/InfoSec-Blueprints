...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WindfarmDynamite
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WindfarmDynamite tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902799", label="Incident ID", disabled=True)
