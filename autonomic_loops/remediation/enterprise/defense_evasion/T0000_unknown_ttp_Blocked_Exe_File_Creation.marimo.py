...
def bluf(mo):
    mo.md(
        r"""
        # Blocked Exe File Creation
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Sysmon blocked an .exe file from being written to disk based on various suspicious conditions.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306507", label="Incident ID", disabled=True)
