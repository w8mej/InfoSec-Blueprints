...
def bluf(mo):
    mo.md(
        r"""
        # Code Integrity Proble (Possible Modification)
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects when hashes are not correct or a file does not meet Windows' security requirements.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300895", label="Incident ID", disabled=True)
