...
def bluf(mo):
    mo.md(
        r"""
        # PwSh 2.0 Downgrade Attack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > An attacker may have started Powershell 2.0 to evade detection.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303304", label="Incident ID", disabled=True)
