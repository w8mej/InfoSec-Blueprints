...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chimera
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chimera tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002020", label="Incident ID", disabled=True)
