...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nysm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nysm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003937", label="Incident ID", disabled=True)
