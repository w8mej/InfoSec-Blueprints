...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SignToolEx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SignToolEx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901598", label="Incident ID", disabled=True)
