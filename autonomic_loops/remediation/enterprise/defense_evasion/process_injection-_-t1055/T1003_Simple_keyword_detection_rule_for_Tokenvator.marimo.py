...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Tokenvator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Tokenvator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001949", label="Incident ID", disabled=True)
