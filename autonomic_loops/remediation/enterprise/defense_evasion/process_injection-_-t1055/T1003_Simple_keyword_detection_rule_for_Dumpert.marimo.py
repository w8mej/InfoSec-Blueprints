...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Dumpert
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Dumpert tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903852", label="Incident ID", disabled=True)
