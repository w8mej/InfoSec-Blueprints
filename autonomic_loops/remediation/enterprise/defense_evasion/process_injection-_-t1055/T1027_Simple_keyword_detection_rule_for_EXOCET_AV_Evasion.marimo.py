...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EXOCET-AV-Evasion
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EXOCET-AV-Evasion tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003656", label="Incident ID", disabled=True)
