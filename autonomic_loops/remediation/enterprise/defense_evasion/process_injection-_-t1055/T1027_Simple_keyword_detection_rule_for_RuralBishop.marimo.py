...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RuralBishop
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RuralBishop tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004828", label="Incident ID", disabled=True)
