...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DLLHijackTest
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DLLHijackTest tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008282", label="Incident ID", disabled=True)
