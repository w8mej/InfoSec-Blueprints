...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpBlock
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpBlock tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000486", label="Incident ID", disabled=True)
