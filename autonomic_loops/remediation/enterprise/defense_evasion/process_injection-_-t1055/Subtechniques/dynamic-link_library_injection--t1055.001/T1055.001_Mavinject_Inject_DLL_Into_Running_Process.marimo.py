...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects process injection using the signed Windows tool "Mavinject" via the "INJECTRUNNING" flag or a renamed execution of the tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306272", label="Incident ID", disabled=True)
