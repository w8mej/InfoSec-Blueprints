...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RunAsWinTcb
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RunAsWinTcb tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003264", label="Incident ID", disabled=True)
