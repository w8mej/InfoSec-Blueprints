...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ren
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ren tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005563", label="Incident ID", disabled=True)
