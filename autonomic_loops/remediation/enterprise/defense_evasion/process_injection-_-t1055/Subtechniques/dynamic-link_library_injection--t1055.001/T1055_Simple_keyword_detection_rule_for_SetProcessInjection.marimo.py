...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SetProcessInjection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SetProcessInjection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008909", label="Incident ID", disabled=True)
