...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Cordyceps
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Cordyceps tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006014", label="Incident ID", disabled=True)
