...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for movefile64.exe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on movefile64.exe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006646", label="Incident ID", disabled=True)
