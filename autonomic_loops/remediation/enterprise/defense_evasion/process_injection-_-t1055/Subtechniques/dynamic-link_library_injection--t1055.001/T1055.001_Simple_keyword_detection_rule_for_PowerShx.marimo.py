...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerShx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerShx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005503", label="Incident ID", disabled=True)
