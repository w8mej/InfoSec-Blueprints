...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pymultitor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pymultitor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001319", label="Incident ID", disabled=True)
