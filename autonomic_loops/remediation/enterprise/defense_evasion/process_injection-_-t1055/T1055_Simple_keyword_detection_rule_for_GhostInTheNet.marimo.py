...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GhostInTheNet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GhostInTheNet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906781", label="Incident ID", disabled=True)
