...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AMSI_patch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AMSI_patch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902165", label="Incident ID", disabled=True)
