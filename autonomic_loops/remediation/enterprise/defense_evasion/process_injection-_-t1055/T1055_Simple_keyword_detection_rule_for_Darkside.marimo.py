...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Darkside
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Darkside tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008172", label="Incident ID", disabled=True)
