...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSAttack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSAttack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005888", label="Incident ID", disabled=True)
