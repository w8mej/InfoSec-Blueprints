...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Cobaltstrike
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Cobaltstrike tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902612", label="Incident ID", disabled=True)
