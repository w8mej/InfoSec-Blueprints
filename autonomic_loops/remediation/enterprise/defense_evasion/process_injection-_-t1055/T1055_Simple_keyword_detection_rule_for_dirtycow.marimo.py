...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dirtycow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dirtycow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009840", label="Incident ID", disabled=True)
