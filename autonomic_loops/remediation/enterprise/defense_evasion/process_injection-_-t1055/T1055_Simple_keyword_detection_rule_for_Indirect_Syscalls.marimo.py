...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Indirect-Syscalls
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Indirect-Syscalls tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007341", label="Incident ID", disabled=True)
