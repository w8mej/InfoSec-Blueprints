...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BypassCredGuard
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BypassCredGuard tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002491", label="Incident ID", disabled=True)
