...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pypykatz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pypykatz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007151", label="Incident ID", disabled=True)
