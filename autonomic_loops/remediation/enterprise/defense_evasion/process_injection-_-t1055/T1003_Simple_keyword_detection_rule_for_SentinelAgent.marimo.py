...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SentinelAgent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SentinelAgent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007685", label="Incident ID", disabled=True)
