...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for avred
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on avred tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003275", label="Incident ID", disabled=True)
