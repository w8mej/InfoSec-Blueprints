...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerShell-Suite
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerShell-Suite tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000362", label="Incident ID", disabled=True)
