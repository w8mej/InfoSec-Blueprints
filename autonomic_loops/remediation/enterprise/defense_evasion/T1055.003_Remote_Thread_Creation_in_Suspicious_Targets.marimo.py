...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects a remote thread creation in suspicious target images
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305440", label="Incident ID", disabled=True)
