...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ntdlll-unhooking-collection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ntdlll-unhooking-collection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005301", label="Incident ID", disabled=True)
