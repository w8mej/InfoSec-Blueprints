...
def bluf(mo):
    mo.md(
        r"""
        # Suspicious Control Panel Applet Detected
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > A new Control Panel Applet was registered, or an unsigned Control Panel Applet was loaded. This technique can be used by threat actors to achieve persistence of a malicious DLL file using Control Panel.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300316", label="Incident ID", disabled=True)
