...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for JunctionFolder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on JunctionFolder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001489", label="Incident ID", disabled=True)
