...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPN.AC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPN.AC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005249", label="Incident ID", disabled=True)
