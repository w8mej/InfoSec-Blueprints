...
def bluf(mo):
    mo.md(
        r"""
        # WinApiExec Tool Executed
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects execution of legitimate WinApiExec tool, that allows running Windows API functions through command line parameters. This LOLBin is misused by InvisiMole Group to mask execution of malware, as reported in June 2020.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305456", label="Incident ID", disabled=True)
