...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AbandonedCOMKeys
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AbandonedCOMKeys tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003741", label="Incident ID", disabled=True)
