...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for icalcs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on icalcs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000776", label="Incident ID", disabled=True)
