...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DAMP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DAMP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007072", label="Incident ID", disabled=True)
