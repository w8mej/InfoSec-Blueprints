...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chattr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chattr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003179", label="Incident ID", disabled=True)
