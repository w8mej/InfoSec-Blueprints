...
def bluf(mo):
    mo.md(
        r"""
        # CobaltStrike BOF Injecting AMSI Bypass
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects the usage of a CobaltStrike BOF which injects an AMSI Bypass
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305515", label="Incident ID", disabled=True)
