...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003039", label="Incident ID", disabled=True)
