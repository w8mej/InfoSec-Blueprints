...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AdvancedRun
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AdvancedRun tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007654", label="Incident ID", disabled=True)
