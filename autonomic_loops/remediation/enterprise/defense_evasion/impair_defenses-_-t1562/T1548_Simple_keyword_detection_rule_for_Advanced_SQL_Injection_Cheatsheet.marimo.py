...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Advanced-SQL-Injection-Cheatsheet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Advanced-SQL-Injection-Cheatsheet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006236", label="Incident ID", disabled=True)
