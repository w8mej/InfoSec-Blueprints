...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSSW100AVB
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSSW100AVB tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002471", label="Incident ID", disabled=True)
