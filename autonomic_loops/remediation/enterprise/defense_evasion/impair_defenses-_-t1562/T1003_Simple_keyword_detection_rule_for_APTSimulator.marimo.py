...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for APTSimulator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on APTSimulator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003996", label="Incident ID", disabled=True)
