...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EvtMute
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EvtMute tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008910", label="Incident ID", disabled=True)
