...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EDRSilencer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EDRSilencer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007978", label="Incident ID", disabled=True)
