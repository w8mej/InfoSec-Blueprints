...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fltMC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fltMC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008648", label="Incident ID", disabled=True)
