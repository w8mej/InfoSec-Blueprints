...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BYOVD_kill_av_edr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BYOVD_kill_av_edr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005425", label="Incident ID", disabled=True)
