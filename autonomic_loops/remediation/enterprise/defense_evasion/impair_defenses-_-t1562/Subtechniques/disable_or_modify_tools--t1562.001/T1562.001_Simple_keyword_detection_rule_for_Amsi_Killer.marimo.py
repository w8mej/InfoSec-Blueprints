...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Amsi-Killer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Amsi-Killer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007093", label="Incident ID", disabled=True)
