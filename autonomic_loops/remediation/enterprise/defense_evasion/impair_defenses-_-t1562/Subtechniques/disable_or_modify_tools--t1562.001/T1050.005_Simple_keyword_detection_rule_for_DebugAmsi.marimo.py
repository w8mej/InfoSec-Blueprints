...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DebugAmsi
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DebugAmsi tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000007", label="Incident ID", disabled=True)
