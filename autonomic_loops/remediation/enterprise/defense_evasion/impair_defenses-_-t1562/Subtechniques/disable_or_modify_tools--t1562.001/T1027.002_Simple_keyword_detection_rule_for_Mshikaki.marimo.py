...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Mshikaki
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Mshikaki tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009882", label="Incident ID", disabled=True)
