...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Augustus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Augustus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000543", label="Incident ID", disabled=True)
