...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for amsi.fail
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on amsi.fail tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007173", label="Incident ID", disabled=True)
