...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MpCmdRun
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MpCmdRun tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005685", label="Incident ID", disabled=True)
