...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetLoader
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetLoader tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008264", label="Incident ID", disabled=True)
