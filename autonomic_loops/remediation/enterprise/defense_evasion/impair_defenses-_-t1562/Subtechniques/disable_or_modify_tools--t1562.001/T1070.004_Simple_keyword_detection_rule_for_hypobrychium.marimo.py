...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hypobrychium
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hypobrychium tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006509", label="Incident ID", disabled=True)
