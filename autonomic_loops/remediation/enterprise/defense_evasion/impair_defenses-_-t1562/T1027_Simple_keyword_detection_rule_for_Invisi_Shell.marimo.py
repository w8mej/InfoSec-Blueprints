...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invisi-Shell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invisi-Shell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004952", label="Incident ID", disabled=True)
