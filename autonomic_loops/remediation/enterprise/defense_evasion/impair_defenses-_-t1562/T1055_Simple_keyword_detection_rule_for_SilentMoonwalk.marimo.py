...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SilentMoonwalk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SilentMoonwalk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905252", label="Incident ID", disabled=True)
