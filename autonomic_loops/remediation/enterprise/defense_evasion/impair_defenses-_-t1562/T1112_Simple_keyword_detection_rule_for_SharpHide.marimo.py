...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpHide
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpHide tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006148", label="Incident ID", disabled=True)
