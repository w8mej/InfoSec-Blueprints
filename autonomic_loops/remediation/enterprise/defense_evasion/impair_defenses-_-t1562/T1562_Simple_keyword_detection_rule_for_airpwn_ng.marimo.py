...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for airpwn-ng
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on airpwn-ng tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009310", label="Incident ID", disabled=True)
