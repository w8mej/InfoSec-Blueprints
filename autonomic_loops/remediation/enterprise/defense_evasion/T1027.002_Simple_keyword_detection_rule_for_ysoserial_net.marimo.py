...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ysoserial.net
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ysoserial.net tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002480", label="Incident ID", disabled=True)
