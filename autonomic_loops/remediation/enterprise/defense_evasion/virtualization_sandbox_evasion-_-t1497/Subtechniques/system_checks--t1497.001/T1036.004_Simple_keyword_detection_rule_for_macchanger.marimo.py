...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for macchanger
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on macchanger tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008861", label="Incident ID", disabled=True)
