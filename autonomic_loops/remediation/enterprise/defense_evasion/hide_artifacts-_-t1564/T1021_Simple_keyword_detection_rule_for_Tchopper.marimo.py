...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Tchopper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Tchopper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006945", label="Incident ID", disabled=True)
