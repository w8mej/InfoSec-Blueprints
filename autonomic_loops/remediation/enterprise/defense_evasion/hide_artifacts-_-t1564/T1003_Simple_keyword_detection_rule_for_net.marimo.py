...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for net
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on net tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006874", label="Incident ID", disabled=True)
