...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for history
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on history tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009133", label="Incident ID", disabled=True)
