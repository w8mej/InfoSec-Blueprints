...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cut
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cut tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005048", label="Incident ID", disabled=True)
