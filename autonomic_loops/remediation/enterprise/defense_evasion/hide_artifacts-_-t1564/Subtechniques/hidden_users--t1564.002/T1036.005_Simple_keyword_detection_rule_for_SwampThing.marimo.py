...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SwampThing
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SwampThing tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002932", label="Incident ID", disabled=True)
