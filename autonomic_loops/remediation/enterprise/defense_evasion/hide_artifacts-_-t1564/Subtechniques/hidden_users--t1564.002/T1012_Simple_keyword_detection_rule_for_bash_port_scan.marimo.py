...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bash port scan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bash port scan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001726", label="Incident ID", disabled=True)
