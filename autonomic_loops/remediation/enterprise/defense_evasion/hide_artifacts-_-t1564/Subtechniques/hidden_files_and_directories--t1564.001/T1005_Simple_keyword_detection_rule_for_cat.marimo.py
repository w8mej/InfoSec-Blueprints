...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905720", label="Incident ID", disabled=True)
