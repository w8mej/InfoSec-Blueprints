...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EvilSln
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EvilSln tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002426", label="Incident ID", disabled=True)
