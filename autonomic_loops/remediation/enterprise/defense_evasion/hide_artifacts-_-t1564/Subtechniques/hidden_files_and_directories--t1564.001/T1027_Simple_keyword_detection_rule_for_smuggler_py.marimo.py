...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smuggler.py
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smuggler.py tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004256", label="Incident ID", disabled=True)
