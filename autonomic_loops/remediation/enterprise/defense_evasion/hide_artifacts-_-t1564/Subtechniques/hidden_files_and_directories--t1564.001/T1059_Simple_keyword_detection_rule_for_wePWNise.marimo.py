...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wePWNise
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wePWNise tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008493", label="Incident ID", disabled=True)
