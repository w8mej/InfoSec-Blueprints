...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VectorKernel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VectorKernel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003147", label="Incident ID", disabled=True)
