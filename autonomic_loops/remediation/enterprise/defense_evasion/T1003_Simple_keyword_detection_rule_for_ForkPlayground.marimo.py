...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ForkPlayground
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ForkPlayground tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000340", label="Incident ID", disabled=True)
