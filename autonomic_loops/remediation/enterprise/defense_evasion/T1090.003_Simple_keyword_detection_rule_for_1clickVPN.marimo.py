...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for 1clickVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on 1clickVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002827", label="Incident ID", disabled=True)
