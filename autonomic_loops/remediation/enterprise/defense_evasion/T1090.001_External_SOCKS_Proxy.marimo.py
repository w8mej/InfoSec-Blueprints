...
def bluf(mo):
    mo.md(
        ...
        >
        > Identifies a SOCKS proxy being outside of the network as defined by local_orig, local_resp. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="102927", label="Incident ID", disabled=True)
