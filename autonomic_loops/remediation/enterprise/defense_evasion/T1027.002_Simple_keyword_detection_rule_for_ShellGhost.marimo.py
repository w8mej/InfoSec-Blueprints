...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ShellGhost
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ShellGhost tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005337", label="Incident ID", disabled=True)
