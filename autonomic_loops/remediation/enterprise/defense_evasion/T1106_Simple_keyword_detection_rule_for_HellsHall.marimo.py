...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HellsHall
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HellsHall tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005085", label="Incident ID", disabled=True)
