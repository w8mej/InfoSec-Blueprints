...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LOLBAS-Project
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LOLBAS-Project tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005332", label="Incident ID", disabled=True)
