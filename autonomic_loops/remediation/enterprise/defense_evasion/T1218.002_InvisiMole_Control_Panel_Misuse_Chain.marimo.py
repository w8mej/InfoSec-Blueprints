...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole Control Panel Misuse Chain
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects artefacts associated with InvisiMole Control Panel persistence chain, as reported in June 2020
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302153", label="Incident ID", disabled=True)
