...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole UAC Bypass
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects artefacts and process activity associated with UAC bypass technique used by InvisiMole, as reported in June 2020.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302650", label="Incident ID", disabled=True)
