...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpBlackout
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpBlackout tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005407", label="Incident ID", disabled=True)
