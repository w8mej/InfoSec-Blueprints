...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Tor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Tor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004154", label="Incident ID", disabled=True)
