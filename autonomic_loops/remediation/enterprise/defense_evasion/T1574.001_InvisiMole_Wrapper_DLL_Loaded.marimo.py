...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole Wrapper DLL Loaded
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects process activity associated with InvisiMole loader, as reported in 2018
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300804", label="Incident ID", disabled=True)
