...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EternalHushFramework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EternalHushFramework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003620", label="Incident ID", disabled=True)
