...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HadesLdr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HadesLdr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004414", label="Incident ID", disabled=True)
