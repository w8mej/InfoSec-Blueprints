...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TokenTactics
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TokenTactics tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007483", label="Incident ID", disabled=True)
