...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for C2-Tool-Collection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on C2-Tool-Collection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900474", label="Incident ID", disabled=True)
