...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Shhhloader
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Shhhloader tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008660", label="Incident ID", disabled=True)
