...
def bluf(mo):
    mo.md(
        r"""
        # Abusable Invoke-ATHRemoteFXvGPUDisablementCommand - PowerShell Module
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308887", label="Incident ID", disabled=True)
