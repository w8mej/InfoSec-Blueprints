...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for covenant
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on covenant tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004878", label="Incident ID", disabled=True)
