...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpPack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpPack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000035", label="Incident ID", disabled=True)
