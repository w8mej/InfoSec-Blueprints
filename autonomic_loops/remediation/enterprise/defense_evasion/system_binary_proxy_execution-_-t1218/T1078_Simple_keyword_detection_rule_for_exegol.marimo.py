...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for exegol
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on exegol tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003762", label="Incident ID", disabled=True)
