...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Eternalblue-Doublepulsar-Metasploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Eternalblue-Doublepulsar-Metasploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000566", label="Incident ID", disabled=True)
