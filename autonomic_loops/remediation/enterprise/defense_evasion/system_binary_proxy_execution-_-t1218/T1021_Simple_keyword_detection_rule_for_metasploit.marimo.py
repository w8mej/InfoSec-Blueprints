...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for metasploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on metasploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004331", label="Incident ID", disabled=True)
