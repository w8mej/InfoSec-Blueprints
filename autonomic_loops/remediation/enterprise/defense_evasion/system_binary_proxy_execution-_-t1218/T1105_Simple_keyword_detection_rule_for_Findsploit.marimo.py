...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Findsploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Findsploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003801", label="Incident ID", disabled=True)
