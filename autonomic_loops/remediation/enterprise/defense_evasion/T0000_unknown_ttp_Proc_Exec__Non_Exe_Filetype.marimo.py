...
def bluf(mo):
    mo.md(
        r"""
        # Proc Exec (Non-Exe Filetype)
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Checks whether the image specified in a process creation event doesn't refer to an .exe file.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300903", label="Incident ID", disabled=True)
