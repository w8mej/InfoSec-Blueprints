...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for username-anarchy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on username-anarchy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002752", label="Incident ID", disabled=True)
