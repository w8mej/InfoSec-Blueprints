...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for impersonate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on impersonate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002837", label="Incident ID", disabled=True)
