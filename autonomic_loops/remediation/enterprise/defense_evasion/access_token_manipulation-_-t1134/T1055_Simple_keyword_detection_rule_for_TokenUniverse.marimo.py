...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TokenUniverse
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TokenUniverse tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007741", label="Incident ID", disabled=True)
