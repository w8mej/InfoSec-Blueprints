...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BesoToken
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BesoToken tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001638", label="Incident ID", disabled=True)
