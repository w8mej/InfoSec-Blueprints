...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Lime-Crypter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Lime-Crypter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008816", label="Incident ID", disabled=True)
