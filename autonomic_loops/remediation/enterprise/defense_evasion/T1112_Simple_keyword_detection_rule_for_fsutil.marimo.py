...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fsutil
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fsutil tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005445", label="Incident ID", disabled=True)
