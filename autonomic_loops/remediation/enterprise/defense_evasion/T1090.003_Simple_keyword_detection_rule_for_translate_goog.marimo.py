...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for translate.goog
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on translate.goog tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004165", label="Incident ID", disabled=True)
