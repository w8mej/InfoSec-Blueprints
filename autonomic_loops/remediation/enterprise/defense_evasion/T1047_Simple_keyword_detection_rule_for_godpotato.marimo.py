...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for godpotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on godpotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000564", label="Incident ID", disabled=True)
