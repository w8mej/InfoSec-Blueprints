...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for combine_harvester
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on combine_harvester tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007843", label="Incident ID", disabled=True)
