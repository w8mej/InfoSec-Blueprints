...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WorkingVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WorkingVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907980", label="Incident ID", disabled=True)
