...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free Residential VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free Residential VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009937", label="Incident ID", disabled=True)
