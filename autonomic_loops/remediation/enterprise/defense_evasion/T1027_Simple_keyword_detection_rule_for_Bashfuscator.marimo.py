...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Bashfuscator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Bashfuscator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002529", label="Incident ID", disabled=True)
