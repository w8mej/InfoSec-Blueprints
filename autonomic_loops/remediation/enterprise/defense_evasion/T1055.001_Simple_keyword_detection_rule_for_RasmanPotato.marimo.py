...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RasmanPotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RasmanPotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000029", label="Incident ID", disabled=True)
