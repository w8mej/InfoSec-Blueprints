...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for base64
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on base64 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004789", label="Incident ID", disabled=True)
