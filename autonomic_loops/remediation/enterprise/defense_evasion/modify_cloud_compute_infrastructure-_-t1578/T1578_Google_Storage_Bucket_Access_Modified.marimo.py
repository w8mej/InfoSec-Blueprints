...
def bluf(mo):
    mo.md(
        r"""
        # Google Storage Bucket Access Modified
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when a previously existing storage container has access control modified to enable public access
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="707815", label="Incident ID", disabled=True)
