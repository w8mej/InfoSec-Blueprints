...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Amsi_Bypass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Amsi_Bypass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002440", label="Incident ID", disabled=True)
