...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sniffer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sniffer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006620", label="Incident ID", disabled=True)
