...
def bluf(mo):
    mo.md(
        r"""
        # Execution of Remote Utilities RAT (RURAT) From Unusual Location
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects execution of Remote Utilities RAT (RURAT) from an unsual location (outisde of 'C:\Program Files')
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305426", label="Incident ID", disabled=True)
