...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerShdll
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerShdll tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007380", label="Incident ID", disabled=True)
