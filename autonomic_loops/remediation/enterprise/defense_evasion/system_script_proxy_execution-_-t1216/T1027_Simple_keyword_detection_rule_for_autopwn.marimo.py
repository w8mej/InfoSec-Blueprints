...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for autopwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on autopwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007312", label="Incident ID", disabled=True)
