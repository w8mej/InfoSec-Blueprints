...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hotspot Shield Elite VPN Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hotspot Shield Elite VPN Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006545", label="Incident ID", disabled=True)
