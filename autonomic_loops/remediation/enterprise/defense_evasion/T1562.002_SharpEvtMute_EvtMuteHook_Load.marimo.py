...
def bluf(mo):
    mo.md(
        r"""
        # SharpEvtMute EvtMuteHook Load
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects the use of SharpEvtHook, a tool to tamper with Windows event logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308724", label="Incident ID", disabled=True)
