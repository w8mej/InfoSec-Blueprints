...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DllNotificationInjection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DllNotificationInjection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908254", label="Incident ID", disabled=True)
