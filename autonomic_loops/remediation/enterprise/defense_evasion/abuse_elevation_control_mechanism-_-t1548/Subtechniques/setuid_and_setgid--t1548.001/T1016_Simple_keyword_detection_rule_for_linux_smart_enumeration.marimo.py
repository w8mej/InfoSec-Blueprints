...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for linux-smart-enumeration
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on linux-smart-enumeration tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007460", label="Incident ID", disabled=True)
