...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Windows_MSKSSRV_LPE_CVE-2023-36802
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Windows_MSKSSRV_LPE_CVE-2023-36802 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009177", label="Incident ID", disabled=True)
