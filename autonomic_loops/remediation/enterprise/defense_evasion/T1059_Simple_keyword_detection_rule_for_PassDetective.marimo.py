...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PassDetective
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PassDetective tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002618", label="Incident ID", disabled=True)
