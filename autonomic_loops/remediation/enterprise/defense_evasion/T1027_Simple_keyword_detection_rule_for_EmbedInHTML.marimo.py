...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EmbedInHTML
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EmbedInHTML tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000920", label="Incident ID", disabled=True)
