...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ifconfig
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ifconfig tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903986", label="Incident ID", disabled=True)
