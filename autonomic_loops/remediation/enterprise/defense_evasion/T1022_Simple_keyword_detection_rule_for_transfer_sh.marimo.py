...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for transfer.sh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on transfer.sh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905301", label="Incident ID", disabled=True)
