...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Eggshell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Eggshell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009354", label="Incident ID", disabled=True)
