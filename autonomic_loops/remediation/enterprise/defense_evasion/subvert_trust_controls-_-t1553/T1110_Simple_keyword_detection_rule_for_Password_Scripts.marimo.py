...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Password-Scripts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Password-Scripts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009570", label="Incident ID", disabled=True)
