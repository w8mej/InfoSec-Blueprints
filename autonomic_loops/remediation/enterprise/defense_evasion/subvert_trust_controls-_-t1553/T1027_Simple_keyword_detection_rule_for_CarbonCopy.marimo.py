...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CarbonCopy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CarbonCopy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006213", label="Incident ID", disabled=True)
