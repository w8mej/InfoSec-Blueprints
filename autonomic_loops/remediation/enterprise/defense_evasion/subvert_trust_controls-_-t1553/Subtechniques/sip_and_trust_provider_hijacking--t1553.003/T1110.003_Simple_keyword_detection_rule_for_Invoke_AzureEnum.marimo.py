...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-AzureEnum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-AzureEnum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003425", label="Incident ID", disabled=True)
