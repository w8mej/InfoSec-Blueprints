...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for InvisibilityCloak
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on InvisibilityCloak tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008183", label="Incident ID", disabled=True)
