...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Stardust
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Stardust tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004387", label="Incident ID", disabled=True)
