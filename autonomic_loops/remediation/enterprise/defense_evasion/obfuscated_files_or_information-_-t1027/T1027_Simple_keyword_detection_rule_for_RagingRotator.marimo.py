...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RagingRotator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RagingRotator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006414", label="Incident ID", disabled=True)
