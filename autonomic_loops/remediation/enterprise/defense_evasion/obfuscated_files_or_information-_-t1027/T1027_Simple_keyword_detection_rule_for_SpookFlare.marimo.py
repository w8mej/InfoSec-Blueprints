...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SpookFlare
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SpookFlare tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009722", label="Incident ID", disabled=True)
