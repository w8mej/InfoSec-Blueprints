...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nishang
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nishang tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003561", label="Incident ID", disabled=True)
