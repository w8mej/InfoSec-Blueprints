...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for htshells
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on htshells tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005209", label="Incident ID", disabled=True)
