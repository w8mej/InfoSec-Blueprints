...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for undertheradar
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on undertheradar tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008746", label="Incident ID", disabled=True)
