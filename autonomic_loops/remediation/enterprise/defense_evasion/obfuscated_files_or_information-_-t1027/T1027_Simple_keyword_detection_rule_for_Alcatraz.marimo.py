...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Alcatraz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Alcatraz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002655", label="Incident ID", disabled=True)
