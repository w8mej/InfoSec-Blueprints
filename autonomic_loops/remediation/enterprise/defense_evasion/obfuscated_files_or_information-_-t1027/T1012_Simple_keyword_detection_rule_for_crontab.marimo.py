...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for crontab
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on crontab tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009908", label="Incident ID", disabled=True)
