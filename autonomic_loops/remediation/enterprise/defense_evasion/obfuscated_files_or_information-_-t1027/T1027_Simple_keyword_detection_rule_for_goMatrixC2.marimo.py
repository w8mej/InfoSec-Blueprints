...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for goMatrixC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on goMatrixC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001643", label="Incident ID", disabled=True)
