...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FakeAMSI
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FakeAMSI tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005817", label="Incident ID", disabled=True)
