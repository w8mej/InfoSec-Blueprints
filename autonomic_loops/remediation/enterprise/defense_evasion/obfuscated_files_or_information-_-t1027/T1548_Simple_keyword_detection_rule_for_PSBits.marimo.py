...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSBits
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSBits tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905566", label="Incident ID", disabled=True)
