...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Shellcode-Downloader-CreateThread-Execution
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Shellcode-Downloader-CreateThread-Execution tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008533", label="Incident ID", disabled=True)
