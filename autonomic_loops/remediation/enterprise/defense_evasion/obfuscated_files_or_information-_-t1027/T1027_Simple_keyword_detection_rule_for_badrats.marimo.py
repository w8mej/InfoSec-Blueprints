...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for badrats
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on badrats tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001905", label="Incident ID", disabled=True)
