...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-BuildAnonymousSMBServer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-BuildAnonymousSMBServer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001614", label="Incident ID", disabled=True)
