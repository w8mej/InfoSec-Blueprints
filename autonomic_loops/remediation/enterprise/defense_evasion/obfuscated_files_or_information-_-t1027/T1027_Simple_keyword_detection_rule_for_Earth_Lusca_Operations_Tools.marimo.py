...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Earth Lusca Operations Tools 
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Earth Lusca Operations Tools  tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007919", label="Incident ID", disabled=True)
