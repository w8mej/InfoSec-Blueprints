...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OffensiveCSharp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OffensiveCSharp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006976", label="Incident ID", disabled=True)
