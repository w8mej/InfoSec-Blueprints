...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for IDiagnosticProfileUAC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on IDiagnosticProfileUAC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001328", label="Incident ID", disabled=True)
