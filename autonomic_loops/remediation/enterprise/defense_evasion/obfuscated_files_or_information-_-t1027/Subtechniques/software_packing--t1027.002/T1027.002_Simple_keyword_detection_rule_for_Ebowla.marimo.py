...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Ebowla
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Ebowla tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002282", label="Incident ID", disabled=True)
