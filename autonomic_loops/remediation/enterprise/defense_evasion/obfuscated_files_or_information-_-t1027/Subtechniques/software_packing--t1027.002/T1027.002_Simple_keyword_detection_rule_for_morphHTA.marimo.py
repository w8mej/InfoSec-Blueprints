...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for morphHTA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on morphHTA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009998", label="Incident ID", disabled=True)
