...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PPLBlade
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PPLBlade tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007988", label="Incident ID", disabled=True)
