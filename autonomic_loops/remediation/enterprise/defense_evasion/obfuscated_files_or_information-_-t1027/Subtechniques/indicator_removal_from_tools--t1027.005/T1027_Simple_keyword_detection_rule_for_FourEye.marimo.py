...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FourEye
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FourEye tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008638", label="Incident ID", disabled=True)
