...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ivy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ivy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001832", label="Incident ID", disabled=True)
