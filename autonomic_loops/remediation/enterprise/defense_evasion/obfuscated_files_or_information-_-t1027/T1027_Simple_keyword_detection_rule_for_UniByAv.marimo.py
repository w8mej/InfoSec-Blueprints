...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UniByAv
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UniByAv tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001334", label="Incident ID", disabled=True)
