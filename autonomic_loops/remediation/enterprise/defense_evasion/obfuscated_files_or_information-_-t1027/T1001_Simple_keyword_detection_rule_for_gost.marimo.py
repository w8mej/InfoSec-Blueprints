...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gost
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gost tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009498", label="Incident ID", disabled=True)
