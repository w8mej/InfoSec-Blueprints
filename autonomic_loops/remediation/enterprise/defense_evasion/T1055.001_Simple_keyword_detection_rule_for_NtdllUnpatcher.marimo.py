...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NtdllUnpatcher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NtdllUnpatcher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002159", label="Incident ID", disabled=True)
