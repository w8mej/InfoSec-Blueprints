...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bash keylogger
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bash keylogger tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007284", label="Incident ID", disabled=True)
