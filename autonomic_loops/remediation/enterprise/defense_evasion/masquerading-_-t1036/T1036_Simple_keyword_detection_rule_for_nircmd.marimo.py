...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nircmd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nircmd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007003", label="Incident ID", disabled=True)
