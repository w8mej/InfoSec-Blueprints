...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sharpcollection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sharpcollection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004483", label="Incident ID", disabled=True)
