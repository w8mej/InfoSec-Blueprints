...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ip
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ip tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006388", label="Incident ID", disabled=True)
