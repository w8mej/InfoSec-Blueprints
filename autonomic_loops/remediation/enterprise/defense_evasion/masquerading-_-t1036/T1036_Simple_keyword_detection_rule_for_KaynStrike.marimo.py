...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KaynStrike
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KaynStrike tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008414", label="Incident ID", disabled=True)
