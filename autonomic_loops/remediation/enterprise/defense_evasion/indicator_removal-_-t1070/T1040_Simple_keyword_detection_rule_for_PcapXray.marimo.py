...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PcapXray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PcapXray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006838", label="Incident ID", disabled=True)
