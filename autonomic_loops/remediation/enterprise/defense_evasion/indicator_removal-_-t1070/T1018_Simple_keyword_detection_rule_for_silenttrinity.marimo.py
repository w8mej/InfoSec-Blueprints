...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for silenttrinity
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on silenttrinity tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004421", label="Incident ID", disabled=True)
