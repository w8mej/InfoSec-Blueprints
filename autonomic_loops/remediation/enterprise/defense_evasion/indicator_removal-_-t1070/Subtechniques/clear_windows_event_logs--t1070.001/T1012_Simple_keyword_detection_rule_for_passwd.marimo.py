...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for passwd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on passwd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004837", label="Incident ID", disabled=True)
