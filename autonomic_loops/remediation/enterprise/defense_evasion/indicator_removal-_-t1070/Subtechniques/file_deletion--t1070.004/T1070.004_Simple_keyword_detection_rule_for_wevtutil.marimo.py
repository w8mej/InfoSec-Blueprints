...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wevtutil
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wevtutil tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006601", label="Incident ID", disabled=True)
