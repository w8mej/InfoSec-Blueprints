...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for shred
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on shred tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005452", label="Incident ID", disabled=True)
