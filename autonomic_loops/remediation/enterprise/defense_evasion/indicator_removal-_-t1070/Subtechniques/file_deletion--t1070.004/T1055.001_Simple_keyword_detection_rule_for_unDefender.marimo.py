...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for unDefender
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on unDefender tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004944", label="Incident ID", disabled=True)
