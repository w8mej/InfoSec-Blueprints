...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for elastic-agent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on elastic-agent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006254", label="Incident ID", disabled=True)
