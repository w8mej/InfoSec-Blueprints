...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for macetrap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on macetrap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003856", label="Incident ID", disabled=True)
