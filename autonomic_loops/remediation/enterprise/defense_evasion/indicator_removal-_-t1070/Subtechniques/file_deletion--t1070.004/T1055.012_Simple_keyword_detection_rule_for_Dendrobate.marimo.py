...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Dendrobate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Dendrobate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909788", label="Incident ID", disabled=True)
