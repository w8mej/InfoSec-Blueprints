...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for iptables
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on iptables tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009455", label="Incident ID", disabled=True)
