...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GhostMapper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GhostMapper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004012", label="Incident ID", disabled=True)
