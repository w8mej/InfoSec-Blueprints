...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rwxfinder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rwxfinder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000061", label="Incident ID", disabled=True)
