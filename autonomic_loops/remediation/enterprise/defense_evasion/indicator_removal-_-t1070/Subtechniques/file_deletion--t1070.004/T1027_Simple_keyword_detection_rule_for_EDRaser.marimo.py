...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EDRaser
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EDRaser tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006268", label="Incident ID", disabled=True)
