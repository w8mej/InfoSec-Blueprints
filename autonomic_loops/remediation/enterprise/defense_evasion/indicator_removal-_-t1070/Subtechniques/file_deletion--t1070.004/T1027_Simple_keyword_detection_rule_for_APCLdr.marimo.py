...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for APCLdr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on APCLdr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000294", label="Incident ID", disabled=True)
