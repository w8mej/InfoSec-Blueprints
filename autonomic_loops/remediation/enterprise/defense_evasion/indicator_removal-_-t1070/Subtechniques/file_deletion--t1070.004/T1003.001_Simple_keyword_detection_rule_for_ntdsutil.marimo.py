...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ntdsutil
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ntdsutil tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904787", label="Incident ID", disabled=True)
