...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for touch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on touch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909924", label="Incident ID", disabled=True)
