...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Stompy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Stompy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003734", label="Incident ID", disabled=True)
