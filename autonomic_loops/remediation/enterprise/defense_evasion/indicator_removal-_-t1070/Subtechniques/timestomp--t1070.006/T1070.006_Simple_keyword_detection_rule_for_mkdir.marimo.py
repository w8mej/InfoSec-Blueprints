...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mkdir
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mkdir tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001267", label="Incident ID", disabled=True)
