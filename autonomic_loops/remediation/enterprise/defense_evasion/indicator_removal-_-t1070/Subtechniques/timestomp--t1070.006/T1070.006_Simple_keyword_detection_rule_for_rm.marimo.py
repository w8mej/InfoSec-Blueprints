...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004203", label="Incident ID", disabled=True)
