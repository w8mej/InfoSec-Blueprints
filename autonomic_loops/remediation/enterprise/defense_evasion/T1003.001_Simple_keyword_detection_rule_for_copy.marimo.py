...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for copy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on copy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002690", label="Incident ID", disabled=True)
