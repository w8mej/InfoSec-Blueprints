...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DarkLoadLibrary
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DarkLoadLibrary tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008100", label="Incident ID", disabled=True)
