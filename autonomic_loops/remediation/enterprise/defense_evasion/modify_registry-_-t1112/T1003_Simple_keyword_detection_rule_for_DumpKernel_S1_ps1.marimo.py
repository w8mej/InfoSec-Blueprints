...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DumpKernel-S1.ps1
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DumpKernel-S1.ps1 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002337", label="Incident ID", disabled=True)
