...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HoneypotBuster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HoneypotBuster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007005", label="Incident ID", disabled=True)
