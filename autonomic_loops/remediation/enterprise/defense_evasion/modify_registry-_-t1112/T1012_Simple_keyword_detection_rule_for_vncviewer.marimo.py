...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vncviewer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vncviewer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001435", label="Incident ID", disabled=True)
