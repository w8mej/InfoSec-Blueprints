...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for inceptor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on inceptor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008419", label="Incident ID", disabled=True)
