...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cuddlephish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cuddlephish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001289", label="Incident ID", disabled=True)
