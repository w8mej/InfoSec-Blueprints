...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mitmproxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mitmproxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901671", label="Incident ID", disabled=True)
