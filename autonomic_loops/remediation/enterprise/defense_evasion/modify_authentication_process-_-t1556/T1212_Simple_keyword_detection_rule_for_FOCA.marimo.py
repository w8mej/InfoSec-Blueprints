...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FOCA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FOCA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004996", label="Incident ID", disabled=True)
