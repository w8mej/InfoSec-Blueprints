...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for InspectAssembly
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on InspectAssembly tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005689", label="Incident ID", disabled=True)
