...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hXOR-Packer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hXOR-Packer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004337", label="Incident ID", disabled=True)
