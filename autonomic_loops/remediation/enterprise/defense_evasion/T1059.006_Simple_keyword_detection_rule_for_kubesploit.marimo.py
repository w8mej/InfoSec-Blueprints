...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kubesploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kubesploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000440", label="Incident ID", disabled=True)
