...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hub VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hub VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008363", label="Incident ID", disabled=True)
