...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-PrintDemon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-PrintDemon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002207", label="Incident ID", disabled=True)
