...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sudoers
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sudoers tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901192", label="Incident ID", disabled=True)
