...
def bluf(mo):
    mo.md(
        r"""
        # Execution of NetSupport RAT From Unusual Location
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects execution of client32.exe (NetSupport RAT) from an unsual location (outisde of 'C:\Program Files')
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305911", label="Incident ID", disabled=True)
