...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UniversalDVC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UniversalDVC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009047", label="Incident ID", disabled=True)
