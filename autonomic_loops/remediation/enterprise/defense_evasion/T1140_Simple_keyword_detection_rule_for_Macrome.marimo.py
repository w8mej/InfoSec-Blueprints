...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Macrome
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Macrome tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000296", label="Incident ID", disabled=True)
