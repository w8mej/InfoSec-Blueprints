...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LightsOut
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LightsOut tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006728", label="Incident ID", disabled=True)
