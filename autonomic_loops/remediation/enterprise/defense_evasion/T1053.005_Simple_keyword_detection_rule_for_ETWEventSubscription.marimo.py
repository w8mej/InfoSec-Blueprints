...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ETWEventSubscription
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ETWEventSubscription tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007004", label="Incident ID", disabled=True)
