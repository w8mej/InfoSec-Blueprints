...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Lethean Proxy VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Lethean Proxy VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006689", label="Incident ID", disabled=True)
