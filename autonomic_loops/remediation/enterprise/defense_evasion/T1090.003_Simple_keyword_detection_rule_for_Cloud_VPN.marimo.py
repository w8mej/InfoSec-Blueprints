...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Cloud VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Cloud VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009233", label="Incident ID", disabled=True)
