...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AlanFramework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AlanFramework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003539", label="Incident ID", disabled=True)
