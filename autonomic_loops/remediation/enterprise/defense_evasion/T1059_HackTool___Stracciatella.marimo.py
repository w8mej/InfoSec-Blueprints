...
def bluf(mo):
    mo.md(
        r"""
        # HackTool - Stracciatella
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects hacktool 'Stracciatella' - OpSec-safe Powershell runspace from within C#
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305936", label="Incident ID", disabled=True)
