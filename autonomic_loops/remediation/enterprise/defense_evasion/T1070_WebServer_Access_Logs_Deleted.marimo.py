...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects the deletion of WebServer access logs which may indicate an attempt to destroy forensic evidence
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303951", label="Incident ID", disabled=True)
