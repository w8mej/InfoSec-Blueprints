...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Set-EtwTraceProvider
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Set-EtwTraceProvider tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007953", label="Incident ID", disabled=True)
