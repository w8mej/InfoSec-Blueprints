...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpKiller
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpKiller tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002679", label="Incident ID", disabled=True)
