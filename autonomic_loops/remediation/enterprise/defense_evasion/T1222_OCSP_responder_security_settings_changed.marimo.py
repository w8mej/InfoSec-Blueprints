...
def bluf(mo):
    mo.md(
        ...
        >
        > Dtects scenarios where an attacker would attempt to escalate privileges by changing the security settings of the responder.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307146", label="Incident ID", disabled=True)
