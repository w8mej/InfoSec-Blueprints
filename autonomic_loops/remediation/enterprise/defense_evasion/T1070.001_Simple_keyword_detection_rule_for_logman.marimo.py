...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for logman
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on logman tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006495", label="Incident ID", disabled=True)
