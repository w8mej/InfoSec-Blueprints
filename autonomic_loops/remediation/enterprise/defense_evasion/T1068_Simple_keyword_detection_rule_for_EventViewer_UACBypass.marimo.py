...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EventViewer-UACBypass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EventViewer-UACBypass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001999", label="Incident ID", disabled=True)
