...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpUnhooker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpUnhooker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002890", label="Incident ID", disabled=True)
