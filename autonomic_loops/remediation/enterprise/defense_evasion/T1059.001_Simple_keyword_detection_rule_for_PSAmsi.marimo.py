...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSAmsi
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSAmsi tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008335", label="Incident ID", disabled=True)
