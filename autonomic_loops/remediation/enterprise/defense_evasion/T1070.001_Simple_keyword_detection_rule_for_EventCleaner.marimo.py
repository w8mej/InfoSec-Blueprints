...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EventCleaner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EventCleaner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002007", label="Incident ID", disabled=True)
