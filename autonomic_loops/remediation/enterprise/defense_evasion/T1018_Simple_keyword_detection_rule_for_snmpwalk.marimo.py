...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for snmpwalk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on snmpwalk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002649", label="Incident ID", disabled=True)
