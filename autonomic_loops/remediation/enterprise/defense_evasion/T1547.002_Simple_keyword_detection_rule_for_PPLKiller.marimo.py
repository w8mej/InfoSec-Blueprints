...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PPLKiller
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PPLKiller tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007464", label="Incident ID", disabled=True)
