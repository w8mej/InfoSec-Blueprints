...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Spartacus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Spartacus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003046", label="Incident ID", disabled=True)
