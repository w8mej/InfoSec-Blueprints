...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ZenMate VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ZenMate VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904610", label="Incident ID", disabled=True)
