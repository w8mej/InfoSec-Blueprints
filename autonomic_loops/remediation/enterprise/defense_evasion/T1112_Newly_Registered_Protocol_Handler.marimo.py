...
def bluf(mo):
    mo.md(
        r"""
        # Newly Registered Protocol Handler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects when a new custom protocole handler is registered
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300167", label="Incident ID", disabled=True)
