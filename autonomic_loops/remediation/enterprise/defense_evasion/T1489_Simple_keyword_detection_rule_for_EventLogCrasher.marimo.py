...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EventLogCrasher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EventLogCrasher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000898", label="Incident ID", disabled=True)
