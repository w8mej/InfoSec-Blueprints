...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Blackout
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Blackout tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004319", label="Incident ID", disabled=True)
