...
def bluf(mo):
    mo.md(
        r"""
        # Suspicious Uncommon Download with BITS from Suspicious TLD
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302562", label="Incident ID", disabled=True)
