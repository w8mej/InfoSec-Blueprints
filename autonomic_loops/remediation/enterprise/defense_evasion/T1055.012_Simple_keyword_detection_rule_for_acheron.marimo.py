...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for acheron
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on acheron tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009600", label="Incident ID", disabled=True)
