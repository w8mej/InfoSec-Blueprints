...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LOLSpoof
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LOLSpoof tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004413", label="Incident ID", disabled=True)
