...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for catbox.moe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on catbox.moe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009567", label="Incident ID", disabled=True)
