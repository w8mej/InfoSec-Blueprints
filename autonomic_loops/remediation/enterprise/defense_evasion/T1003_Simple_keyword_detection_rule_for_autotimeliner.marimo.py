...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for autotimeliner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on autotimeliner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008988", label="Incident ID", disabled=True)
