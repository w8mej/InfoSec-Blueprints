...
def bluf(mo):
    mo.md(
        ...
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > This should be used as a guide to filter for known and unknown proxies on your network being used.  This rule detects external proxies using Corelight and Zeek http log. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="106623", label="Incident ID", disabled=True)
