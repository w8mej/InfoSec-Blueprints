...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PoolParty
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PoolParty tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006241", label="Incident ID", disabled=True)
