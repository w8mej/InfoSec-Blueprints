...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nipe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nipe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001191", label="Incident ID", disabled=True)
