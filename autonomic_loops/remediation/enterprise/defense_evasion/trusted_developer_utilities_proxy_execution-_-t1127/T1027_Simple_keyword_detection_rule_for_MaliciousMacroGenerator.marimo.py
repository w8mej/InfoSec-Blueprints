...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MaliciousMacroGenerator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MaliciousMacroGenerator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004450", label="Incident ID", disabled=True)
