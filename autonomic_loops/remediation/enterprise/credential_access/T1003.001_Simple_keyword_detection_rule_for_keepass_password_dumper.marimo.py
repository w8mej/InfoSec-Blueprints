...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for keepass-password-dumper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on keepass-password-dumper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003857", label="Incident ID", disabled=True)
