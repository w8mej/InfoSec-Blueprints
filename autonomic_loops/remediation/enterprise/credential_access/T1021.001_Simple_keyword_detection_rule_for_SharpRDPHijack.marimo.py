...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpRDPHijack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpRDPHijack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008599", label="Incident ID", disabled=True)
