...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EvilnoVNC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EvilnoVNC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008671", label="Incident ID", disabled=True)
