...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpTerminator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpTerminator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006186", label="Incident ID", disabled=True)
