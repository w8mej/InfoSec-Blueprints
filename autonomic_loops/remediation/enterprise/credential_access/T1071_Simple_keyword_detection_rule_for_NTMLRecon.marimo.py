...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NTMLRecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NTMLRecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006885", label="Incident ID", disabled=True)
