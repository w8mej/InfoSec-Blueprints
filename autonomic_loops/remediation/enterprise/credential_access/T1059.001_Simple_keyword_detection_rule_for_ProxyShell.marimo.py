...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ProxyShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ProxyShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009513", label="Incident ID", disabled=True)
