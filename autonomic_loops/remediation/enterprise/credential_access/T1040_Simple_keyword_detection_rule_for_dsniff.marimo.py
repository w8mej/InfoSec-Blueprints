...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dsniff
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dsniff tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008796", label="Incident ID", disabled=True)
