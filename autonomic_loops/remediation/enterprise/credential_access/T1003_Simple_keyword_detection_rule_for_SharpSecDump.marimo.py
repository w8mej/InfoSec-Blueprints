...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSecDump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSecDump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003905", label="Incident ID", disabled=True)
