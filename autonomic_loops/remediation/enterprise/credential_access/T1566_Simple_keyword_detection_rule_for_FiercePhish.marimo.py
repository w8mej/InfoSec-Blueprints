...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FiercePhish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FiercePhish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006742", label="Incident ID", disabled=True)
