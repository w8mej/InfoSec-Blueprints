...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sccmdecryptpoc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sccmdecryptpoc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003195", label="Incident ID", disabled=True)
