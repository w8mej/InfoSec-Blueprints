...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Gorsair
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Gorsair tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001443", label="Incident ID", disabled=True)
