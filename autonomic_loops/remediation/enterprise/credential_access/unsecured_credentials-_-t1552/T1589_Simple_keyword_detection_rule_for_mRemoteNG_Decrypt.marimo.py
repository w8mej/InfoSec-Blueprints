...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mRemoteNG-Decrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mRemoteNG-Decrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007958", label="Incident ID", disabled=True)
