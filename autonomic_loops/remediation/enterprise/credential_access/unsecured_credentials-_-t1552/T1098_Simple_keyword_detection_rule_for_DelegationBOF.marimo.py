...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DelegationBOF
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DelegationBOF tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005990", label="Incident ID", disabled=True)
