...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for reapoc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on reapoc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001869", label="Incident ID", disabled=True)
