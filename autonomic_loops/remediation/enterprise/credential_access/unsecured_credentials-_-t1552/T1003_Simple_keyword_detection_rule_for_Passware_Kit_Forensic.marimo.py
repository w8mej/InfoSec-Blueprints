...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Passware Kit Forensic
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Passware Kit Forensic tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004992", label="Incident ID", disabled=True)
