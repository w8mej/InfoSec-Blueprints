...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for 3snake
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on 3snake tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001111", label="Incident ID", disabled=True)
