...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BloodHound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BloodHound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001888", label="Incident ID", disabled=True)
