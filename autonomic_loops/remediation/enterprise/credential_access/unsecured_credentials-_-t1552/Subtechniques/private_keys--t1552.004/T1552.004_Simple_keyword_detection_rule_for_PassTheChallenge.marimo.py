...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PassTheChallenge
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PassTheChallenge tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903882", label="Incident ID", disabled=True)
