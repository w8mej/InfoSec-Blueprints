...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SSH-Snake
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SSH-Snake tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007717", label="Incident ID", disabled=True)
