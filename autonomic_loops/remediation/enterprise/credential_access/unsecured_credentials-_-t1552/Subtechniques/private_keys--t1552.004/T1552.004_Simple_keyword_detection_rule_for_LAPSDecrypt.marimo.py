...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LAPSDecrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LAPSDecrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004277", label="Incident ID", disabled=True)
