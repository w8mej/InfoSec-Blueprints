...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WorldWind-Stealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WorldWind-Stealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004139", label="Incident ID", disabled=True)
