...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GPOddity
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GPOddity tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006393", label="Incident ID", disabled=True)
