...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gMSADumper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gMSADumper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002696", label="Incident ID", disabled=True)
