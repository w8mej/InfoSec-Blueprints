...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for veeam-creds
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on veeam-creds tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005416", label="Incident ID", disabled=True)
