...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ssh-mitm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ssh-mitm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001109", label="Incident ID", disabled=True)
