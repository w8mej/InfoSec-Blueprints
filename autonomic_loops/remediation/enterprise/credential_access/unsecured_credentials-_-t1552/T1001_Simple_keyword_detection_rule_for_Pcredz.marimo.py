...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pcredz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pcredz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901746", label="Incident ID", disabled=True)
