...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WSPCoerce
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WSPCoerce tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007617", label="Incident ID", disabled=True)
