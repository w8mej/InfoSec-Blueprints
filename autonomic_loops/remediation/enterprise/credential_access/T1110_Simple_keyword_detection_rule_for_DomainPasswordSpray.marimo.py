...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DomainPasswordSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DomainPasswordSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903942", label="Incident ID", disabled=True)
