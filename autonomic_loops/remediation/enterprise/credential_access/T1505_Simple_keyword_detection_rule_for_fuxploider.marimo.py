...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fuxploider
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fuxploider tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000519", label="Incident ID", disabled=True)
