...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for samdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on samdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004126", label="Incident ID", disabled=True)
