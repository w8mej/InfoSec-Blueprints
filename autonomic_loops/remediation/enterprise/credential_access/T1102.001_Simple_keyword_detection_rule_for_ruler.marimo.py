...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ruler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ruler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002446", label="Incident ID", disabled=True)
