...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ADCSPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ADCSPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002972", label="Incident ID", disabled=True)
