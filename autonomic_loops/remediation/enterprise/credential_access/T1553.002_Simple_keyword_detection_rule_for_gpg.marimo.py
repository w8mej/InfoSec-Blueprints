...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gpg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gpg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009828", label="Incident ID", disabled=True)
