...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GreatSCT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GreatSCT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006993", label="Incident ID", disabled=True)
