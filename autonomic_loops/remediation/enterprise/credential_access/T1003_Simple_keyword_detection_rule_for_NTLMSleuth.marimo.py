...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NTLMSleuth
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NTLMSleuth tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005872", label="Incident ID", disabled=True)
