...
def bluf(mo):
    mo.md(
        r"""
        # SQLite Chrome Cookie DB Access
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detect use of sqlite binary to query the Chrome Cookies database and steal the cookie data contained within it
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307868", label="Incident ID", disabled=True)
