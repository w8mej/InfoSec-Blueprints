...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ADFSpoof
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ADFSpoof tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903612", label="Incident ID", disabled=True)
