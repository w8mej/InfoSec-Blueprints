...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Procdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Procdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001637", label="Incident ID", disabled=True)
