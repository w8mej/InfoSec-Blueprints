...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-WCMDump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-WCMDump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007215", label="Incident ID", disabled=True)
