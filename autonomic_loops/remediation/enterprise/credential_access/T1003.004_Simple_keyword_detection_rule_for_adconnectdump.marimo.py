...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adconnectdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adconnectdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001895", label="Incident ID", disabled=True)
