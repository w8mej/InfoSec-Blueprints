...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PstPassword
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PstPassword tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004255", label="Incident ID", disabled=True)
