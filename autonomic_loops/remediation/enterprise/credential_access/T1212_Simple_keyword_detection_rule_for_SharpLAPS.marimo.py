...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpLAPS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpLAPS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004758", label="Incident ID", disabled=True)
