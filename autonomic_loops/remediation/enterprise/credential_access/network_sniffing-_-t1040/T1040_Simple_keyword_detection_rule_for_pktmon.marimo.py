...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pktmon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pktmon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000561", label="Incident ID", disabled=True)
