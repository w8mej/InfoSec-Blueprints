...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wireshark
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wireshark tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003813", label="Incident ID", disabled=True)
