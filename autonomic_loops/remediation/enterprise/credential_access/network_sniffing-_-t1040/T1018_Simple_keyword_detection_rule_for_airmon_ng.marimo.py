...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for airmon-ng
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on airmon-ng tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005380", label="Incident ID", disabled=True)
