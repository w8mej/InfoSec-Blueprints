...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for net-creds
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on net-creds tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001839", label="Incident ID", disabled=True)
