...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for orbitaldump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on orbitaldump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008069", label="Incident ID", disabled=True)
