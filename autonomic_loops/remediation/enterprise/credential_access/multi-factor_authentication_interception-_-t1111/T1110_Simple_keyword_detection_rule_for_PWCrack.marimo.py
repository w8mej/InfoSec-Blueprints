...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PWCrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PWCrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002595", label="Incident ID", disabled=True)
