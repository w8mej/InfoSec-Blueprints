...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for changeme
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on changeme tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009953", label="Incident ID", disabled=True)
