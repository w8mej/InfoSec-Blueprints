...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gocrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gocrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008148", label="Incident ID", disabled=True)
