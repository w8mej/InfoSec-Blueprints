...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects browsers starting with the '--remote-debugging' flag. Which is a technique often used to perform browser injection attacks
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309083", label="Incident ID", disabled=True)
