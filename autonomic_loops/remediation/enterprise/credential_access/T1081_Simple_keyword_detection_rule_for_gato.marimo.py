...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009569", label="Incident ID", disabled=True)
