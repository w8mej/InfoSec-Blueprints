...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for C2 related tools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on C2 related tools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008661", label="Incident ID", disabled=True)
