...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Adamantium-Thief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Adamantium-Thief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006969", label="Incident ID", disabled=True)
