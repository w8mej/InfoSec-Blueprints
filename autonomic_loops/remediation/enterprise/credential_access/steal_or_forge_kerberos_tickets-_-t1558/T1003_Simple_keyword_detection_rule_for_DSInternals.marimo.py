...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DSInternals
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DSInternals tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904452", label="Incident ID", disabled=True)
