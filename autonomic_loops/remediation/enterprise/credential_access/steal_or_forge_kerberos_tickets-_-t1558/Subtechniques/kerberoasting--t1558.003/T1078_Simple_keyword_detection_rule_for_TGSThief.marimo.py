...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TGSThief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TGSThief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001414", label="Incident ID", disabled=True)
