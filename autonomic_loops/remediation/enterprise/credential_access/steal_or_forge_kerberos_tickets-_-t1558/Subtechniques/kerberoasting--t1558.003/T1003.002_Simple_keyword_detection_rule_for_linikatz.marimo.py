...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for linikatz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on linikatz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902667", label="Incident ID", disabled=True)
