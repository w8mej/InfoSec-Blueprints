...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NtlmThief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NtlmThief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906238", label="Incident ID", disabled=True)
