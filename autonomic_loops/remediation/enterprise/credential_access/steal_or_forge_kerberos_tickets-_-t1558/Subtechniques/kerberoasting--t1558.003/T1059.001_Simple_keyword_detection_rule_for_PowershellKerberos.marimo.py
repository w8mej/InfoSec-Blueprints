...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowershellKerberos
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowershellKerberos tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000508", label="Incident ID", disabled=True)
