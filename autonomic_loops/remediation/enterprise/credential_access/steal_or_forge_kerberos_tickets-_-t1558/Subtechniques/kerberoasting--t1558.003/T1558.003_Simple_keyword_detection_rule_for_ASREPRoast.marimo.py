...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ASREPRoast
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ASREPRoast tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006652", label="Incident ID", disabled=True)
