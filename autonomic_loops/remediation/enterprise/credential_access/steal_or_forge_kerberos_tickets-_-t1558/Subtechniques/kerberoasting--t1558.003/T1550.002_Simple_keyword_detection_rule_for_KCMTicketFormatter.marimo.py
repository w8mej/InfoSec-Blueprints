...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KCMTicketFormatter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KCMTicketFormatter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002022", label="Incident ID", disabled=True)
