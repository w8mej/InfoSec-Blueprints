...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dcipher-cli
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dcipher-cli tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009655", label="Incident ID", disabled=True)
