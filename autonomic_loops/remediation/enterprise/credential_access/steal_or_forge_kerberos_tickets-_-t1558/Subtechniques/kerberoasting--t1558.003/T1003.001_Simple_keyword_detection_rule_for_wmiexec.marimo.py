...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wmiexec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wmiexec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001485", label="Incident ID", disabled=True)
