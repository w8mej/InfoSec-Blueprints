...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetNTLMtoSilverTicket
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetNTLMtoSilverTicket tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001360", label="Incident ID", disabled=True)
