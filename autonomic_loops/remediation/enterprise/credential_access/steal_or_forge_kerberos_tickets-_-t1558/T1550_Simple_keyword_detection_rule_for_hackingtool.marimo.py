...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hackingtool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hackingtool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005196", label="Incident ID", disabled=True)
