...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Egress-Assess
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Egress-Assess tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008307", label="Incident ID", disabled=True)
