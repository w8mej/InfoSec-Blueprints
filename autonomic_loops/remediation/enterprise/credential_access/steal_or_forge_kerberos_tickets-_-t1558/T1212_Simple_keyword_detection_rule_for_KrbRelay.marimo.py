...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KrbRelay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KrbRelay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005253", label="Incident ID", disabled=True)
