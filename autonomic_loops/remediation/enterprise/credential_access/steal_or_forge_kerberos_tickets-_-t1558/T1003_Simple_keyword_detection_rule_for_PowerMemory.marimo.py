...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerMemory
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerMemory tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000445", label="Incident ID", disabled=True)
