...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for lsarelayx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on lsarelayx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009541", label="Incident ID", disabled=True)
