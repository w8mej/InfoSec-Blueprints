...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for whiskeysamlandfriends
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on whiskeysamlandfriends tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006836", label="Incident ID", disabled=True)
