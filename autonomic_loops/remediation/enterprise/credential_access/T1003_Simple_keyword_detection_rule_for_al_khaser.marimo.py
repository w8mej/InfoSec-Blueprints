...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for al-khaser
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on al-khaser tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006079", label="Incident ID", disabled=True)
