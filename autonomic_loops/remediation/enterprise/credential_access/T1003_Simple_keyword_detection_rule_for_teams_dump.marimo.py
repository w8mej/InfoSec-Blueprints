...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for teams_dump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on teams_dump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008871", label="Incident ID", disabled=True)
