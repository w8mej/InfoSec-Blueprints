...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sccmhunter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sccmhunter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001110", label="Incident ID", disabled=True)
