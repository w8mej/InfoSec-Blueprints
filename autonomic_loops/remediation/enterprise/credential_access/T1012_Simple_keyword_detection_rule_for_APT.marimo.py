...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for APT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on APT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007119", label="Incident ID", disabled=True)
