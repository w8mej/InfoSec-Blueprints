...
def bluf(mo):
    mo.md(
        ...
        >
        > Identifies internet bound webdav requests which could be forced authentication. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="108714", label="Incident ID", disabled=True)
