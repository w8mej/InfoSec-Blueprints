...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for metatwin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on metatwin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004426", label="Incident ID", disabled=True)
