...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KeyTabExtract
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KeyTabExtract tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001784", label="Incident ID", disabled=True)
