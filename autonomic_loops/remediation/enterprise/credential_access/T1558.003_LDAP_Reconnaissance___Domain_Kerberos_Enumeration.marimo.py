...
def bluf(mo):
    mo.md(
        r"""
        # LDAP Reconnaissance / Domain Kerberos Enumeration
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects possible Active Directory Kerberos enumeration via LDAP
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308377", label="Incident ID", disabled=True)
