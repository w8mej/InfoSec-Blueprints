...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ROADtools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ROADtools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909470", label="Incident ID", disabled=True)
