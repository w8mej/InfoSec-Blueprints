...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nanorobeus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nanorobeus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007486", label="Incident ID", disabled=True)
