...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KeePwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KeePwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901100", label="Incident ID", disabled=True)
