...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fastfuzz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fastfuzz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006706", label="Incident ID", disabled=True)
