...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KeeThiefSyscalls
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KeeThiefSyscalls tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009616", label="Incident ID", disabled=True)
