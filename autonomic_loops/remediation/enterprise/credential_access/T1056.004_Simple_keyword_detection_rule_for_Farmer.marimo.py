...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Farmer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Farmer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002881", label="Incident ID", disabled=True)
