...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for unset
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on unset tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003666", label="Incident ID", disabled=True)
