...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bettercap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bettercap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003298", label="Incident ID", disabled=True)
