...
def bluf(mo):
    mo.md(
        r"""
        # Launch WebBrowserPassView Executable
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detect use of WebBrowserPassView.exe
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302406", label="Incident ID", disabled=True)
