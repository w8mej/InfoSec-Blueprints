...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mortar
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mortar tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000434", label="Incident ID", disabled=True)
