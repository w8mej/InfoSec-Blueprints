...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for decrypt-chrome-passwords
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on decrypt-chrome-passwords tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902116", label="Incident ID", disabled=True)
