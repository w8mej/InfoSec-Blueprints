...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for keylogger keyword
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on keylogger keyword tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006802", label="Incident ID", disabled=True)
