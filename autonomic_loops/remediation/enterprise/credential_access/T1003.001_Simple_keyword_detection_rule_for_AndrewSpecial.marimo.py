...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AndrewSpecial
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AndrewSpecial tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002361", label="Incident ID", disabled=True)
