...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pdbedit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pdbedit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007184", label="Incident ID", disabled=True)
