...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for john
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on john tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009318", label="Incident ID", disabled=True)
