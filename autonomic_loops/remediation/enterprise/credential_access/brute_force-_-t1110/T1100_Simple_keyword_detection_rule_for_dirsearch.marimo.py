...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dirsearch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dirsearch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007804", label="Incident ID", disabled=True)
