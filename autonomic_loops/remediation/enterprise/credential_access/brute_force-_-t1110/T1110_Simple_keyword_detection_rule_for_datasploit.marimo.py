...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for datasploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on datasploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007828", label="Incident ID", disabled=True)
