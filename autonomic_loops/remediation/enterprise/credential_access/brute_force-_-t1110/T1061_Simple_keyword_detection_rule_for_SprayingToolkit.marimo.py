...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SprayingToolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SprayingToolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008702", label="Incident ID", disabled=True)
