...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kerbrute
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kerbrute tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906290", label="Incident ID", disabled=True)
