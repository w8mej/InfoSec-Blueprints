...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for t14m4t
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on t14m4t tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908445", label="Incident ID", disabled=True)
