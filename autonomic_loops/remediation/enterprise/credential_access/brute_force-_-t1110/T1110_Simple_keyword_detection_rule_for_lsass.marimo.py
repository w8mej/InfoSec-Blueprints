...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for lsass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on lsass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001555", label="Incident ID", disabled=True)
