...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AzureAD_Autologon_Brute
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AzureAD_Autologon_Brute tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009232", label="Incident ID", disabled=True)
