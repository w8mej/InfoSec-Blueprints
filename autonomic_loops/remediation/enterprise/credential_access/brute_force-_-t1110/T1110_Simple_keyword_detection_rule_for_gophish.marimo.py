...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gophish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gophish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003357", label="Incident ID", disabled=True)
