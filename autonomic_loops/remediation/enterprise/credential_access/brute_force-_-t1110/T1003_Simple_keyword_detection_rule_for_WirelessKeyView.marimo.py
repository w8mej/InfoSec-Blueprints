...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WirelessKeyView
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WirelessKeyView tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007033", label="Incident ID", disabled=True)
