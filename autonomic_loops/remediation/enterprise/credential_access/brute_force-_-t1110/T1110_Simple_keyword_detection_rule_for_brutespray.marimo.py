...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for brutespray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on brutespray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000596", label="Incident ID", disabled=True)
