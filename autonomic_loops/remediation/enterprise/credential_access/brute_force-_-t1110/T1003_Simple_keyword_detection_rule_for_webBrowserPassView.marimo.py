...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for webBrowserPassView
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on webBrowserPassView tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001410", label="Incident ID", disabled=True)
