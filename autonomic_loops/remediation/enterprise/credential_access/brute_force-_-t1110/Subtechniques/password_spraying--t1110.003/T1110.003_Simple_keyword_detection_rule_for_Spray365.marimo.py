...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Spray365
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Spray365 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005754", label="Incident ID", disabled=True)
