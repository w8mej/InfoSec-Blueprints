...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ncrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ncrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001169", label="Incident ID", disabled=True)
