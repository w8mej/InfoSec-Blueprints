...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SocialBox-Termux
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SocialBox-Termux tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005909", label="Incident ID", disabled=True)
