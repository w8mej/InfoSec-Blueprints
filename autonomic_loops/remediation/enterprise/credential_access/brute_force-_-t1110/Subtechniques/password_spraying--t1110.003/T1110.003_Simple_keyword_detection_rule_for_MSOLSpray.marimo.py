...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MSOLSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MSOLSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004446", label="Incident ID", disabled=True)
