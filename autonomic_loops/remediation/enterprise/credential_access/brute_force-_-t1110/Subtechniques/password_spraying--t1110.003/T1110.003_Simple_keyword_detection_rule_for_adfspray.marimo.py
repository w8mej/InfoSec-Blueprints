...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adfspray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adfspray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005629", label="Incident ID", disabled=True)
