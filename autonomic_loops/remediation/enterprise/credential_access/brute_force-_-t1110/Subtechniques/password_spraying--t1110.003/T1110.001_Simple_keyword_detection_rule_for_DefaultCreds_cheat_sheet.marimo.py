...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DefaultCreds-cheat-sheet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DefaultCreds-cheat-sheet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903675", label="Incident ID", disabled=True)
