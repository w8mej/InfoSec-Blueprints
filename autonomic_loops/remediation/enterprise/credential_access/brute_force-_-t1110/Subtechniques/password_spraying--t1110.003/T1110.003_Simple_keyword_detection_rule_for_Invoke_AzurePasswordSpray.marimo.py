...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-AzurePasswordSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-AzurePasswordSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001364", label="Incident ID", disabled=True)
