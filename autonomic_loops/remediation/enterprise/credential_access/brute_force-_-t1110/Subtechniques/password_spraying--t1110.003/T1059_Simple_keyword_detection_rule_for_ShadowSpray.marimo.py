...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ShadowSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ShadowSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005572", label="Incident ID", disabled=True)
