...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ticket_converter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ticket_converter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005737", label="Incident ID", disabled=True)
