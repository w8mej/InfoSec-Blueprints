...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for thc-hydra
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on thc-hydra tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909302", label="Incident ID", disabled=True)
