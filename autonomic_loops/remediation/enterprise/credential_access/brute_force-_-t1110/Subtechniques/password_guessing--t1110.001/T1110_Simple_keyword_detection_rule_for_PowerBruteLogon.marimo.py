...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerBruteLogon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerBruteLogon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006970", label="Incident ID", disabled=True)
