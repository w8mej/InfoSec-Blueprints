...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSMapExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSMapExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009394", label="Incident ID", disabled=True)
