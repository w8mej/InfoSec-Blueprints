...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for icebreaker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on icebreaker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003691", label="Incident ID", disabled=True)
