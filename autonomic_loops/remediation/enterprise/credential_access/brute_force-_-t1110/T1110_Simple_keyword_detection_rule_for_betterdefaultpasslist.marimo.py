...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for betterdefaultpasslist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on betterdefaultpasslist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000787", label="Incident ID", disabled=True)
