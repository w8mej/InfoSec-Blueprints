...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ShuckNT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ShuckNT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009524", label="Incident ID", disabled=True)
