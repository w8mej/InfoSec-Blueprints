...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LaZagne
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LaZagne tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009520", label="Incident ID", disabled=True)
