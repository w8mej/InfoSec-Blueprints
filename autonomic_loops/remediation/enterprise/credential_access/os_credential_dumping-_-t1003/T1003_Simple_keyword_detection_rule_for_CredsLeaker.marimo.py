...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CredsLeaker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CredsLeaker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001451", label="Incident ID", disabled=True)
