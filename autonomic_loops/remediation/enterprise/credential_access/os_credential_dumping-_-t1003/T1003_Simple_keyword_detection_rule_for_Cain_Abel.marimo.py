...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Cain&Abel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Cain&Abel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001162", label="Incident ID", disabled=True)
