...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MailSniper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MailSniper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904826", label="Incident ID", disabled=True)
