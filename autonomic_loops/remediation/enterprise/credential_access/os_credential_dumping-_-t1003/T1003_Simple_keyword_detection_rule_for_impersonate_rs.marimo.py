...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for impersonate-rs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on impersonate-rs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000790", label="Incident ID", disabled=True)
