...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dialupass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dialupass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007197", label="Incident ID", disabled=True)
