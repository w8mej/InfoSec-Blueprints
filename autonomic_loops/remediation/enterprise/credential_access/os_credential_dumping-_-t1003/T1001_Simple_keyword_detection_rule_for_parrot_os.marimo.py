...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for parrot os
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on parrot os tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006787", label="Incident ID", disabled=True)
