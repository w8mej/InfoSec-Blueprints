...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for o365recon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on o365recon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000103", label="Incident ID", disabled=True)
