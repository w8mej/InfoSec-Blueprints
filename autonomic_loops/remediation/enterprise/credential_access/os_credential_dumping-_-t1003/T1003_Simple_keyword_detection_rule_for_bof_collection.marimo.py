...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bof-collection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bof-collection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008117", label="Incident ID", disabled=True)
