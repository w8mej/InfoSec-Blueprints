...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpAzbelt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpAzbelt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008447", label="Incident ID", disabled=True)
