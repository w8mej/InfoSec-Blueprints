...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SQLRecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SQLRecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005321", label="Incident ID", disabled=True)
