...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects suspicious creations of a file named "ntds.dit" (Active Directory Database) by suspicious parent process, directory or a suspicious one liner
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309484", label="Incident ID", disabled=True)
