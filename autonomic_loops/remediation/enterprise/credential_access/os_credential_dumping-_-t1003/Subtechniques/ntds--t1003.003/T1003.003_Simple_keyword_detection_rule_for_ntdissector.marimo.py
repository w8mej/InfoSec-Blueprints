...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ntdissector
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ntdissector tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006613", label="Incident ID", disabled=True)
