...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-ZeroLogon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-ZeroLogon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008234", label="Incident ID", disabled=True)
