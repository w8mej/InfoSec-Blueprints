...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hibr2Dmp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hibr2Dmp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904797", label="Incident ID", disabled=True)
