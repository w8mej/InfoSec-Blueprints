...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LsassSilentProcessExit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LsassSilentProcessExit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008347", label="Incident ID", disabled=True)
