...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EvilLsassTwin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EvilLsassTwin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005804", label="Incident ID", disabled=True)
