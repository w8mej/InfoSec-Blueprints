...
def bluf(mo):
    mo.md(
        r"""
        # Suspicious dump file transfered via SMB share
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects scenarios where an attacker would access and/or transfer a dump file containing potential sensitive information (LSASS dump).
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304072", label="Incident ID", disabled=True)
