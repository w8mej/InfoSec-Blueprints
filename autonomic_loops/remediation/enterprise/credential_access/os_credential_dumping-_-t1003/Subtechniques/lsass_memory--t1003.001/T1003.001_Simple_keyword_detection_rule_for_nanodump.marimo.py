...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nanodump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nanodump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004966", label="Incident ID", disabled=True)
