...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wce
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wce tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007704", label="Incident ID", disabled=True)
