...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for samdump2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on samdump2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908667", label="Incident ID", disabled=True)
