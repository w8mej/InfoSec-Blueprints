...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ExtractBitlockerKeys
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ExtractBitlockerKeys tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008896", label="Incident ID", disabled=True)
