...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for requests-ntlm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on requests-ntlm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005219", label="Incident ID", disabled=True)
