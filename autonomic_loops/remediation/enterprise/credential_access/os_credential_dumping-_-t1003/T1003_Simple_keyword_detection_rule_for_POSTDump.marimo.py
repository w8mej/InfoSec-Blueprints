...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for POSTDump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on POSTDump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008543", label="Incident ID", disabled=True)
