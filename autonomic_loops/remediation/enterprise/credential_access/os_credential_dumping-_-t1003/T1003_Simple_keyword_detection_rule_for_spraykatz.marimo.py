...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for spraykatz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on spraykatz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003276", label="Incident ID", disabled=True)
