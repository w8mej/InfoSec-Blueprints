...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wordlists
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wordlists tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009313", label="Incident ID", disabled=True)
