...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LinikatzV2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LinikatzV2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008792", label="Incident ID", disabled=True)
