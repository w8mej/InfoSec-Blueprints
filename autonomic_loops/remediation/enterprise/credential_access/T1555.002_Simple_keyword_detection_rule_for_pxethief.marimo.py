...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pxethief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pxethief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000772", label="Incident ID", disabled=True)
