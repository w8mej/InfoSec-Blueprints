...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for targetedKerberoast
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on targetedKerberoast tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009431", label="Incident ID", disabled=True)
