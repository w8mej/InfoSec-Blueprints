...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for S4UTomato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on S4UTomato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009039", label="Incident ID", disabled=True)
