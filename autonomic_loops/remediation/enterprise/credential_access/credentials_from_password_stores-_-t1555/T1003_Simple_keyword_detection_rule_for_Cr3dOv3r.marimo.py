...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Cr3dOv3r
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Cr3dOv3r tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006611", label="Incident ID", disabled=True)
