...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for krackattacks-scripts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on krackattacks-scripts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005466", label="Incident ID", disabled=True)
