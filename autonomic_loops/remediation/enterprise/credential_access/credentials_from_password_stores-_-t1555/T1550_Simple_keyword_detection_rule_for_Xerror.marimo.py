...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Xerror
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Xerror tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008322", label="Incident ID", disabled=True)
