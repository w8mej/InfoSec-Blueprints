...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EDR-Test
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EDR-Test tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004910", label="Incident ID", disabled=True)
