...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for afrog
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on afrog tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004779", label="Incident ID", disabled=True)
