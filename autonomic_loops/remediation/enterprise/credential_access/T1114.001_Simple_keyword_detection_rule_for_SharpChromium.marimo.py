...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpChromium
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpChromium tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003873", label="Incident ID", disabled=True)
