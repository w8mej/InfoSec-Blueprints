...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RoguePotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RoguePotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005011", label="Incident ID", disabled=True)
