...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for JuicyPotatoNG
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on JuicyPotatoNG tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009958", label="Incident ID", disabled=True)
