...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for exe_to_dll
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on exe_to_dll tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001434", label="Incident ID", disabled=True)
