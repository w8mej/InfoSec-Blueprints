...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Admin2Sys
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Admin2Sys tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004726", label="Incident ID", disabled=True)
