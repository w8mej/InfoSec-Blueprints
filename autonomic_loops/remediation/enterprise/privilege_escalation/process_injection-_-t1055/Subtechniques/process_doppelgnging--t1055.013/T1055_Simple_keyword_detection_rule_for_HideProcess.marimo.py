...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HideProcess
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HideProcess tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009434", label="Incident ID", disabled=True)
