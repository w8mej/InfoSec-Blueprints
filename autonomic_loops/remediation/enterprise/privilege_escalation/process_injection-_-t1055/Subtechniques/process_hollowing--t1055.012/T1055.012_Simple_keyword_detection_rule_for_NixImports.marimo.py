...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NixImports
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NixImports tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009190", label="Incident ID", disabled=True)
