...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Shellcode-Loader
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Shellcode-Loader tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001683", label="Incident ID", disabled=True)
