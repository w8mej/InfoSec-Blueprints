...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for darkarmour
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on darkarmour tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007993", label="Incident ID", disabled=True)
