...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NimBlackout
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NimBlackout tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001783", label="Incident ID", disabled=True)
