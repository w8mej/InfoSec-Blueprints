...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ThreadlessInject
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ThreadlessInject tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004589", label="Incident ID", disabled=True)
