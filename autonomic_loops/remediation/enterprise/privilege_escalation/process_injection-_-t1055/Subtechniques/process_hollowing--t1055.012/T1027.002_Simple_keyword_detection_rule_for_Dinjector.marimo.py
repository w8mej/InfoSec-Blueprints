...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Dinjector
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Dinjector tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008486", label="Incident ID", disabled=True)
