...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for StackCrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on StackCrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002232", label="Incident ID", disabled=True)
