...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ngrok
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ngrok tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906175", label="Incident ID", disabled=True)
