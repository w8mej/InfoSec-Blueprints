...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CredPhisher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CredPhisher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007764", label="Incident ID", disabled=True)
