...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SlowLoris
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SlowLoris tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000760", label="Incident ID", disabled=True)
