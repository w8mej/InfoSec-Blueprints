...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dazzleUP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dazzleUP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002706", label="Incident ID", disabled=True)
