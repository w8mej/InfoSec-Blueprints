...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for debugdfs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on debugdfs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000360", label="Incident ID", disabled=True)
