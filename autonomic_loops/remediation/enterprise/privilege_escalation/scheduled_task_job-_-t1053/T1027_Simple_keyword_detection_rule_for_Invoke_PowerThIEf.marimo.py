...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-PowerThIEf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-PowerThIEf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902255", label="Incident ID", disabled=True)
