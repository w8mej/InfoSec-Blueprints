...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharPersist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharPersist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002023", label="Incident ID", disabled=True)
