...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sudo_inject
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sudo_inject tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006385", label="Incident ID", disabled=True)
