...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for windows-privesc-check
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on windows-privesc-check tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000844", label="Incident ID", disabled=True)
