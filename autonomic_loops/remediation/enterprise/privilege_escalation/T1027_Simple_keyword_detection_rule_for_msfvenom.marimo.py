...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for msfvenom
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on msfvenom tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004440", label="Incident ID", disabled=True)
