...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PrivilegeEscalation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PrivilegeEscalation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903356", label="Incident ID", disabled=True)
