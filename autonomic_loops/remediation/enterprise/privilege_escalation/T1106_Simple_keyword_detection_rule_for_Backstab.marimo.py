...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Backstab
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Backstab tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000292", label="Incident ID", disabled=True)
