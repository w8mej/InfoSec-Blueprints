...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Sharp-Suite
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Sharp-Suite tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009572", label="Incident ID", disabled=True)
