...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Gotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Gotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005009", label="Incident ID", disabled=True)
