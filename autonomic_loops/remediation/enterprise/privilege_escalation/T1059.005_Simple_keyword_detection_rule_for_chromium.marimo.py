...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chromium
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chromium tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003845", label="Incident ID", disabled=True)
