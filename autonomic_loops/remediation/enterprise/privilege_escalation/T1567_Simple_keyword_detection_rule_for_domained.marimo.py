...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for domained
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on domained tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002389", label="Incident ID", disabled=True)
