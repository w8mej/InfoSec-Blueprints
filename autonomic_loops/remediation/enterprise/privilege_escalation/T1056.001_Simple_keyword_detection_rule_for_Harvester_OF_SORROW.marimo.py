...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Harvester_OF_SORROW
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Harvester_OF_SORROW tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000313", label="Incident ID", disabled=True)
