...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Lovely-Potato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Lovely-Potato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006984", label="Incident ID", disabled=True)
