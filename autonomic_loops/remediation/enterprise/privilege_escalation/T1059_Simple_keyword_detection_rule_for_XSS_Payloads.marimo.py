...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for XSS-Payloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on XSS-Payloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002298", label="Incident ID", disabled=True)
