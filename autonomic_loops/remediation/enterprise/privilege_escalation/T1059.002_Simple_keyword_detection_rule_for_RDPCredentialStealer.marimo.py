...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RDPCredentialStealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RDPCredentialStealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001901", label="Incident ID", disabled=True)
