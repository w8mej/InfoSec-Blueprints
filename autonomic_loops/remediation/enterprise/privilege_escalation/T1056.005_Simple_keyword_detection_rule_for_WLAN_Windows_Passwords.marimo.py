...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WLAN-Windows-Passwords
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WLAN-Windows-Passwords tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005343", label="Incident ID", disabled=True)
