...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for elevationstation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on elevationstation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000791", label="Incident ID", disabled=True)
