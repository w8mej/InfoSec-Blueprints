...
def bluf(mo):
    mo.md(
        ...
        >
        > Identifies when a service principal has privileges escalated to Global Administrator.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="709804", label="Incident ID", disabled=True)
