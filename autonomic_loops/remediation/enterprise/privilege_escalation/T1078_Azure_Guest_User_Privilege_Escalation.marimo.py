...
def bluf(mo):
    mo.md(
        r"""
        # Azure Guest User Privilege Escalation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when a guest user has privileges escalated to Global Administrator.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="707989", label="Incident ID", disabled=True)
