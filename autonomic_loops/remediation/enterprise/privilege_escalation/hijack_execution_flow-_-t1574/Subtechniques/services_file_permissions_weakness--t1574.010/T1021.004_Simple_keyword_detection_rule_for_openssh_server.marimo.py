...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for openssh server
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on openssh server tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008548", label="Incident ID", disabled=True)
