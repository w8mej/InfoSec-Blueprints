...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WebDeveloperSecurityChecklist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WebDeveloperSecurityChecklist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009330", label="Incident ID", disabled=True)
