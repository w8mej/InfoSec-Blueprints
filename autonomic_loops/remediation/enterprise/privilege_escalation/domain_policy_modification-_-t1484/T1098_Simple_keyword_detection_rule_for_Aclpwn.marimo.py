...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Aclpwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Aclpwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005449", label="Incident ID", disabled=True)
