...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpGPOAbuse
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpGPOAbuse tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002000", label="Incident ID", disabled=True)
