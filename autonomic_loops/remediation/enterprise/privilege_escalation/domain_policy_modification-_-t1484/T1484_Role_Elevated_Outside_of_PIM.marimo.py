...
def bluf(mo):
    mo.md(
        r"""
        # Role Elevated Outside of PIM
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when a privileged role assignment has been made outside of the Privileged Identity Management tool.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="700728", label="Incident ID", disabled=True)
