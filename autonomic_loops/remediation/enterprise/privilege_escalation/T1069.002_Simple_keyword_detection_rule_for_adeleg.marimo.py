...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adeleg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adeleg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906365", label="Incident ID", disabled=True)
