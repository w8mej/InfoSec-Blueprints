...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Browser-password-stealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Browser-password-stealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003390", label="Incident ID", disabled=True)
