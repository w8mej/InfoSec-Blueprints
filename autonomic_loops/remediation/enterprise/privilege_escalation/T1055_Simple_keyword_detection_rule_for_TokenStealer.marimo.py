...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TokenStealer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TokenStealer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001785", label="Incident ID", disabled=True)
