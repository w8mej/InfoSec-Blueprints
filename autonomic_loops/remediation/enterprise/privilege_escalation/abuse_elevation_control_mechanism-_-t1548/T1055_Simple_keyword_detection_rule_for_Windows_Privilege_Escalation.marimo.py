...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Windows-Privilege-Escalation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Windows-Privilege-Escalation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007755", label="Incident ID", disabled=True)
