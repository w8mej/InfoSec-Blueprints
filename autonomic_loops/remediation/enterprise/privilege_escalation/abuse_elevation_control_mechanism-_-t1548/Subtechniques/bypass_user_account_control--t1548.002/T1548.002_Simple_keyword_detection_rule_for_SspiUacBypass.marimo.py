...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SspiUacBypass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SspiUacBypass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005206", label="Incident ID", disabled=True)
