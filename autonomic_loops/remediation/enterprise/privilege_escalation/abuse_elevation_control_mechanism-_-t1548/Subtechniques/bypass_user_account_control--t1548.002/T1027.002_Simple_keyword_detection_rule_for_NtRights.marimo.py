...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NtRights
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NtRights tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903671", label="Incident ID", disabled=True)
