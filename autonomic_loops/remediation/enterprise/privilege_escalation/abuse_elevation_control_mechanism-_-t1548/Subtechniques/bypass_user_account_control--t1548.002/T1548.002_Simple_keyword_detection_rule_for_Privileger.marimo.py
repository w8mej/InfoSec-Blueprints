...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Privileger
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Privileger tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901351", label="Incident ID", disabled=True)
