...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for reaper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on reaper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000871", label="Incident ID", disabled=True)
