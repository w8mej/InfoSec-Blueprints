...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PyExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PyExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004023", label="Incident ID", disabled=True)
