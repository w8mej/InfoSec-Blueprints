...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PrintSpoofer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PrintSpoofer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006200", label="Incident ID", disabled=True)
