...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Perfusion
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Perfusion tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908673", label="Incident ID", disabled=True)
