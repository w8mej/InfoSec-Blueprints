...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SmashedPotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SmashedPotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002352", label="Incident ID", disabled=True)
