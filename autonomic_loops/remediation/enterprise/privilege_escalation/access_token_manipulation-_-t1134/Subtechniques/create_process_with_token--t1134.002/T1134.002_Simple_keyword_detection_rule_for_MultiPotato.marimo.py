...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MultiPotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MultiPotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002944", label="Incident ID", disabled=True)
