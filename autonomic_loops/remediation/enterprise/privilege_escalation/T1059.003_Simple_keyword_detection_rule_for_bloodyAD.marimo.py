...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bloodyAD
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bloodyAD tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904337", label="Incident ID", disabled=True)
