...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cytool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cytool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002256", label="Incident ID", disabled=True)
