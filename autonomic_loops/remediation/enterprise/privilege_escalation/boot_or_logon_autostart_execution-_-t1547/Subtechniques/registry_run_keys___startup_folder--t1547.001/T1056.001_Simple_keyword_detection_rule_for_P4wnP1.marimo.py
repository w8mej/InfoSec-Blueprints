...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for P4wnP1
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on P4wnP1 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002737", label="Incident ID", disabled=True)
