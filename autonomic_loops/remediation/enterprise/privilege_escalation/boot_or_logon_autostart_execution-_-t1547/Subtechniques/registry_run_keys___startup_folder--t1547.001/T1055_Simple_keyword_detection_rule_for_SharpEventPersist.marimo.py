...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpEventPersist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpEventPersist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006517", label="Incident ID", disabled=True)
