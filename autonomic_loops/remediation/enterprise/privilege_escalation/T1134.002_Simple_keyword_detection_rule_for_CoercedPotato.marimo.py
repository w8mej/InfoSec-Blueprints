...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CoercedPotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CoercedPotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003415", label="Incident ID", disabled=True)
