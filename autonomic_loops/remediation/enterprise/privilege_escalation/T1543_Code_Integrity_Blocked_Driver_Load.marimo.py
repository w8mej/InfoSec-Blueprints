...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects blocked load events that did not meet the authenticode signing level requirements or violated code integrity policy
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300908", label="Incident ID", disabled=True)
