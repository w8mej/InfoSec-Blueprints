...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RefleXXion
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RefleXXion tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008346", label="Incident ID", disabled=True)
