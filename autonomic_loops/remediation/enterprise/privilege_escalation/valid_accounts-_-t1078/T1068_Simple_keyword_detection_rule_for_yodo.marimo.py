...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for yodo
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on yodo tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900814", label="Incident ID", disabled=True)
