...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NtlmRelayToEWS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NtlmRelayToEWS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003698", label="Incident ID", disabled=True)
