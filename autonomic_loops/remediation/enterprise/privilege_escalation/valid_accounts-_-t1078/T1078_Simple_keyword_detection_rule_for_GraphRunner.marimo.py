...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GraphRunner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GraphRunner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001710", label="Incident ID", disabled=True)
