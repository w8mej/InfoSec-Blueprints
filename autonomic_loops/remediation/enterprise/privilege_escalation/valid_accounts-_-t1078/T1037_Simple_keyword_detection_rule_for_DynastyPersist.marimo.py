...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DynastyPersist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DynastyPersist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906437", label="Incident ID", disabled=True)
