...
def bluf(mo):
    mo.md(
        ...
        >
        > I looked at all our Cloudtrail data and filtered out logins from any observed country. When a new country appears, this will alert.
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003797", label="Incident ID", disabled=True)
