...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fakelogonscreen
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fakelogonscreen tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002475", label="Incident ID", disabled=True)
