...
def bluf(mo):
    mo.md(
        r"""
        # AWS ConsoleLogin Bruteforce
        
        > [!CAUTION]
        > **SIGMA RULE SEVERITY LEVEL. REFLECTS THE RISK ASSOCIATED WITH A TRUE POSITIVE EVENT. SEVERITY** | **ASO PLAYBOOK**
        >
        > Alert when a user has more than 10 failed authentication attempts to the console in 3 days
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002328", label="Incident ID", disabled=True)
