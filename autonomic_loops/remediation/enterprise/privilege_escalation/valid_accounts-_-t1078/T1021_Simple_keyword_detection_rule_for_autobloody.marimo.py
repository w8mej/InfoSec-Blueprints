...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for autobloody
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on autobloody tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907008", label="Incident ID", disabled=True)
