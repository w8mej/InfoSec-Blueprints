...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PPLFault
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PPLFault tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907616", label="Incident ID", disabled=True)
