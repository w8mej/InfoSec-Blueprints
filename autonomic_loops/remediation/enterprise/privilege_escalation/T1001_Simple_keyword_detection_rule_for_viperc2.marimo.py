...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for viperc2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on viperc2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000528", label="Incident ID", disabled=True)
