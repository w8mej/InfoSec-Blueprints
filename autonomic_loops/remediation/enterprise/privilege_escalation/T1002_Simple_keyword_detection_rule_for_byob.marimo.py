...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for byob
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on byob tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007532", label="Incident ID", disabled=True)
