...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for scan4all
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on scan4all tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004240", label="Incident ID", disabled=True)
