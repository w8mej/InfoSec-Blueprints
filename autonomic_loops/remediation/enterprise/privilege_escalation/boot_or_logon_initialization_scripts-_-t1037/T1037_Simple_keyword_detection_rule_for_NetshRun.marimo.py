...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetshRun
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetshRun tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007155", label="Incident ID", disabled=True)
