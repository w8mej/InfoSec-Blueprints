...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OMGLogger
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OMGLogger tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004006", label="Incident ID", disabled=True)
