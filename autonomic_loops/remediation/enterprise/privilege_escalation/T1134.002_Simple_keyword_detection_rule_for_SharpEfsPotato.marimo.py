...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpEfsPotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpEfsPotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001313", label="Incident ID", disabled=True)
