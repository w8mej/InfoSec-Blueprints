...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DLL-Spoofer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DLL-Spoofer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008624", label="Incident ID", disabled=True)
