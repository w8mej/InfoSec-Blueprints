...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpDllProxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpDllProxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003815", label="Incident ID", disabled=True)
