...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NTDLLReflection
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NTDLLReflection tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009029", label="Incident ID", disabled=True)
