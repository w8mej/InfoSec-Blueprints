...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kwetza
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kwetza tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908546", label="Incident ID", disabled=True)
