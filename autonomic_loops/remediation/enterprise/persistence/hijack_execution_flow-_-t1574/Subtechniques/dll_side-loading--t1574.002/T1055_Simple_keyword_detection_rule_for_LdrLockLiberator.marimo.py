...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LdrLockLiberator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LdrLockLiberator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008532", label="Incident ID", disabled=True)
