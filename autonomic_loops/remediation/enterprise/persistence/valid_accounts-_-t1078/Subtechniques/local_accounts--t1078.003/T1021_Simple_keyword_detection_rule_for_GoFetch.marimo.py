...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GoFetch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GoFetch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904168", label="Incident ID", disabled=True)
