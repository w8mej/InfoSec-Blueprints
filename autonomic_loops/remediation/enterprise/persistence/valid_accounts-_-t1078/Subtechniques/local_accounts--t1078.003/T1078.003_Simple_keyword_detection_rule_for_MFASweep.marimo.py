...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MFASweep
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MFASweep tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901881", label="Incident ID", disabled=True)
