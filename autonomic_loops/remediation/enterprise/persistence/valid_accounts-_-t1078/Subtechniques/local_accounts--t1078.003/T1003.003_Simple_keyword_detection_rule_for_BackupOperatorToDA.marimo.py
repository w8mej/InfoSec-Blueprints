...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BackupOperatorToDA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BackupOperatorToDA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006786", label="Incident ID", disabled=True)
