...
def bluf(mo):
    mo.md(
        ...
        >
        > Some cybercriminals use curse words in their webshells, this rule detects those common words or curse words that wouldn't typcially be found
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="106158", label="Incident ID", disabled=True)
