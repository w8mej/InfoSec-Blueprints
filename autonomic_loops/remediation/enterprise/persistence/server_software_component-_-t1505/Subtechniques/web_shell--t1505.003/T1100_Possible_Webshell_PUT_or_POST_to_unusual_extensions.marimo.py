...
def bluf(mo):
    mo.md(
        ...
        >
        > This rule looks for post requests to unusual extensions (e.g. .jpg). This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="108147", label="Incident ID", disabled=True)
