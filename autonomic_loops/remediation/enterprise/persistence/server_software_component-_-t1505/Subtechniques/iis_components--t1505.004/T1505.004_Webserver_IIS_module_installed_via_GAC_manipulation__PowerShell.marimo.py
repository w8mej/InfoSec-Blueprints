...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker attempts to deploy an IIS module via Global Assembly cache (GAC) manipulation.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306487", label="Incident ID", disabled=True)
