...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ICMP-TransferTools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ICMP-TransferTools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001925", label="Incident ID", disabled=True)
