...
def bluf(mo):
    mo.md(
        ...
        >
        > 检测Windows服务器上的本地用户创建，这在Active Directory环境中不适用。使用本地日志，非AD日志。
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300305", label="Incident ID", disabled=True)
