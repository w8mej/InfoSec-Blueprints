...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for power-pwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on power-pwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004442", label="Incident ID", disabled=True)
