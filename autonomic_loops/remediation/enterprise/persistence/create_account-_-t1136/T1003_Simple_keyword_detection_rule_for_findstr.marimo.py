...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for findstr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on findstr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006544", label="Incident ID", disabled=True)
