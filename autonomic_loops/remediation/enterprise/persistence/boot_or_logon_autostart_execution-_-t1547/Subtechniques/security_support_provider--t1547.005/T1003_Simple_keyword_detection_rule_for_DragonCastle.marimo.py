...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DragonCastle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DragonCastle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005448", label="Incident ID", disabled=True)
