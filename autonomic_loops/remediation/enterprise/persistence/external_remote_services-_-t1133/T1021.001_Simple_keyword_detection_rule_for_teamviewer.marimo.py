...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for teamviewer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on teamviewer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001502", label="Incident ID", disabled=True)
