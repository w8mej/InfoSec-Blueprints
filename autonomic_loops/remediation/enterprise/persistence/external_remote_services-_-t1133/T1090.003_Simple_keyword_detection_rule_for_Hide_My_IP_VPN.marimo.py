...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hide My IP VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hide My IP VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903037", label="Incident ID", disabled=True)
