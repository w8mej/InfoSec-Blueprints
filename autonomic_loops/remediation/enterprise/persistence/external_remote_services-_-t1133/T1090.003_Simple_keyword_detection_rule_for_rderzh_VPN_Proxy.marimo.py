...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rderzh VPN Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rderzh VPN Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909049", label="Incident ID", disabled=True)
