...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nac_bypass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nac_bypass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008469", label="Incident ID", disabled=True)
