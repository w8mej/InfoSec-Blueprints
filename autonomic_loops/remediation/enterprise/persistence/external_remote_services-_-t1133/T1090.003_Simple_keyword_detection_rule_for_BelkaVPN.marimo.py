...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BelkaVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BelkaVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004174", label="Incident ID", disabled=True)
