...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Atera
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Atera tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002100", label="Incident ID", disabled=True)
