...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FoxyProxy Standard
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FoxyProxy Standard tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000134", label="Incident ID", disabled=True)
