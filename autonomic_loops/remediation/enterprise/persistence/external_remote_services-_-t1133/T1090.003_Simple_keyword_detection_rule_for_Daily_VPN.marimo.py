...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Daily VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Daily VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901178", label="Incident ID", disabled=True)
