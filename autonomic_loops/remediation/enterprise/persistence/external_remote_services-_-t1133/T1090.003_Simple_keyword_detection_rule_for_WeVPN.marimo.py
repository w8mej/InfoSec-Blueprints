...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WeVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WeVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009702", label="Incident ID", disabled=True)
