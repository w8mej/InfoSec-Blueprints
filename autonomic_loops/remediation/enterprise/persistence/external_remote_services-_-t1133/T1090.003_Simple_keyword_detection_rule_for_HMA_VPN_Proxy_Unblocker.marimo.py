...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HMA VPN Proxy Unblocker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HMA VPN Proxy Unblocker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002821", label="Incident ID", disabled=True)
