...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RustDesk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RustDesk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001760", label="Incident ID", disabled=True)
