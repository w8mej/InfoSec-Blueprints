...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Earth VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Earth VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904357", label="Incident ID", disabled=True)
