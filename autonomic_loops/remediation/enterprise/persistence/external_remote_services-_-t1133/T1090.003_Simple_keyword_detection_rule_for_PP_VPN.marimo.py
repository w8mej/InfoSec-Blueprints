...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PP VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PP VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003204", label="Incident ID", disabled=True)
