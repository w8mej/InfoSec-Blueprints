...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Push VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Push VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007888", label="Incident ID", disabled=True)
