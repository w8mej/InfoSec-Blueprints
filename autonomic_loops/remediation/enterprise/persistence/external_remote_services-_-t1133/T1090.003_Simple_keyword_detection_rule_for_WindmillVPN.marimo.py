...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WindmillVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WindmillVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002340", label="Incident ID", disabled=True)
