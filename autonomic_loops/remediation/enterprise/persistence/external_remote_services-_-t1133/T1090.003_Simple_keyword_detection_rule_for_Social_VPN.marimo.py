...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Social VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Social VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004283", label="Incident ID", disabled=True)
