...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for traitor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on traitor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001390", label="Incident ID", disabled=True)
