...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for _
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on _ tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008361", label="Incident ID", disabled=True)
