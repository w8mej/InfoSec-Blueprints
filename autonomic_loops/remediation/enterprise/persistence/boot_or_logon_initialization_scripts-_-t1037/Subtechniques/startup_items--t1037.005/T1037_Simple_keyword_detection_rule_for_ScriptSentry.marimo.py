...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ScriptSentry
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ScriptSentry tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004364", label="Incident ID", disabled=True)
