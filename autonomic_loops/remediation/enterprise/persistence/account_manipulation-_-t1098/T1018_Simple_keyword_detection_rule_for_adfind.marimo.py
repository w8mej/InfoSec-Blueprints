...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adfind
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adfind tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000024", label="Incident ID", disabled=True)
