...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for krbrelayx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on krbrelayx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000637", label="Incident ID", disabled=True)
