...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pywhisker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pywhisker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006927", label="Incident ID", disabled=True)
