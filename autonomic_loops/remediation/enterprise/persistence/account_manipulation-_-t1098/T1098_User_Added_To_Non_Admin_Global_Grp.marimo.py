...
def bluf(mo):
    mo.md(
        r"""
        # User Added To Non-Admin Global Grp
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > User Added To Non-Admin Global Security Group. Only logged on DCs.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305772", label="Incident ID", disabled=True)
