...
def bluf(mo):
    mo.md(
        r"""
        # User Added To Local Domain Admins Grp
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > A user was added to the local Domain Admins group.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300902", label="Incident ID", disabled=True)
