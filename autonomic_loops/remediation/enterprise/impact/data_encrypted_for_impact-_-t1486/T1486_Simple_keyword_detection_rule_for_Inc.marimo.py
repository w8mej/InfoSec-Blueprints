...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Inc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Inc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002281", label="Incident ID", disabled=True)
