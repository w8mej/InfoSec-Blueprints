...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wifijammer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wifijammer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006655", label="Incident ID", disabled=True)
