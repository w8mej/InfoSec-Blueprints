...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Nidhogg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Nidhogg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006214", label="Incident ID", disabled=True)
