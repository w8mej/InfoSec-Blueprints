...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hive
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hive tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001512", label="Incident ID", disabled=True)
