...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wbadmin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wbadmin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007300", label="Incident ID", disabled=True)
