...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for taskkill
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on taskkill tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009231", label="Incident ID", disabled=True)
