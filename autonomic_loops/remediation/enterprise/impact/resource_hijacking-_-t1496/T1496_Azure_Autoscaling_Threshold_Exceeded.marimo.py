...
def bluf(mo):
    mo.md(
        r"""
        # Azure Autoscaling Threshold Exceeded
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when the number of instances in the resource group is greater than the threshold.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="700915", label="Incident ID", disabled=True)
