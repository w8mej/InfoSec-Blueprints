...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Anevicon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Anevicon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002166", label="Incident ID", disabled=True)
