...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-BSOD
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-BSOD tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000049", label="Incident ID", disabled=True)
