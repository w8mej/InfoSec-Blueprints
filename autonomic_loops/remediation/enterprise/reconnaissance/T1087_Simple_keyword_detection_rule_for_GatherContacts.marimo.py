...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GatherContacts
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GatherContacts tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002476", label="Incident ID", disabled=True)
