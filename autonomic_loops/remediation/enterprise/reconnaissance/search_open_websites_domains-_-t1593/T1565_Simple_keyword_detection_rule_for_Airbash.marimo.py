...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Airbash
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Airbash tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001577", label="Incident ID", disabled=True)
