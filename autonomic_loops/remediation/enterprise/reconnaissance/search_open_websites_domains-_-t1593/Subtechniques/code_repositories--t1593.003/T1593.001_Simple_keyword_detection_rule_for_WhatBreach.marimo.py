...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WhatBreach
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WhatBreach tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003178", label="Incident ID", disabled=True)
