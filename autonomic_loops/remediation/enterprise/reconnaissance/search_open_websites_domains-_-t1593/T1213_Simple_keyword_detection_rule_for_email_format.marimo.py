...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for email-format
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on email-format tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904194", label="Incident ID", disabled=True)
