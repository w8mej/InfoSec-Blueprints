...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CrossLinked
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CrossLinked tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006737", label="Incident ID", disabled=True)
