...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for metagoofil
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on metagoofil tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000592", label="Incident ID", disabled=True)
