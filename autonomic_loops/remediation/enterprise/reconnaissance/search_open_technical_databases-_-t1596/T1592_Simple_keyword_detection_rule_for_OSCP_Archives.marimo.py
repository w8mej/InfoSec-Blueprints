...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OSCP-Archives
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OSCP-Archives tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002108", label="Incident ID", disabled=True)
