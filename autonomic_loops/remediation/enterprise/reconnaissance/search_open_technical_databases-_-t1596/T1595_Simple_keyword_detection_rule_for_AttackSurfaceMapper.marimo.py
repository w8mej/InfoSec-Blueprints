...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AttackSurfaceMapper
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AttackSurfaceMapper tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006922", label="Incident ID", disabled=True)
