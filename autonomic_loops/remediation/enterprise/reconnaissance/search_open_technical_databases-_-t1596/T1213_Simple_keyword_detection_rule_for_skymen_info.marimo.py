...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for skymen.info
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on skymen.info tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008048", label="Incident ID", disabled=True)
