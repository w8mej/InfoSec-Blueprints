...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for crunch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on crunch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903960", label="Incident ID", disabled=True)
