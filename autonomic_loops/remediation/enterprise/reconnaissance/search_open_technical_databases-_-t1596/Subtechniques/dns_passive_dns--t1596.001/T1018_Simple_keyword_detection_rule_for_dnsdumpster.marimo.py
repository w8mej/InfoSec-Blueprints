...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnsdumpster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnsdumpster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009329", label="Incident ID", disabled=True)
