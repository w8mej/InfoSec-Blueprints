...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Kubestroyer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Kubestroyer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907377", label="Incident ID", disabled=True)
