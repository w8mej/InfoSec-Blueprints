...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for amass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on amass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009883", label="Incident ID", disabled=True)
