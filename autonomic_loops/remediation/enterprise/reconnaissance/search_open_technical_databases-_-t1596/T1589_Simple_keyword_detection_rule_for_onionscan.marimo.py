...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for onionscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on onionscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006840", label="Incident ID", disabled=True)
