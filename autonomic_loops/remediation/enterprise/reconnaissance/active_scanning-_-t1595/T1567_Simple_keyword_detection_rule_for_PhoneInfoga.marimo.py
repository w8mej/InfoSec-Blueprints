...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PhoneInfoga
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PhoneInfoga tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003701", label="Incident ID", disabled=True)
