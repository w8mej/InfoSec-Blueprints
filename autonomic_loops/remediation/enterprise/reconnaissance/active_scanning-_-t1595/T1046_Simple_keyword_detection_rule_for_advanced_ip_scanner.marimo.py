...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for advanced-ip-scanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on advanced-ip-scanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008885", label="Incident ID", disabled=True)
