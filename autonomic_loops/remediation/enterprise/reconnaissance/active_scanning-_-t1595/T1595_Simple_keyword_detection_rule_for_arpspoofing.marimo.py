...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for arpspoofing
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on arpspoofing tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000171", label="Incident ID", disabled=True)
