...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GONET-Scanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GONET-Scanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006884", label="Incident ID", disabled=True)
