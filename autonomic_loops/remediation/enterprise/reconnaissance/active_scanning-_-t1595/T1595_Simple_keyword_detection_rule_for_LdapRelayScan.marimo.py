...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LdapRelayScan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LdapRelayScan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008085", label="Incident ID", disabled=True)
