...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for red_hawk
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on red_hawk tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004943", label="Incident ID", disabled=True)
