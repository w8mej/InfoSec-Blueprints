...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rengine
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rengine tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902410", label="Incident ID", disabled=True)
