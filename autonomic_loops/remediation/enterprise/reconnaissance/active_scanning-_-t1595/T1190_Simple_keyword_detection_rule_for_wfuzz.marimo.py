...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wfuzz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wfuzz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008666", label="Incident ID", disabled=True)
