...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldeep
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldeep tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002983", label="Incident ID", disabled=True)
