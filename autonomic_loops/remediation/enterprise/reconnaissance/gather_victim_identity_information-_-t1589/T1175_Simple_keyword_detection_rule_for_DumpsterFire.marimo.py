...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DumpsterFire
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DumpsterFire tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008918", label="Incident ID", disabled=True)
