...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cloud_enum
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cloud_enum tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002365", label="Incident ID", disabled=True)
