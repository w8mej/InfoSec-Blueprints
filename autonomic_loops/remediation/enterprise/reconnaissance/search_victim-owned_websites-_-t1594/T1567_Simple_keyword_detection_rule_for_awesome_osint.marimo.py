...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for awesome-osint
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on awesome-osint tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003902", label="Incident ID", disabled=True)
