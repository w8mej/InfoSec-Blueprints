...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ctfr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ctfr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000278", label="Incident ID", disabled=True)
