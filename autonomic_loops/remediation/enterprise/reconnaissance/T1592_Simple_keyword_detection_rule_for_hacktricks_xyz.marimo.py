...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hacktricks.xyz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hacktricks.xyz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001732", label="Incident ID", disabled=True)
