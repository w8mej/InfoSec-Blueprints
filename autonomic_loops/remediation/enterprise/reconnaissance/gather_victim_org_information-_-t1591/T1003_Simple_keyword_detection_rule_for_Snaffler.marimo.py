...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Snaffler
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Snaffler tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009179", label="Incident ID", disabled=True)
