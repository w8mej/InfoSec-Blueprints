...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Oh365UserFinder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Oh365UserFinder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903492", label="Incident ID", disabled=True)
