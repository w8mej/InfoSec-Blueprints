...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for jackdaw
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on jackdaw tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001096", label="Incident ID", disabled=True)
