...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ADExplorerSnapshot.py
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ADExplorerSnapshot.py tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004498", label="Incident ID", disabled=True)
