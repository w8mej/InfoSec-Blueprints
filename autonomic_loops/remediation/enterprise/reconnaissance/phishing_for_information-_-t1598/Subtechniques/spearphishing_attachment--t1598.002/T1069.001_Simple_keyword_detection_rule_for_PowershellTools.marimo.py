...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowershellTools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowershellTools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009248", label="Incident ID", disabled=True)
