...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for h8mail
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on h8mail tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003094", label="Incident ID", disabled=True)
