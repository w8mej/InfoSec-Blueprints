...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SimplyEmail
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SimplyEmail tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001320", label="Incident ID", disabled=True)
