...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnsrecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnsrecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005800", label="Incident ID", disabled=True)
