...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Airgeddon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Airgeddon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004124", label="Incident ID", disabled=True)
