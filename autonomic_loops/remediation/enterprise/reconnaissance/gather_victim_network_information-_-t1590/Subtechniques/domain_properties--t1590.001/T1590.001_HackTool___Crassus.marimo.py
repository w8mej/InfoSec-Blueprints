...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects hacktool 'Crassus' - Windows privilege escalation discovery tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308018", label="Incident ID", disabled=True)
