...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Biu-framework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Biu-framework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005104", label="Incident ID", disabled=True)
