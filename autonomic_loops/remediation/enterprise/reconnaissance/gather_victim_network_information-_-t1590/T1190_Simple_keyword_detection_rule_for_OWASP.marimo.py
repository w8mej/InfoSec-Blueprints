...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for OWASP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on OWASP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009323", label="Incident ID", disabled=True)
