...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Operative Framework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Operative Framework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005696", label="Incident ID", disabled=True)
