...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EAPHammer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EAPHammer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906854", label="Incident ID", disabled=True)
