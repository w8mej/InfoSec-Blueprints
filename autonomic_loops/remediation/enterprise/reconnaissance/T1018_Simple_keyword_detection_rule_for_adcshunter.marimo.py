...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adcshunter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adcshunter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008857", label="Incident ID", disabled=True)
