...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Mr.SIP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Mr.SIP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001473", label="Incident ID", disabled=True)
