...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AutoSmuggle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AutoSmuggle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001066", label="Incident ID", disabled=True)
