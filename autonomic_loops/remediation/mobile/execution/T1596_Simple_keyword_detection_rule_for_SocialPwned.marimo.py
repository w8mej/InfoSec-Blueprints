...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SocialPwned
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SocialPwned tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000993", label="Incident ID", disabled=True)
