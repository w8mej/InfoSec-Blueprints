...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for slip
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on slip tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001891", label="Incident ID", disabled=True)
