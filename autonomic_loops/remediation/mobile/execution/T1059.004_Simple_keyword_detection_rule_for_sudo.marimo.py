...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sudo
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sudo tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907782", label="Incident ID", disabled=True)
