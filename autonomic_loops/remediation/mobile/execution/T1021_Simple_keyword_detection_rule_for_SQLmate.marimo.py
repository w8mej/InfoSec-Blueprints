...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SQLmate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SQLmate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008380", label="Incident ID", disabled=True)
