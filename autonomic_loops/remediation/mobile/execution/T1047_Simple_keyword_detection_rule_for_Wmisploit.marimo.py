...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Wmisploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Wmisploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009258", label="Incident ID", disabled=True)
