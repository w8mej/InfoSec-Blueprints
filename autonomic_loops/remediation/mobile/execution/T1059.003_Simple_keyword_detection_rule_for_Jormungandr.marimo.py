...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Jormungandr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Jormungandr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906517", label="Incident ID", disabled=True)
