...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HRShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HRShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008352", label="Incident ID", disabled=True)
