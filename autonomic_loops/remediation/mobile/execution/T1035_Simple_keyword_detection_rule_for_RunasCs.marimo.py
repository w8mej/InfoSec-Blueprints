...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RunasCs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RunasCs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005411", label="Incident ID", disabled=True)
