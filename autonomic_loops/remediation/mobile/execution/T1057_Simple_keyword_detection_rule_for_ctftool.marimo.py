...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ctftool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ctftool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004664", label="Incident ID", disabled=True)
