...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WinPwnage
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WinPwnage tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001658", label="Incident ID", disabled=True)
