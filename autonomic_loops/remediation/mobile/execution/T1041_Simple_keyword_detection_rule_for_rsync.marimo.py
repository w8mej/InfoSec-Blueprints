...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rsync
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rsync tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006447", label="Incident ID", disabled=True)
