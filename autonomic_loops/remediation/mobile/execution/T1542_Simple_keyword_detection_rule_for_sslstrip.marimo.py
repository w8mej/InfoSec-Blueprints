...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sslstrip
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sslstrip tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002138", label="Incident ID", disabled=True)
