...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for InjectProc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on InjectProc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005032", label="Incident ID", disabled=True)
