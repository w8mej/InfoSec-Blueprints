...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldifde
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldifde tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901492", label="Incident ID", disabled=True)
