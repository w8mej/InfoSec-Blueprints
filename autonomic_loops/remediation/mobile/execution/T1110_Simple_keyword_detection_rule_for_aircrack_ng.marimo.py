...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for aircrack-ng
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on aircrack-ng tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003557", label="Incident ID", disabled=True)
