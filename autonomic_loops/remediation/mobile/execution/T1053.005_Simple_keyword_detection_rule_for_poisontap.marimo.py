...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for poisontap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on poisontap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008010", label="Incident ID", disabled=True)
