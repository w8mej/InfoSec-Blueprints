...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pyinstaller
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pyinstaller tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007108", label="Incident ID", disabled=True)
