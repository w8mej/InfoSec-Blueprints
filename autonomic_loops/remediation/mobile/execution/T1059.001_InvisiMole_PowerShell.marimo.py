...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole PowerShell
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects InvisiMole shellcode loaded by PowerShell, as reported in February 2021
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305822", label="Incident ID", disabled=True)
