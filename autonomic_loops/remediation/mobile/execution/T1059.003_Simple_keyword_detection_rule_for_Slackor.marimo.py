...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Slackor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Slackor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905977", label="Incident ID", disabled=True)
