...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for venom
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on venom tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002938", label="Incident ID", disabled=True)
