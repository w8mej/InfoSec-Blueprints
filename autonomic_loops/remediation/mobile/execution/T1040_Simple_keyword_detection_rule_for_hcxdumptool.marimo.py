...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for hcxdumptool
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on hcxdumptool tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003978", label="Incident ID", disabled=True)
