...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cracklord
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cracklord tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002523", label="Incident ID", disabled=True)
