...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker remotely creates a scheduled task on multiple hosts over named pipes to execute commands or elevate privileges.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308765", label="Incident ID", disabled=True)
