...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PS2EXE
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PS2EXE tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005428", label="Incident ID", disabled=True)
