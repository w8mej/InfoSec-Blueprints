...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for procmon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on procmon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902687", label="Incident ID", disabled=True)
