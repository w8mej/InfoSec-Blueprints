...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pwnagotchi
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pwnagotchi tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002082", label="Incident ID", disabled=True)
