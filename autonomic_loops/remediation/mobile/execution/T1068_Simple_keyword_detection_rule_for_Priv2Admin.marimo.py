...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Priv2Admin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Priv2Admin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002798", label="Incident ID", disabled=True)
