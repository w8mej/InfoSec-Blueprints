...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GoToMyPC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GoToMyPC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000170", label="Incident ID", disabled=True)
