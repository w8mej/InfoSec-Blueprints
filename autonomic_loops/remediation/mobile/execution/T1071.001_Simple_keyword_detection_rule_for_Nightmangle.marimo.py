...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Nightmangle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Nightmangle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009822", label="Incident ID", disabled=True)
