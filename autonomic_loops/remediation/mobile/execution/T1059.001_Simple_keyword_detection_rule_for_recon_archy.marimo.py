...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for recon-archy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on recon-archy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007496", label="Incident ID", disabled=True)
