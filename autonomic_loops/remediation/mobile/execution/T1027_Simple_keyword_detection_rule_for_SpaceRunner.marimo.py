...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SpaceRunner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SpaceRunner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006881", label="Incident ID", disabled=True)
