...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DoubleAgent
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DoubleAgent tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009971", label="Incident ID", disabled=True)
