...
def bluf(mo):
    mo.md(
        ...
        >
        > PSEXEC a tool commonly used for lateral movement uses the default named pipe "psexecsvc". This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="109098", label="Incident ID", disabled=True)
