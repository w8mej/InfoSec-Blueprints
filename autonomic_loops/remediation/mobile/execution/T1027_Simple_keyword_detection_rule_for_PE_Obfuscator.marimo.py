...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PE-Obfuscator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PE-Obfuscator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003399", label="Incident ID", disabled=True)
