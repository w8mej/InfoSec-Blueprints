...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for telnet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on telnet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006075", label="Incident ID", disabled=True)
