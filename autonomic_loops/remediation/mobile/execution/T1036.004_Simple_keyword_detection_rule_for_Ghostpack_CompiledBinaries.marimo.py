...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Ghostpack-CompiledBinaries
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Ghostpack-CompiledBinaries tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007347", label="Incident ID", disabled=True)
