...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpDPAPI
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpDPAPI tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000044", label="Incident ID", disabled=True)
