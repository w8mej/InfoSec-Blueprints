...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for No-powershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on No-powershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002834", label="Incident ID", disabled=True)
