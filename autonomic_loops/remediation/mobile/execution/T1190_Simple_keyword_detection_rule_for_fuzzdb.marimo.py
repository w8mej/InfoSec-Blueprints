...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fuzzdb
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fuzzdb tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000241", label="Incident ID", disabled=True)
