...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ReflectiveNtdll
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ReflectiveNtdll tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003665", label="Incident ID", disabled=True)
