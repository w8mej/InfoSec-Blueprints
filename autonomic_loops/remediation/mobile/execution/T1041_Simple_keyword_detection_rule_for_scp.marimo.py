...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for scp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on scp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002188", label="Incident ID", disabled=True)
