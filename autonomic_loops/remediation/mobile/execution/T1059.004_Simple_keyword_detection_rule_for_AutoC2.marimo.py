...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AutoC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AutoC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004608", label="Incident ID", disabled=True)
