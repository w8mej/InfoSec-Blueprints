...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GPSCoordinates
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GPSCoordinates tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000558", label="Incident ID", disabled=True)
