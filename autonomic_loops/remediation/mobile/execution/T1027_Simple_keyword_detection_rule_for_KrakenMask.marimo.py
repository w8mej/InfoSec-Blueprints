...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for KrakenMask
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on KrakenMask tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009683", label="Incident ID", disabled=True)
