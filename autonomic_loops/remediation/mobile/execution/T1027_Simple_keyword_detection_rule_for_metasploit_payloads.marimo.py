...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for metasploit-payloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on metasploit-payloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004723", label="Incident ID", disabled=True)
