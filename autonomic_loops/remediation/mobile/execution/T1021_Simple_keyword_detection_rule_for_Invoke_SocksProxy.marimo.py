...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-SocksProxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-SocksProxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="908815", label="Incident ID", disabled=True)
