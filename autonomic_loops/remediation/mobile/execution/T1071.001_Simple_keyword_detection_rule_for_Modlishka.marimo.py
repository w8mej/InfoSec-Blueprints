...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Modlishka 
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Modlishka  tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008375", label="Incident ID", disabled=True)
