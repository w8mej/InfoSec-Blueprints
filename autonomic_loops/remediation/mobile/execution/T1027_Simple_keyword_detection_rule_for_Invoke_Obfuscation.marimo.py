...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-Obfuscation
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-Obfuscation tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907534", label="Incident ID", disabled=True)
