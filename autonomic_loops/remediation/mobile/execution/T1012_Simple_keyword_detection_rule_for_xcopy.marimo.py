...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for xcopy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on xcopy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001165", label="Incident ID", disabled=True)
