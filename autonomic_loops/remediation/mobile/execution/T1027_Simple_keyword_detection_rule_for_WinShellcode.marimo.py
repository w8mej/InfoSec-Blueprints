...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WinShellcode
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WinShellcode tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008167", label="Incident ID", disabled=True)
