...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for http.server
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on http.server tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001942", label="Incident ID", disabled=True)
