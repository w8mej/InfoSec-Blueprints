...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WDExtract
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WDExtract tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006595", label="Incident ID", disabled=True)
