...
def bluf(mo):
    mo.md(
        ...
        >
        > Iranian Threat actors use a custom tool built on SMB protocol called "Mellona.exe" to spread destructive ransomware.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305648", label="Incident ID", disabled=True)
