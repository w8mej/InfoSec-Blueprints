...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UACME
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UACME tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004769", label="Incident ID", disabled=True)
