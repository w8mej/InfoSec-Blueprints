...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FlipperZero
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FlipperZero tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000506", label="Incident ID", disabled=True)
