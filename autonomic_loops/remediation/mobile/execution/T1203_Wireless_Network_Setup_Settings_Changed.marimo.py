...
def bluf(mo):
    mo.md(
        r"""
        # Wireless Network Setup Settings Changed
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects manipulation of a registry key that allows to trigger an undocumented feature of legitimate setupSNK.exe, to load a custom DLL. This function is misused by InvisiMole Group to mask execution of malicious code, as reported in June 2020.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309708", label="Incident ID", disabled=True)
