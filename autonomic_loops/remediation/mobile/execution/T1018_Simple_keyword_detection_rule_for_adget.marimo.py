...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adget
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adget tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001184", label="Incident ID", disabled=True)
