...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSRecon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSRecon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005388", label="Incident ID", disabled=True)
