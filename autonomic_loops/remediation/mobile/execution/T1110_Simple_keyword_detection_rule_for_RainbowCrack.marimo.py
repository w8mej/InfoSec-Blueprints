...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RainbowCrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RainbowCrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006208", label="Incident ID", disabled=True)
