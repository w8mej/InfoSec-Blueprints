...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EyeWitness
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EyeWitness tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003270", label="Incident ID", disabled=True)
