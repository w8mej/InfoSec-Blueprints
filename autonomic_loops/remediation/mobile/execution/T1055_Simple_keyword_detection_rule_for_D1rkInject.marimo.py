...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for D1rkInject
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on D1rkInject tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008287", label="Incident ID", disabled=True)
