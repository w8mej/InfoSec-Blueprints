...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PRT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PRT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006476", label="Incident ID", disabled=True)
