...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bulletpassview
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bulletpassview tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002126", label="Incident ID", disabled=True)
