...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for crackpkcs12
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on crackpkcs12 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001801", label="Incident ID", disabled=True)
