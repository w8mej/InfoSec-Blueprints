...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharPyShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharPyShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009066", label="Incident ID", disabled=True)
