...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Rudrastra
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Rudrastra tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001556", label="Incident ID", disabled=True)
