...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Shell3er
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Shell3er tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006680", label="Incident ID", disabled=True)
