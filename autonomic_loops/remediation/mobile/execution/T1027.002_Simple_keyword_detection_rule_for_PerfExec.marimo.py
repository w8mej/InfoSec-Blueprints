...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PerfExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PerfExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008824", label="Incident ID", disabled=True)
