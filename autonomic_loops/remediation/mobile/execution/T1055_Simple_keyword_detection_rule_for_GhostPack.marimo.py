...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GhostPack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GhostPack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907497", label="Incident ID", disabled=True)
