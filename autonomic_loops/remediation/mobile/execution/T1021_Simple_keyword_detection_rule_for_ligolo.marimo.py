...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ligolo
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ligolo tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009633", label="Incident ID", disabled=True)
