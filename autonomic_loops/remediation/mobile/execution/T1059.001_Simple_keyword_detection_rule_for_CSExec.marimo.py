...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CSExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CSExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004379", label="Incident ID", disabled=True)
