...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ghauri
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ghauri tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009715", label="Incident ID", disabled=True)
