...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pwnat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pwnat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006103", label="Incident ID", disabled=True)
