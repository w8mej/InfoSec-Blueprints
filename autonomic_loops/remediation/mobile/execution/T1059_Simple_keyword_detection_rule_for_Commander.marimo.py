...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Commander
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Commander tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003720", label="Incident ID", disabled=True)
