...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VDR
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VDR tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009041", label="Incident ID", disabled=True)
