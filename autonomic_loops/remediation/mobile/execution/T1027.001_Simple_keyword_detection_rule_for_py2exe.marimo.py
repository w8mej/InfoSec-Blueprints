...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for py2exe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on py2exe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001724", label="Incident ID", disabled=True)
