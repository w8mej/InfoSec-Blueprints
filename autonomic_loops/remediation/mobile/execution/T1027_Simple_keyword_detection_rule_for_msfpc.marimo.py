...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for msfpc
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on msfpc tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907602", label="Incident ID", disabled=True)
