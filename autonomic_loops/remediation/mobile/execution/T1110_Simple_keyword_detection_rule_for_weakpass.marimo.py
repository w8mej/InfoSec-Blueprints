...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for weakpass
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on weakpass tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005197", label="Incident ID", disabled=True)
