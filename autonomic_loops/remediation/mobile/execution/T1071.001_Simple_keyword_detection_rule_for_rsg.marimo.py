...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rsg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rsg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006549", label="Incident ID", disabled=True)
