...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tasklist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tasklist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000447", label="Incident ID", disabled=True)
