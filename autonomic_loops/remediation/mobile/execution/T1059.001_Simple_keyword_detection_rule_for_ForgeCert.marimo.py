...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ForgeCert
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ForgeCert tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903816", label="Incident ID", disabled=True)
