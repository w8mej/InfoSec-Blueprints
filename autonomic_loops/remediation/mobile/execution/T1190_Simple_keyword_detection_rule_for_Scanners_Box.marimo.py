...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Scanners-Box
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Scanners-Box tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005609", label="Incident ID", disabled=True)
