...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for commix
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on commix tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003220", label="Incident ID", disabled=True)
