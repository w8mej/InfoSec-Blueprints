...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for localpotato
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on localpotato tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004924", label="Incident ID", disabled=True)
