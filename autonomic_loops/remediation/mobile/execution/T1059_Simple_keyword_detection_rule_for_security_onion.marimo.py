...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for security-onion
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on security-onion tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006144", label="Incident ID", disabled=True)
