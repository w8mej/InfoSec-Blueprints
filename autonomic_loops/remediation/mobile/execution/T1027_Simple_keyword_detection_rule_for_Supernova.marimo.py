...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Supernova
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Supernova tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003475", label="Incident ID", disabled=True)
