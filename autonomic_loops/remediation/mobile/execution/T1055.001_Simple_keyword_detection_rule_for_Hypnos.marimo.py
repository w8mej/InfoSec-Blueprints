...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hypnos
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hypnos tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909840", label="Incident ID", disabled=True)
