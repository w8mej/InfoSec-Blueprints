...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ldapminer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ldapminer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009713", label="Incident ID", disabled=True)
