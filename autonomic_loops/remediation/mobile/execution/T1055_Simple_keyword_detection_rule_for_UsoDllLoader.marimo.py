...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UsoDllLoader
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UsoDllLoader tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008138", label="Incident ID", disabled=True)
