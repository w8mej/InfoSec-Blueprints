...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for HackTheWorld
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on HackTheWorld tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903245", label="Incident ID", disabled=True)
