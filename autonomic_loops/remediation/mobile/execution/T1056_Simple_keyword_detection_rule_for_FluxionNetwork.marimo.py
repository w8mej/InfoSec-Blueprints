...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FluxionNetwork
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FluxionNetwork tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007786", label="Incident ID", disabled=True)
