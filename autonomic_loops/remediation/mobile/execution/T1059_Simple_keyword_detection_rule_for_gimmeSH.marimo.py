...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gimmeSH
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gimmeSH tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003679", label="Incident ID", disabled=True)
