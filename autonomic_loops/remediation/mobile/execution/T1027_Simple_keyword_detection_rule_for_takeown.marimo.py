...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for takeown
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on takeown tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003915", label="Incident ID", disabled=True)
