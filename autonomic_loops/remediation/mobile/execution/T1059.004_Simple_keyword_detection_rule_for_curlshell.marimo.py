...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for curlshell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on curlshell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007615", label="Incident ID", disabled=True)
