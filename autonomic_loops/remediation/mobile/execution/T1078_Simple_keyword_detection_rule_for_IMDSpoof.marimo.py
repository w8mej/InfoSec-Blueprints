...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for IMDSpoof
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on IMDSpoof tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007081", label="Incident ID", disabled=True)
