...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnscat2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnscat2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000770", label="Incident ID", disabled=True)
