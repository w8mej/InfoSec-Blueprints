...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Salsa-tools
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Salsa-tools tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006438", label="Incident ID", disabled=True)
