...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ShellPop
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ShellPop tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003786", label="Incident ID", disabled=True)
