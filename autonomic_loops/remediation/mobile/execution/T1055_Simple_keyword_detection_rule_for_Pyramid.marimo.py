...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pyramid
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pyramid tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002917", label="Incident ID", disabled=True)
