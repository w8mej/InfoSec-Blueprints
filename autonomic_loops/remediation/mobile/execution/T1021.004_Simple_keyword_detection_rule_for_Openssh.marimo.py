...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Openssh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Openssh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000425", label="Incident ID", disabled=True)
