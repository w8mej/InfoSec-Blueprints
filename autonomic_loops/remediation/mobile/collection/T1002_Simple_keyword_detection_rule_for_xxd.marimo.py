...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for xxd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on xxd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906341", label="Incident ID", disabled=True)
