...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Azure-AccessPermissions
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Azure-AccessPermissions tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002274", label="Incident ID", disabled=True)
