...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dpapi.py
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dpapi.py tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006326", label="Incident ID", disabled=True)
