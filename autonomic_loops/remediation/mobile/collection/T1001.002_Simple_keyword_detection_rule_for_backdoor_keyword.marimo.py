...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for backdoor keyword
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on backdoor keyword tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002106", label="Incident ID", disabled=True)
