...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dnscmd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dnscmd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008568", label="Incident ID", disabled=True)
