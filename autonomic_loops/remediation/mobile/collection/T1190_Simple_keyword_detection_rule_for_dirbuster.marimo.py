...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dirbuster
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dirbuster tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006699", label="Incident ID", disabled=True)
