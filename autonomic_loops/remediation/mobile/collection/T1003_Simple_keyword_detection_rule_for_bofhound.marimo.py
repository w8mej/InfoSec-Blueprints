...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bofhound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bofhound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004547", label="Incident ID", disabled=True)
