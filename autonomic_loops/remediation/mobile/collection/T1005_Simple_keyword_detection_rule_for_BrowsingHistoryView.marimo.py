...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BrowsingHistoryView
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BrowsingHistoryView tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008675", label="Incident ID", disabled=True)
