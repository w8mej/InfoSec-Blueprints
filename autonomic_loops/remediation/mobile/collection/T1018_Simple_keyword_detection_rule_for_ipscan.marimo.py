...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ipscan
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ipscan tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000416", label="Incident ID", disabled=True)
