...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WMImplant
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WMImplant tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002812", label="Incident ID", disabled=True)
