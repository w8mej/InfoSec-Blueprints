...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for netsh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on netsh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003066", label="Incident ID", disabled=True)
