...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rsocx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rsocx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003079", label="Incident ID", disabled=True)
