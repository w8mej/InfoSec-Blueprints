...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SlinkyCat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SlinkyCat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008012", label="Incident ID", disabled=True)
