...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ducktail
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ducktail tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008808", label="Incident ID", disabled=True)
