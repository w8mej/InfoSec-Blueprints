...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for gimmecredz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on gimmecredz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003881", label="Incident ID", disabled=True)
