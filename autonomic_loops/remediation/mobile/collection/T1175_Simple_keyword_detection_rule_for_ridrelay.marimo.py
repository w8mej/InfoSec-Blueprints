...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ridrelay
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ridrelay tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005792", label="Incident ID", disabled=True)
