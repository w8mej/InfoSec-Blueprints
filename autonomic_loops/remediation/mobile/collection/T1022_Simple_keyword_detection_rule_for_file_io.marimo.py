...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for file.io
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on file.io tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007815", label="Incident ID", disabled=True)
