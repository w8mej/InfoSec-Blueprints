...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sliver
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sliver tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008376", label="Incident ID", disabled=True)
