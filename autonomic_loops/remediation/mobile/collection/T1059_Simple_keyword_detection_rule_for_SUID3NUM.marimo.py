...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SUID3NUM
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SUID3NUM tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000555", label="Incident ID", disabled=True)
