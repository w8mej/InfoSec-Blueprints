...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole RC2CL Backdoor
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects artefacts associated with InvisiMole RC2CL backdoor, as reported in 2018 and 2020
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302458", label="Incident ID", disabled=True)
