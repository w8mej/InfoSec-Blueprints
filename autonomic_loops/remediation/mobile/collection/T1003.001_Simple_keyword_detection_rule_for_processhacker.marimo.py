...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for processhacker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on processhacker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004212", label="Incident ID", disabled=True)
