...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dsquery
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dsquery tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007745", label="Incident ID", disabled=True)
