...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for evilginx
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on evilginx tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009838", label="Incident ID", disabled=True)
