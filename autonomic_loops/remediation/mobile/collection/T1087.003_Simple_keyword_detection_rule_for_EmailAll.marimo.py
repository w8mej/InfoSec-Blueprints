...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for EmailAll
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on EmailAll tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004636", label="Incident ID", disabled=True)
