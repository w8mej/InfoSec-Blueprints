...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for github
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on github tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003968", label="Incident ID", disabled=True)
