...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for enum4linux
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on enum4linux tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001311", label="Incident ID", disabled=True)
