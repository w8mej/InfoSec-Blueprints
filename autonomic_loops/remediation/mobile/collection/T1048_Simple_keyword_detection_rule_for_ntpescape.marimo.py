...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ntpescape
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ntpescape tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009767", label="Incident ID", disabled=True)
