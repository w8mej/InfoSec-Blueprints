...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LinkedInt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LinkedInt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006041", label="Incident ID", disabled=True)
