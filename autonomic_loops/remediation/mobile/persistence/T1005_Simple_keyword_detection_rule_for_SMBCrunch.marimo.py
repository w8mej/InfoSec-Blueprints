...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SMBCrunch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SMBCrunch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000515", label="Incident ID", disabled=True)
