...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for awesome-web-security
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on awesome-web-security tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002984", label="Incident ID", disabled=True)
