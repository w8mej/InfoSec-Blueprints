...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Fuck-Etw
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Fuck-Etw tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000630", label="Incident ID", disabled=True)
