...
def bluf(mo):
    mo.md(
        r"""
        # MSDT.exe Creates Files in Autorun Directory
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects msdt.exe creating files in suspicious directories
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309972", label="Incident ID", disabled=True)
