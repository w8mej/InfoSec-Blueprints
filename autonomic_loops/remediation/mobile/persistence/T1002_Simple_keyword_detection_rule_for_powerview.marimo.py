...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for powerview
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on powerview tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004623", label="Incident ID", disabled=True)
