...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for csploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on csploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009294", label="Incident ID", disabled=True)
