...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for privexchange
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on privexchange tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007065", label="Incident ID", disabled=True)
