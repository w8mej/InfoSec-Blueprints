...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for IntruderPayloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on IntruderPayloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006664", label="Incident ID", disabled=True)
