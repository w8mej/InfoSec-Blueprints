...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FakeCmdLine
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FakeCmdLine tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002641", label="Incident ID", disabled=True)
