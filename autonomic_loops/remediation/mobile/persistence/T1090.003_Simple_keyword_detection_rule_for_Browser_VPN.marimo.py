...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Browser VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Browser VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002659", label="Incident ID", disabled=True)
