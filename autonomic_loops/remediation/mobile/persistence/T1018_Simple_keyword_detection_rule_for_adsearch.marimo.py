...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for adsearch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on adsearch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002684", label="Incident ID", disabled=True)
