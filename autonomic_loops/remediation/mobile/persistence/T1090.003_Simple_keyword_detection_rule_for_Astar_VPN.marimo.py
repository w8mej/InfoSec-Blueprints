...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Astar VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Astar VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008292", label="Incident ID", disabled=True)
