...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wifi-bruteforcer-fsecurity
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wifi-bruteforcer-fsecurity tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909582", label="Incident ID", disabled=True)
