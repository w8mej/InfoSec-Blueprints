...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UnhookingPatch
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UnhookingPatch tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005631", label="Incident ID", disabled=True)
