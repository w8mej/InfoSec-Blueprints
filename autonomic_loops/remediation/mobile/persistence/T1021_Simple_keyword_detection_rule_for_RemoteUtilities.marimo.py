...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RemoteUtilities
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RemoteUtilities tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008043", label="Incident ID", disabled=True)
