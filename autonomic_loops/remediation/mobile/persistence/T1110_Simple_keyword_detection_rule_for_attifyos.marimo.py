...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for attifyos
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on attifyos tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001222", label="Incident ID", disabled=True)
