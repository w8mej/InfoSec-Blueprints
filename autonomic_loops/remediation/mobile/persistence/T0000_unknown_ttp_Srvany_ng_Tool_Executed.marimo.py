...
def bluf(mo):
    mo.md(
        r"""
        # Srvany-ng Tool Executed
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects execution of legitimate srvany-ng tool, that allows running any Windows application as a service. This LOLBin is misused by InvisiMole Group to mask execution of malware, as reported in June 2020.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306621", label="Incident ID", disabled=True)
