...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nopowershell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nopowershell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006461", label="Incident ID", disabled=True)
