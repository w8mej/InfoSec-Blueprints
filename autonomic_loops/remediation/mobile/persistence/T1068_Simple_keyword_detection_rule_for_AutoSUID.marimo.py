...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AutoSUID
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AutoSUID tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009102", label="Incident ID", disabled=True)
