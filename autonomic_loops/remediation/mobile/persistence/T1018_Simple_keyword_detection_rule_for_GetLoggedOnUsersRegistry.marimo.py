...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GetLoggedOnUsersRegistry
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GetLoggedOnUsersRegistry tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009420", label="Incident ID", disabled=True)
