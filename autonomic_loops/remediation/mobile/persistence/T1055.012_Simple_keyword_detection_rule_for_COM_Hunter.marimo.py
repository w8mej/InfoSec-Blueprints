...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for COM-Hunter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on COM-Hunter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005833", label="Incident ID", disabled=True)
