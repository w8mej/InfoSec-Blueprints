...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for donut
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on donut tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002856", label="Incident ID", disabled=True)
