...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPN PROXY MASTER
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPN PROXY MASTER tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002448", label="Incident ID", disabled=True)
