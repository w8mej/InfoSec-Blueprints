...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Anonymous Proxy Vpn Browser
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Anonymous Proxy Vpn Browser tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004957", label="Incident ID", disabled=True)
