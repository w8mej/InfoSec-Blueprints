...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Fornex VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Fornex VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000687", label="Incident ID", disabled=True)
