...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free One Touch VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free One Touch VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005861", label="Incident ID", disabled=True)
