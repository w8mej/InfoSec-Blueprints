...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pwn_jenkins
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pwn_jenkins tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007099", label="Incident ID", disabled=True)
