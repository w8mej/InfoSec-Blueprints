...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NordVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NordVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003811", label="Incident ID", disabled=True)
