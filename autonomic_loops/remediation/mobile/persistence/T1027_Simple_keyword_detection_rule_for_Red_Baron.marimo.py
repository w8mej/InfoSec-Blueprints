...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Red-Baron
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Red-Baron tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009773", label="Incident ID", disabled=True)
