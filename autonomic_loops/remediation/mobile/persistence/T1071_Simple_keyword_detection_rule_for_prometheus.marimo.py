...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for prometheus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on prometheus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004542", label="Incident ID", disabled=True)
