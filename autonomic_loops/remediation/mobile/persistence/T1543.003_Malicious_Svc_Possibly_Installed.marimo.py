...
def bluf(mo):
    mo.md(
        r"""
        # Malicious Svc Possibly Installed
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Malicious service was possibly installed based on suspicious entries in ./rules/config/regex/regexes_suspicous_service.txt
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305382", label="Incident ID", disabled=True)
