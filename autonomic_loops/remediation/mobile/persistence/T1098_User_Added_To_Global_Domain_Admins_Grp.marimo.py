...
def bluf(mo):
    mo.md(
        r"""
        # User Added To Global Domain Admins Grp
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > A user was added to the Domain Admins group. Only logged on DCs.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303468", label="Incident ID", disabled=True)
