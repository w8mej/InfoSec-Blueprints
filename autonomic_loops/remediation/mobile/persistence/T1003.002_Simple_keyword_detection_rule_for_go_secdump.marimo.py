...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for go-secdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on go-secdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007367", label="Incident ID", disabled=True)
