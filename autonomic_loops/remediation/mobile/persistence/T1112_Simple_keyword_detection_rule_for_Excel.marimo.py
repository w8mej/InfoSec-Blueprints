...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Excel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Excel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004903", label="Incident ID", disabled=True)
