...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for w3af
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on w3af tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001825", label="Incident ID", disabled=True)
