...
def bluf(mo):
    mo.md(
        r"""
        # Electron Application Search-Order Hijack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects the creation of an Electron hijack abusing the application search-order for persistence, execution and defense evasion.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307663", label="Incident ID", disabled=True)
