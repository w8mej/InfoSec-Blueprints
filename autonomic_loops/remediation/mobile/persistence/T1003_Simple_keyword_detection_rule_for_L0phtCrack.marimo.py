...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for L0phtCrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on L0phtCrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003037", label="Incident ID", disabled=True)
