...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Browsec VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Browsec VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003791", label="Incident ID", disabled=True)
