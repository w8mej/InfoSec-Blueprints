...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AutoRDPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AutoRDPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005006", label="Incident ID", disabled=True)
