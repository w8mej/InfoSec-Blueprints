...
def bluf(mo):
    mo.md(
        ...
        >
        > This rule looks for post requests to a single webserver location from less than 3 IPs over 24 hours. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="102982", label="Incident ID", disabled=True)
