...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pwdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pwdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000463", label="Incident ID", disabled=True)
