...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hideman VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hideman VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907719", label="Incident ID", disabled=True)
