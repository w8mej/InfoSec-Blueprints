...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for icmpsh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on icmpsh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005895", label="Incident ID", disabled=True)
