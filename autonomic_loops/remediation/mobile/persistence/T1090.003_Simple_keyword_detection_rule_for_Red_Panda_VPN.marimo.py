...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Red Panda VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Red Panda VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000223", label="Incident ID", disabled=True)
