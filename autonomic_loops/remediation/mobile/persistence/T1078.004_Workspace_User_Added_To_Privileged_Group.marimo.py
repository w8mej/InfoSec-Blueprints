...
def bluf(mo):
    mo.md(
        r"""
        # Workspace User Added To Privileged Group
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when a user is added to a privileged group
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1203329", label="Incident ID", disabled=True)
