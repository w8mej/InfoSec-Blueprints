...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hotspot Shield Free VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hotspot Shield Free VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000518", label="Incident ID", disabled=True)
