...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for daphne
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on daphne tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008202", label="Incident ID", disabled=True)
