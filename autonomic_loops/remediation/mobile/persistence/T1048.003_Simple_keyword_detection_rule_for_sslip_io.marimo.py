...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sslip.io
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sslip.io tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007424", label="Incident ID", disabled=True)
