...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bash
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bash tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902279", label="Incident ID", disabled=True)
