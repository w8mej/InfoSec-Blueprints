...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ImplantSSP
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ImplantSSP tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005084", label="Incident ID", disabled=True)
