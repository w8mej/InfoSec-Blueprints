...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PassHunt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PassHunt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000795", label="Incident ID", disabled=True)
