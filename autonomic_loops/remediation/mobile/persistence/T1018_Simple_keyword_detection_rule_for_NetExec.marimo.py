...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002072", label="Incident ID", disabled=True)
