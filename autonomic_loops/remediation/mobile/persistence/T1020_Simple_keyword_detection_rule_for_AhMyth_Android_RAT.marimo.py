...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AhMyth-Android-RAT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AhMyth-Android-RAT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005656", label="Incident ID", disabled=True)
