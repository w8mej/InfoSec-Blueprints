...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TunnelBear VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TunnelBear VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901616", label="Incident ID", disabled=True)
