...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Pulseway
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Pulseway tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004004", label="Incident ID", disabled=True)
