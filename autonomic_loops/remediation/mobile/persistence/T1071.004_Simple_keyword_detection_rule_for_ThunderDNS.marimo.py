...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ThunderDNS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ThunderDNS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009396", label="Incident ID", disabled=True)
