...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for usbpcap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on usbpcap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007990", label="Incident ID", disabled=True)
