...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SniffAir
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SniffAir tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008957", label="Incident ID", disabled=True)
