...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for StayKit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on StayKit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="900397", label="Incident ID", disabled=True)
