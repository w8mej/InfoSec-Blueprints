...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cloudsploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cloudsploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008585", label="Incident ID", disabled=True)
