...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for conhost.exe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on conhost.exe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000184", label="Incident ID", disabled=True)
