...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CoercedPotatoRDLL
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CoercedPotatoRDLL tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005690", label="Incident ID", disabled=True)
