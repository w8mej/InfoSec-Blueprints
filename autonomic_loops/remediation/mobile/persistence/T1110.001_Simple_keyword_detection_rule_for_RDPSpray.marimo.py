...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RDPSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RDPSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003070", label="Incident ID", disabled=True)
