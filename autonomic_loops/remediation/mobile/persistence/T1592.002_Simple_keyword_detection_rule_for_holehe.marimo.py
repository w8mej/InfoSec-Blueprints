...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for holehe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on holehe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002203", label="Incident ID", disabled=True)
