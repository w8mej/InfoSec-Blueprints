...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rmmod
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rmmod tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903009", label="Incident ID", disabled=True)
