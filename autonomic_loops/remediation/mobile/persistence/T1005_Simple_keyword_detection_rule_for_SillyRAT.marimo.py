...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SillyRAT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SillyRAT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006571", label="Incident ID", disabled=True)
