...
def bluf(mo):
    mo.md(
        ...
        >
        > Searches for hex encoded 50+ character strings which may be shellcode hiding in event logs.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306030", label="Incident ID", disabled=True)
