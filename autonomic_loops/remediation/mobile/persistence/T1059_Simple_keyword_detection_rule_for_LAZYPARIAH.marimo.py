...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LAZYPARIAH
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LAZYPARIAH tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001337", label="Incident ID", disabled=True)
