...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RemotePC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RemotePC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004690", label="Incident ID", disabled=True)
