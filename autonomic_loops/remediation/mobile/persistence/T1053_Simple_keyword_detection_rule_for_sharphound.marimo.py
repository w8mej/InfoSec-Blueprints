...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sharphound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sharphound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001482", label="Incident ID", disabled=True)
