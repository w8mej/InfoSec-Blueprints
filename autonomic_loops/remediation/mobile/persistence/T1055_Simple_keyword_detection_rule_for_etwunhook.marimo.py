...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for etwunhook
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on etwunhook tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001309", label="Incident ID", disabled=True)
