...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for JumpSession_BOF
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on JumpSession_BOF tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000996", label="Incident ID", disabled=True)
