...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Exrop
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Exrop tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009849", label="Incident ID", disabled=True)
