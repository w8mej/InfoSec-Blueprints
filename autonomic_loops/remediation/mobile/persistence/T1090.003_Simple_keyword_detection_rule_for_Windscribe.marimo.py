...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Windscribe
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Windscribe tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000738", label="Incident ID", disabled=True)
