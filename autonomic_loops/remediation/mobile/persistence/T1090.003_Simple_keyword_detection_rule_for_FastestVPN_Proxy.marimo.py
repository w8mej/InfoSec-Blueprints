...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FastestVPN Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FastestVPN Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003711", label="Incident ID", disabled=True)
