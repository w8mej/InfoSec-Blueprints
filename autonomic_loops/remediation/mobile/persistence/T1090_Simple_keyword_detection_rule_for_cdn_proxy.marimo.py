...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cdn-proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cdn-proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006965", label="Incident ID", disabled=True)
