...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for modproble
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on modproble tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001939", label="Incident ID", disabled=True)
