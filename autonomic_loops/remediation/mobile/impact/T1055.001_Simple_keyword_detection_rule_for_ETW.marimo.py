...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ETW
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ETW tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008155", label="Incident ID", disabled=True)
