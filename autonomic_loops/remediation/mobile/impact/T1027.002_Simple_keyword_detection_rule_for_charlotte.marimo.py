...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for charlotte
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on charlotte tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001081", label="Incident ID", disabled=True)
