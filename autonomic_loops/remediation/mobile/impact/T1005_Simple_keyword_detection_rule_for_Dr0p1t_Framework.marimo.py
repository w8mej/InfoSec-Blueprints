...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Dr0p1t-Framework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Dr0p1t-Framework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001379", label="Incident ID", disabled=True)
