...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for AoratosWin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on AoratosWin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003352", label="Incident ID", disabled=True)
