...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for InsecurePowerShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on InsecurePowerShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001044", label="Incident ID", disabled=True)
