...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Akira
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Akira tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001154", label="Incident ID", disabled=True)
