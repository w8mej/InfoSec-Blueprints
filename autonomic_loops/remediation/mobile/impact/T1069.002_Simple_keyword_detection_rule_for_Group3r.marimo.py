...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Group3r
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Group3r tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007360", label="Incident ID", disabled=True)
