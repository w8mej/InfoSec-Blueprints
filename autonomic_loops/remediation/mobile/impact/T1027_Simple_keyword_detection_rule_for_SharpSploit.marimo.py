...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpSploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpSploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005401", label="Incident ID", disabled=True)
