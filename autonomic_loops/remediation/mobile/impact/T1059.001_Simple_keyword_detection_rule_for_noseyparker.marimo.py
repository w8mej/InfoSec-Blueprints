...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for noseyparker
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on noseyparker tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001344", label="Incident ID", disabled=True)
