...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ExtensionSpoofer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ExtensionSpoofer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003917", label="Incident ID", disabled=True)
