...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for acltoolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on acltoolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005172", label="Incident ID", disabled=True)
