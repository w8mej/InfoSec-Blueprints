...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PAExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PAExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004860", label="Incident ID", disabled=True)
