...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for systemctl
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on systemctl tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002384", label="Incident ID", disabled=True)
