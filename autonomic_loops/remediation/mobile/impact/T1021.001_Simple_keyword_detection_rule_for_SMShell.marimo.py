...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SMShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SMShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001892", label="Incident ID", disabled=True)
