...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VoidCrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VoidCrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="906247", label="Incident ID", disabled=True)
