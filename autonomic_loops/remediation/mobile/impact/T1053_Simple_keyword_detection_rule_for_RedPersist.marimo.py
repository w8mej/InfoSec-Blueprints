...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RedPersist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RedPersist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002765", label="Incident ID", disabled=True)
