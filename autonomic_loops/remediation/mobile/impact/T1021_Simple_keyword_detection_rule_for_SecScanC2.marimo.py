...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SecScanC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SecScanC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009820", label="Incident ID", disabled=True)
