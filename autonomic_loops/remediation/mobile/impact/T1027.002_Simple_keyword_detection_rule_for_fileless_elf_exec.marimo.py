...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fileless-elf-exec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fileless-elf-exec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007275", label="Incident ID", disabled=True)
