...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RDE1
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RDE1 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009814", label="Incident ID", disabled=True)
