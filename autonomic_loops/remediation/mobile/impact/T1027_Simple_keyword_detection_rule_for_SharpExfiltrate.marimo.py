...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpExfiltrate
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpExfiltrate tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004653", label="Incident ID", disabled=True)
