...
def bluf(mo):
    mo.md(
        r"""
        # GCP Autoscaling Threshold Exceeded
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > Identifies when autoscaling events have exceeded a threshold. Uses Sigma correlation rules.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="702248", label="Incident ID", disabled=True)
