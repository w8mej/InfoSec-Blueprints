...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for TorPylle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on TorPylle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006830", label="Incident ID", disabled=True)
