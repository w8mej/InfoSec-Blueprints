...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for linux
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on linux tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002862", label="Incident ID", disabled=True)
