...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for reg
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on reg tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004734", label="Incident ID", disabled=True)
