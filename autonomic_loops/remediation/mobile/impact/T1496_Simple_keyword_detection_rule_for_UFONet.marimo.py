...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UFONet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UFONet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006190", label="Incident ID", disabled=True)
