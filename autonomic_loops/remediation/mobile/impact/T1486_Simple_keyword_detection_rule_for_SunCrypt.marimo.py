...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SunCrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SunCrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001858", label="Incident ID", disabled=True)
