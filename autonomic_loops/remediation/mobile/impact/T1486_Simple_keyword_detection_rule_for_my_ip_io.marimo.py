...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for my-ip.io
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on my-ip.io tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009859", label="Incident ID", disabled=True)
