...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DiskCryptor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DiskCryptor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004722", label="Incident ID", disabled=True)
