...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for truffleHog
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on truffleHog tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002182", label="Incident ID", disabled=True)
