...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for certsync
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on certsync tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003122", label="Incident ID", disabled=True)
