...
def bluf(mo):
    mo.md(
        ...
        >
        > The time wmiprvse was executed and path to the provider DLL. Attackers may sometimes install malicious WMI provider DLLs.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302632", label="Incident ID", disabled=True)
