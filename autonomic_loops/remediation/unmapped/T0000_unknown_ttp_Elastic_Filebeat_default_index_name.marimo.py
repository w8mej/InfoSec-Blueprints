...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Filebeat default index name
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005648", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50005648",
        event_source     = "pod_security",
