...
def bluf(mo):
    mo.md(
        r"""
        # Zeek field mappings for default collection of JSON logs with no parsing/normalization done and sending into logstash-*index
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009617", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50009617",
        event_source     = "opentelemetry",
