...
def bluf(mo):
    mo.md(
        r"""
        # Contional mapping with multiple targets
        
        > [!CAUTION]
        > **SIGMA RULE SEVERITY LEVEL. REFLECTS THE RISK ASSOCIATED WITH A TRUE POSITIVE EVENT. SEVERITY** | **ASO PLAYBOOK**
        >
        > Logpoint configuration causes conditional mapping with multiple results
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304683", label="Incident ID", disabled=True)
