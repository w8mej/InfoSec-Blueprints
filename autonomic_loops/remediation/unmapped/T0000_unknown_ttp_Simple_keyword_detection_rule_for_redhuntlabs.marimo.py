...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for redhuntlabs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on redhuntlabs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008404", label="Incident ID", disabled=True)
