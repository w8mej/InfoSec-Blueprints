...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Proxmark
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Proxmark tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004710", label="Incident ID", disabled=True)
