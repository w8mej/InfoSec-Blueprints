...
def bluf(mo):
    mo.md(
        r"""
        # Conversion of Generic Windows Service to Channel and EventID
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001303", label="Incident ID", disabled=True)
