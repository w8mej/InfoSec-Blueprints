...
def bluf(mo):
    mo.md(
        ...
        >
        > Type 12 logons can be dangerous as the credentials (plaintext or hashed passwords) are stored in memory (lsass process) and can be stolen by tools like mimikatz.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309597", label="Incident ID", disabled=True)
