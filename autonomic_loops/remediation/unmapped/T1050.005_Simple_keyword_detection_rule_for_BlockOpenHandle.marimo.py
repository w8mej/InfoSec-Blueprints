...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BlockOpenHandle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BlockOpenHandle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005967", label="Incident ID", disabled=True)
