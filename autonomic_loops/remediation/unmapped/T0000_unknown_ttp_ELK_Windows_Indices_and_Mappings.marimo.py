...
def bluf(mo):
    mo.md(
        r"""
        # ELK Windows Indices and Mappings
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008900", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50008900",
        event_source     = "vector_database",
