...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for apollon
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on apollon tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002673", label="Incident ID", disabled=True)
