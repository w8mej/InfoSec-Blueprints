...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects suspicious start of program that usually requires a DLL as parameter, which can be a sign of process injection or hollowing activity
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306137", label="Incident ID", disabled=True)
