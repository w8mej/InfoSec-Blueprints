...
def bluf(mo):
    mo.md(
        ...
        >
        > Originally "Special privileges assigned to new logon". This will create a seperate LID that is used when special admin-level privileges are used.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300326", label="Incident ID", disabled=True)
