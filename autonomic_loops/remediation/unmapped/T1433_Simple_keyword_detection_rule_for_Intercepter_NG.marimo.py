...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Intercepter-NG
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Intercepter-NG tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005576", label="Incident ID", disabled=True)
