...
def bluf(mo):
    mo.md(
        r"""
        # HEURISTIC Microsoft Office Creating Suspicious Process
        
        > [!CAUTION]
        > **SIGMA RULE SEVERITY LEVEL. REFLECTS THE RISK ASSOCIATED WITH A TRUE POSITIVE EVENT. SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects suspicious processes created from microsoft office products.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309687", label="Incident ID", disabled=True)
