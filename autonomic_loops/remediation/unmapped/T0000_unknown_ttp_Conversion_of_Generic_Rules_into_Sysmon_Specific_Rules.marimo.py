...
def bluf(mo):
    mo.md(
        r"""
        # Conversion of Generic Rules into Sysmon Specific Rules
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001234", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50001234",
        event_source     = "ebpf_kernel",
