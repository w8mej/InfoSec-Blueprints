...
def bluf(mo):
    mo.md(
        r"""
        # Elastic filebeat (from 7.x) index pattern and field mapping following Elastic Common Schema
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009896", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50009896",
        event_source     = "service_mesh",
