...
def bluf(mo):
    mo.md(
        r"""
        # Azure AD Signin Audit Logs Elasticsearch ecs mapping
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001719", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50001719",
        event_source     = "data_labeling",
