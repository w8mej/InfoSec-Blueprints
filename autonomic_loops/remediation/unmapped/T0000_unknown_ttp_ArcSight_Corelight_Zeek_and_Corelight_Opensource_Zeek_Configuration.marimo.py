...
def bluf(mo):
    mo.md(
        r"""
        # ArcSight Corelight Zeek and Corelight Opensource Zeek Configuration
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905326", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-905326",
        event_source     = "kubernetes_admission",
