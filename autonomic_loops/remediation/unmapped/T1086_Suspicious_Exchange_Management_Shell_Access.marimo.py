...
def bluf(mo):
    mo.md(
        r"""
        # Suspicious Exchange Management Shell Access
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects suspicious PowerShell WSMan activity that might indicate unauthorized access or exploitation of an Exchange server.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1305196", label="Incident ID", disabled=True)
