...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for scshell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on scshell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004192", label="Incident ID", disabled=True)
