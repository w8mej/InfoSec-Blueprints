...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WMIPersistence
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WMIPersistence tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006751", label="Incident ID", disabled=True)
