...
def bluf(mo):
    mo.md(
        r"""
        # VSS卷影复制本地读取Ntds.dit文件(域控主机操作，也适用于VSS卷影复制远程读取Ntds.dit文件)
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > windows server 2008 模拟测试结果
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306229", label="Incident ID", disabled=True)
