...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Common Schema mapping for proxy and webserver logs including NSM logs (zeek/suricata)
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901274", label="Incident ID", disabled=True)
