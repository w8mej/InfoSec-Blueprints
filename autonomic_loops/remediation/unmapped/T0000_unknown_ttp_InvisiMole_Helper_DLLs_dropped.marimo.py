...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole Helper DLLs dropped
        
        > [!CAUTION]
        > **LOW SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects DLL file names, as used by InvisiMole Group, reported in June 2018
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308216", label="Incident ID", disabled=True)
