...
def bluf(mo):
    mo.md(
        r"""
        # windows本地执行reg query HKEY_CURRENT_USER\Software\Microsoft\Terminal Server Client\Default
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300687", label="Incident ID", disabled=True)
