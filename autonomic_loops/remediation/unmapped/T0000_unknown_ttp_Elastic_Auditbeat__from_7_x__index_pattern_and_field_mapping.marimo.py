...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Auditbeat (from 7.x) index pattern and field mapping
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006827", label="Incident ID", disabled=True)
