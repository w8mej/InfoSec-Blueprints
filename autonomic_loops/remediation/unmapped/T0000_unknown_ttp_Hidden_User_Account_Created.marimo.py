...
def bluf(mo):
    mo.md(
        ...
        >
        > A computer account (an account that ends with a $) was created. These accounts are not displayed by default so will be hidden.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1309679", label="Incident ID", disabled=True)
