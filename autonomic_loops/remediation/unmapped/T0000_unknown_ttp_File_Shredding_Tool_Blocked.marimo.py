...
def bluf(mo):
    mo.md(
        r"""
        # File Shredding Tool Blocked
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Sysmon blocked file shredding from a tool like SDelete.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306307", label="Incident ID", disabled=True)
