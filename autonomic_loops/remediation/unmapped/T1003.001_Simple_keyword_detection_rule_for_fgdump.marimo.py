...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fgdump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fgdump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008942", label="Incident ID", disabled=True)
