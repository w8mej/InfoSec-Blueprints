...
def bluf(mo):
    mo.md(
        r"""
        # Oracle WebLogic漏洞利用Z
        
        > [!CAUTION]
        > **CRITICAL SEVERITY** | **ASO PLAYBOOK**
        >
        > 检测对放入WebLogic服务器上密钥库文件夹中的webshell的访问
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001747", label="Incident ID", disabled=True)
