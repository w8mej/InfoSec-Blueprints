...
def bluf(mo):
    mo.md(
        ...
        >
        > A VMGS or VHD (Virtual Hard Disk) image was mounted. They are often used with HyperV.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304137", label="Incident ID", disabled=True)
