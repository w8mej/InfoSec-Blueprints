...
def bluf(mo):
    mo.md(
        r"""
        # Splunk Zeek sourcetype mappings
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006456", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50006456",
        event_source     = "secrets_manager",
