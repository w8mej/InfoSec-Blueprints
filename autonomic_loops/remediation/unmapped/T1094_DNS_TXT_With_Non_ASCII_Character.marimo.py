...
def bluf(mo):
    mo.md(
        r"""
        # DNS TXT With Non ASCII Character
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Advesaries can use DNS TXT requests/responses for C2. Sometimes they may include binary data in the response. Since DNS text should be human readable, this is unusual. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="101526", label="Incident ID", disabled=True)
