...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ratchatpt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ratchatpt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000941", label="Incident ID", disabled=True)
