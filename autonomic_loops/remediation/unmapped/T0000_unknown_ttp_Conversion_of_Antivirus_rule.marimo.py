...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009755", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50009755",
        event_source     = "container_runtime",
