...
def bluf(mo):
    mo.md(
        r"""
        # Dir Svc Obj Modified
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > Directory Service Object Modified. Log written only to domain controllers (2008+)
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302550", label="Incident ID", disabled=True)
