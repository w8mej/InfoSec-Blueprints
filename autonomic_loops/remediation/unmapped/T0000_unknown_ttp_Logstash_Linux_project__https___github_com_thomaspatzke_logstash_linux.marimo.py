...
def bluf(mo):
    mo.md(
        r"""
        # Logstash Linux project (https://github.com/thomaspatzke/logstash-linux)
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007830", label="Incident ID", disabled=True)
