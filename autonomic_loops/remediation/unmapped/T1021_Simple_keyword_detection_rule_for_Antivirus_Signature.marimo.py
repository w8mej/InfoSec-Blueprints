...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Antivirus Signature
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Antivirus Signature tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901265", label="Incident ID", disabled=True)
