...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sendspace.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sendspace.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007492", label="Incident ID", disabled=True)
