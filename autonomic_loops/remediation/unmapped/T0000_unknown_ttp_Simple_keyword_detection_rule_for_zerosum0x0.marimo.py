...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for zerosum0x0
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on zerosum0x0 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004341", label="Incident ID", disabled=True)
