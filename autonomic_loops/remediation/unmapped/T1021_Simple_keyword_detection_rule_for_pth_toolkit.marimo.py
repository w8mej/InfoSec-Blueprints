...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pth-toolkit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pth-toolkit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007020", label="Incident ID", disabled=True)
