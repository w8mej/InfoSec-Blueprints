...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dtd-finder
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dtd-finder tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002287", label="Incident ID", disabled=True)
