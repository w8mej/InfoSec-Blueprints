...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mythic
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mythic tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009063", label="Incident ID", disabled=True)
