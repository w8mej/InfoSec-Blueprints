...
def bluf(mo):
    mo.md(
        r"""
        # Registry Autorun Keys With \AppData\Roaming\
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Attempts to detect direct modification of autostart extensibility point (ASEP) in registry
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303413", label="Incident ID", disabled=True)
