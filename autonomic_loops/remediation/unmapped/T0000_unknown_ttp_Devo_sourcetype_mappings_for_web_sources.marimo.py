...
def bluf(mo):
    mo.md(
        r"""
        # Devo sourcetype mappings for web sources
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006498", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50006498",
        event_source     = "deception_system",
