...
def bluf(mo):
    mo.md(
        r"""
        # Logon (NetworkCleartext)
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > Prints logon information. Despite the naming NetworkCleartext, the password is not sent over the network in cleartext. It is usually for IIS Basic Authentication.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306853", label="Incident ID", disabled=True)
