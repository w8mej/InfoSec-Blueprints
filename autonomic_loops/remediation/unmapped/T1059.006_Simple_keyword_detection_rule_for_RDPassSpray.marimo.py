...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for RDPassSpray
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on RDPassSpray tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007884", label="Incident ID", disabled=True)
