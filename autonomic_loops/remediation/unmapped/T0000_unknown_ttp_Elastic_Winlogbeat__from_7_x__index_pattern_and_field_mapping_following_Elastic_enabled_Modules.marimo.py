...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Winlogbeat (from 7.x) index pattern and field mapping following Elastic enabled Modules
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003171", label="Incident ID", disabled=True)
