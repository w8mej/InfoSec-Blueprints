...
def bluf(mo):
    mo.md(
        r"""
        # Logon (Interactive) (Noisy)
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > This is filtered by default as it is usually system noise.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303804", label="Incident ID", disabled=True)
