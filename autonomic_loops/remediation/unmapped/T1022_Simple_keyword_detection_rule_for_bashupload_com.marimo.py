...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for bashupload.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on bashupload.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000488", label="Incident ID", disabled=True)
