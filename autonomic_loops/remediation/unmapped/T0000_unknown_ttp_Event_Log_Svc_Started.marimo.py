...
def bluf(mo):
    mo.md(
        r"""
        # Event Log Svc Started
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > Startup, restarting the event log service, etc...
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306282", label="Incident ID", disabled=True)
