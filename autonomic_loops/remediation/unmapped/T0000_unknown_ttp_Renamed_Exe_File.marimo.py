...
def bluf(mo):
    mo.md(
        ...
        >
        > This is to detect when an .exe file was renamed. Attackers will often rename malware and lolbas tools in order not to be detected. %OriginalFileName% is the original filename in the PE header when the .exe was compiled.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307579", label="Incident ID", disabled=True)
