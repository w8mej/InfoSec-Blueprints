...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wifi-arsenal
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wifi-arsenal tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009675", label="Incident ID", disabled=True)
