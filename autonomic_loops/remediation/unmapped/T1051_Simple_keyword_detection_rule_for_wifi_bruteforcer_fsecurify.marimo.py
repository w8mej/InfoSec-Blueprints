...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wifi-bruteforcer-fsecurify
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wifi-bruteforcer-fsecurify tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005666", label="Incident ID", disabled=True)
