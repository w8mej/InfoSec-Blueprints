...
def bluf(mo):
    mo.md(
        r"""
        # InvisiMole Artefacts
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects artefacts associated with lateral movement technique used by InvisiMole Group, as reported in June 2020
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304100", label="Incident ID", disabled=True)
