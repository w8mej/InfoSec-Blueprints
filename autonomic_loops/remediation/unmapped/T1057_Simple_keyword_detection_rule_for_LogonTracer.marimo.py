...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LogonTracer
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LogonTracer tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007201", label="Incident ID", disabled=True)
