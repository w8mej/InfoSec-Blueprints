...
def bluf(mo):
    mo.md(
        ...
        >
        > This is to detect when a LOLBIN (default Windows binary) was renamed in order to hide its execution. OringalFileName is the original filename in the PE header. From my tests, false positives should be low so I rated this as high.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304709", label="Incident ID", disabled=True)
