...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PSByPassCLM
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PSByPassCLM tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905749", label="Incident ID", disabled=True)
