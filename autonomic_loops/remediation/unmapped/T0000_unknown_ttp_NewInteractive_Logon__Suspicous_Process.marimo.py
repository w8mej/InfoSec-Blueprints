...
def bluf(mo):
    mo.md(
        r"""
        # NewInteractive Logon (Suspicous Process)
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Tries to detect token impersonation by tools like Cobalt Strike.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302987", label="Incident ID", disabled=True)
