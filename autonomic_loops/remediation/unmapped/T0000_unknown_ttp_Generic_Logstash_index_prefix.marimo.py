...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002513", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50002513",
        event_source     = "training_pipeline",
