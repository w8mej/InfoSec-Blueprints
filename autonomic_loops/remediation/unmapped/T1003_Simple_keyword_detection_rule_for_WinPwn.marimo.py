...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WinPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WinPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004973", label="Incident ID", disabled=True)
