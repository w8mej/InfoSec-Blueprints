...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Office-DDE-Payloads
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Office-DDE-Payloads tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002154", label="Incident ID", disabled=True)
