...
def bluf(mo):
    mo.md(
        r"""
        # General Powershell line suspiciousness
        
        > [!CAUTION]
        > **HIGH SEVERITY** | **ASO PLAYBOOK**
        >
        > Broad rule to detect suspicious Powershell artifacts
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002393", label="Incident ID", disabled=True)
