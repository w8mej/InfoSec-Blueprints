...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NetworkMiner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NetworkMiner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005289", label="Incident ID", disabled=True)
