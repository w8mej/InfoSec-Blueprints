...
def bluf(mo):
    mo.md(
        ...
        >
        > Sysmon process creation. Displays only commands that have not been flagged with a sysmon detection rule.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300380", label="Incident ID", disabled=True)
