...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpToken
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpToken tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008294", label="Incident ID", disabled=True)
