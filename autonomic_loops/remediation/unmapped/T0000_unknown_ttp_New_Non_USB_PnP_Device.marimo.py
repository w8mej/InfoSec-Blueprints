...
def bluf(mo):
    mo.md(
        r"""
        # New Non-USB PnP Device
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > Logs only the first time a device has been plugged in.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1304511", label="Incident ID", disabled=True)
