...
def bluf(mo):
    mo.md(
        r"""
        # Corelight Zeek and Corelight Opensource Zeek Elastic Common Schema (ECS) implementation
        
        > [!CAUTION]
        > **SIGMA RULE SEVERITY LEVEL. REFLECTS THE RISK ASSOCIATED WITH A TRUE POSITIVE EVENT. SEVERITY** | **ASO PLAYBOOK**
        >
        > Uses the mappings as created by Corelight here https://github.com/corelight/ecs-mapping
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009387", label="Incident ID", disabled=True)
