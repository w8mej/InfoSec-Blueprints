...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Common Schema And Elastic Exported Fields Mapping For Suricata Logs
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002213", label="Incident ID", disabled=True)
