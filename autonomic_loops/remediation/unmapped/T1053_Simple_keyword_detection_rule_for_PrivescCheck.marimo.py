...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PrivescCheck
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PrivescCheck tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001866", label="Incident ID", disabled=True)
