...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Auditbeat (from 7.x) index pattern and field mapping following Elastic enabled Modules
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002911", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50002911",
        event_source     = "data_query_engine",
