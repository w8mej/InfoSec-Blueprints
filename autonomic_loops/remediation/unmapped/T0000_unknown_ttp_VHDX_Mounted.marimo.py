...
def bluf(mo):
    mo.md(
        ...
        >
        > A VHDX (Virtual Hard Disk version 2) image was mounted. They are often used with WSL disk partitions.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1307166", label="Incident ID", disabled=True)
