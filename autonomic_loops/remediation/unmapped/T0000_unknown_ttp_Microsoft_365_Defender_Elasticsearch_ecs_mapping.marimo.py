...
def bluf(mo):
    mo.md(
        r"""
        # Microsoft 365 Defender Elasticsearch ecs mapping
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002535", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50002535",
        event_source     = "object_storage",
