...
def bluf(mo):
    mo.md(
        ...
        >
        > Broad rule to detect common bad terms. Warning: Can be noisy
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005901", label="Incident ID", disabled=True)
