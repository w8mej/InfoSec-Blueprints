...
def bluf(mo):
    mo.md(
        ...
        >
        > Outputs results to a Kafka topic. Detects a download from Webdav service which could be used as a way to transfer tools internally. Determine if this is a) Legitimate server b) legitimate binary/file
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="109973", label="Incident ID", disabled=True)
