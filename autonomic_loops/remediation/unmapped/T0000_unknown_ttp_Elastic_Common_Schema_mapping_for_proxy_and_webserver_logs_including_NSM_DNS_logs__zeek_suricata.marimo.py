...
def bluf(mo):
    mo.md(
        r"""
        # Elastic Common Schema mapping for proxy and webserver logs including NSM DNS logs (zeek/suricata)
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009197", label="Incident ID", disabled=True)
