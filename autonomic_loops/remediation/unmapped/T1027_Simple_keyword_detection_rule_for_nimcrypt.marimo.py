...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nimcrypt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nimcrypt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007066", label="Incident ID", disabled=True)
