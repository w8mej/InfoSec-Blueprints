...
def bluf(mo):
    mo.md(
        ...
        >
        > Display network connection without sysmon rule alerts. Disabled by default.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302274", label="Incident ID", disabled=True)
