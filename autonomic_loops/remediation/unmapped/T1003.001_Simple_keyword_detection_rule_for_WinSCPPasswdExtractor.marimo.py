...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for WinSCPPasswdExtractor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on WinSCPPasswdExtractor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004936", label="Incident ID", disabled=True)
