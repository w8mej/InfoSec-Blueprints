...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-TheHash
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-TheHash tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006540", label="Incident ID", disabled=True)
