...
def bluf(mo):
    mo.md(
        ...
        >
        > Used to test cancellation and artifact timeout on server artifact
        collector.
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005352", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50005352",
        event_source     = "policy_engine",
