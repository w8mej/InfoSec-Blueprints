...
def bluf(mo):
    mo.md(
        ...
        >
        > Display network connection with sysmon rule alerts. Disabled by default.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306239", label="Incident ID", disabled=True)
