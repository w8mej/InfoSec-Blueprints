...
def bluf(mo):
    mo.md(
        r"""
        # Devo sourcetype mappings for network sources
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005975", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50005975",
        event_source     = "stargate_api",
