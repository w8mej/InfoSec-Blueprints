...
def bluf(mo):
    mo.md(
        r"""
        # AWS ConsoleLogin From New Country
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000435", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50000435",
        event_source     = "cicd_pipeline",
