...
def bluf(mo):
    mo.md(
        r"""
        # Splunk Windows log source conditions
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005721", label="Incident ID", disabled=True)
...
def context(IncidentContext, alert_confidence, incident_id, target_client, ConfidenceThresholdConfig):
    INCIDENT = IncidentContext(
        ...
        case_id          = "INC-2026-50005721",
        event_source     = "cni_network",
