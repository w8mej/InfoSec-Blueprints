...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CIMplant
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CIMplant tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009916", label="Incident ID", disabled=True)
