...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pysoserial
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pysoserial tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004405", label="Incident ID", disabled=True)
