...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tplmap
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tplmap tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008481", label="Incident ID", disabled=True)
