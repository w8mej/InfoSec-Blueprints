...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for catphish
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on catphish tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000165", label="Incident ID", disabled=True)
