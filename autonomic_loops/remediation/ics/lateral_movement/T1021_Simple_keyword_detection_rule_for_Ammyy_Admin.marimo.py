...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Ammyy Admin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Ammyy Admin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004826", label="Incident ID", disabled=True)
