...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BetterBackdoor
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BetterBackdoor tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="903910", label="Incident ID", disabled=True)
