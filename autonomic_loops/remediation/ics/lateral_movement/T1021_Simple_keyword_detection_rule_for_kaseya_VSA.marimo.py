...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kaseya VSA
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kaseya VSA tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006258", label="Incident ID", disabled=True)
