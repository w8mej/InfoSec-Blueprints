...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rundll32
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rundll32 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000448", label="Incident ID", disabled=True)
