...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for winrs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on winrs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000953", label="Incident ID", disabled=True)
