...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ThunderShell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ThunderShell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003389", label="Incident ID", disabled=True)
