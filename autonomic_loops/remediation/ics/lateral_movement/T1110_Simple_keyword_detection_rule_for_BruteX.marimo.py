...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BruteX
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BruteX tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007946", label="Incident ID", disabled=True)
