...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for find
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on find tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000343", label="Incident ID", disabled=True)
