...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for echo
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on echo tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004714", label="Incident ID", disabled=True)
