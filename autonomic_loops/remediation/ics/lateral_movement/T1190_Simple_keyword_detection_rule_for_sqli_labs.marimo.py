...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sqli-labs
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sqli-labs tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005369", label="Incident ID", disabled=True)
