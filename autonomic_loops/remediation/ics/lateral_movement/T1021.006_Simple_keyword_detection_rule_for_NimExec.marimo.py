...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NimExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NimExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="901814", label="Incident ID", disabled=True)
