...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ophcrack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ophcrack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007448", label="Incident ID", disabled=True)
