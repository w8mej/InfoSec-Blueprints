...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SessionGopher
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SessionGopher tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001468", label="Incident ID", disabled=True)
