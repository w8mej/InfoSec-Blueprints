...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for commando-vm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on commando-vm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007969", label="Incident ID", disabled=True)
