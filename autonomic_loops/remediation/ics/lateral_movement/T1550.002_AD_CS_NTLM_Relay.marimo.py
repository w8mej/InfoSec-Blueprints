...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects Kerberos authentication via client certificate (NTLM relay to Active Directory Certificate Services HTTP enrollment endpoints)
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1308169", label="Incident ID", disabled=True)
