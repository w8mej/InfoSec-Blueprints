...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wmiexec-pro
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wmiexec-pro tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001158", label="Incident ID", disabled=True)
