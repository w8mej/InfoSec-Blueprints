...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker enables the native OpenSSH server feature on Windows to perform stealthy lateral movement.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1302133", label="Incident ID", disabled=True)
