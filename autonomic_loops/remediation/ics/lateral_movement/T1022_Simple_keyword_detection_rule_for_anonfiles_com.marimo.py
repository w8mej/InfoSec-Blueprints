...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for anonfiles.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on anonfiles.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001181", label="Incident ID", disabled=True)
