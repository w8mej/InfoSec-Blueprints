...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Nuages
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Nuages tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005467", label="Incident ID", disabled=True)
