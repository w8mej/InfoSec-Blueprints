...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for disctopia-c2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on disctopia-c2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002313", label="Incident ID", disabled=True)
