...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for koadic
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on koadic tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004188", label="Incident ID", disabled=True)
