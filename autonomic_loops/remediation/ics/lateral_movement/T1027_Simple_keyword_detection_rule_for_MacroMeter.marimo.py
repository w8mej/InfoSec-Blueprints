...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MacroMeter
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MacroMeter tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009879", label="Incident ID", disabled=True)
