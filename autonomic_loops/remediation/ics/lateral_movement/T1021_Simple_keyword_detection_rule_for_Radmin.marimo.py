...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Radmin
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Radmin tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904309", label="Incident ID", disabled=True)
