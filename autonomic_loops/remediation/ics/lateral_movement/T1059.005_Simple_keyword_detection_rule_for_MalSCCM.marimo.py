...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MalSCCM
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MalSCCM tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006929", label="Incident ID", disabled=True)
