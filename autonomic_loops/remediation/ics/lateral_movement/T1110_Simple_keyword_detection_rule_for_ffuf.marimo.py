...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ffuf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ffuf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005431", label="Incident ID", disabled=True)
