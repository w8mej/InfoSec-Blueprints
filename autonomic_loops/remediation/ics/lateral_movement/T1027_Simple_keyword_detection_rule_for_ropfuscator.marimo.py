...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ropfuscator
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ropfuscator tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002453", label="Incident ID", disabled=True)
