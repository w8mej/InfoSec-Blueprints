...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DockerPwn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DockerPwn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002651", label="Incident ID", disabled=True)
