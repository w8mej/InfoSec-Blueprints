...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tacticalrmm
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tacticalrmm tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009123", label="Incident ID", disabled=True)
