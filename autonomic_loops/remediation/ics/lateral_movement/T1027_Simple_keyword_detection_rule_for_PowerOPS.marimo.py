...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerOPS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerOPS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000090", label="Incident ID", disabled=True)
