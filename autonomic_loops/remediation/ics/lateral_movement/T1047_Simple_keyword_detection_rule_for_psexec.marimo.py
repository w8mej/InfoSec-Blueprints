...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for psexec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on psexec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009972", label="Incident ID", disabled=True)
