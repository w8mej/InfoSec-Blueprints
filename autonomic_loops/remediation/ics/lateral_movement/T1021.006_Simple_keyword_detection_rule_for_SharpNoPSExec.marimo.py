...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpNoPSExec
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpNoPSExec tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001772", label="Incident ID", disabled=True)
