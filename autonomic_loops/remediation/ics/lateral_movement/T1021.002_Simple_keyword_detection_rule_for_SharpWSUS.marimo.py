...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpWSUS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpWSUS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006749", label="Incident ID", disabled=True)
