...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenarios where an attacker enables the OpenSSH server on Windows to perform stealthy lateral movement.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300657", label="Incident ID", disabled=True)
