...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for MSDAT
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on MSDAT tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003052", label="Incident ID", disabled=True)
