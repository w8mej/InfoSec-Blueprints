...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SharpPrintNightmare
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SharpPrintNightmare tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000078", label="Incident ID", disabled=True)
