...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for badazure
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on badazure tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006998", label="Incident ID", disabled=True)
