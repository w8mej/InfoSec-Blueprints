...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for V3n0M-Scanner
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on V3n0M-Scanner tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007420", label="Incident ID", disabled=True)
