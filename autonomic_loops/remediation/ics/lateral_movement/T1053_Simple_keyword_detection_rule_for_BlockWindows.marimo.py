...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BlockWindows
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BlockWindows tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008245", label="Incident ID", disabled=True)
