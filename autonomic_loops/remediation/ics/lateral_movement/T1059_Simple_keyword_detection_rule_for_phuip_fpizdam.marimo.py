...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for phuip-fpizdam
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on phuip-fpizdam tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003364", label="Incident ID", disabled=True)
