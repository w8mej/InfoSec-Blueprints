...
def bluf(mo):
    mo.md(
        r"""
        # RDS Connection (Noisy)
        
        > [!CAUTION]
        > **INFORMATIONAL SEVERITY** | **ASO PLAYBOOK**
        >
        > There was a connection to the RDS service. Unfortunately there are no details in this event log.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306996", label="Incident ID", disabled=True)
