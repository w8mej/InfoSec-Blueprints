...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for smb-reverse-shell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on smb-reverse-shell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001748", label="Incident ID", disabled=True)
