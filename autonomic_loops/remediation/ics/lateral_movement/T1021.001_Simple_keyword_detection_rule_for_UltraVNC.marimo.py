...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for UltraVNC
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on UltraVNC tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003123", label="Incident ID", disabled=True)
