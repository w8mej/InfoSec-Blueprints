...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for tempsend.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on tempsend.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008722", label="Incident ID", disabled=True)
