...
def bluf(mo):
    mo.md(
        r"""
        # Explicit Logon (Suspicious Process)
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Alter on explicit credential logons with suspicous processes like powershell and wmic which are often abused by malware like Cobalt Strike.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1303298", label="Incident ID", disabled=True)
