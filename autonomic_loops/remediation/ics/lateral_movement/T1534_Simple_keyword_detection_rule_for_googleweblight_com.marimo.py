...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for googleweblight.com
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on googleweblight.com tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006785", label="Incident ID", disabled=True)
