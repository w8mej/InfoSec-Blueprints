...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for chaos
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on chaos tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007517", label="Incident ID", disabled=True)
