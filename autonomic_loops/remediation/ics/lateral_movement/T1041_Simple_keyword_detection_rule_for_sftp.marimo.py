...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sftp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sftp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003640", label="Incident ID", disabled=True)
