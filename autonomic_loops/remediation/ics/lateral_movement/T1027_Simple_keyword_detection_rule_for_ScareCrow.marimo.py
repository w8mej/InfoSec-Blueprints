...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ScareCrow
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ScareCrow tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001245", label="Incident ID", disabled=True)
