...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for BeRoot
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on BeRoot tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003222", label="Incident ID", disabled=True)
