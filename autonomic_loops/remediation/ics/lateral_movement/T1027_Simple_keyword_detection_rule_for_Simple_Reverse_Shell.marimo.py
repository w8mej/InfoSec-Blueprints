...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Simple-Reverse-Shell
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Simple-Reverse-Shell tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001547", label="Incident ID", disabled=True)
