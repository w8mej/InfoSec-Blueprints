...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Browser-C2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Browser-C2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006780", label="Incident ID", disabled=True)
