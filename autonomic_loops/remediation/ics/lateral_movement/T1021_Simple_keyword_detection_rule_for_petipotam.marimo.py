...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for petipotam
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on petipotam tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000843", label="Incident ID", disabled=True)
