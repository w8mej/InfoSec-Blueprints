...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SMBeagle
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SMBeagle tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004080", label="Incident ID", disabled=True)
