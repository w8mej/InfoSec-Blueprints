...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for fcrackzip
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on fcrackzip tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008561", label="Incident ID", disabled=True)
