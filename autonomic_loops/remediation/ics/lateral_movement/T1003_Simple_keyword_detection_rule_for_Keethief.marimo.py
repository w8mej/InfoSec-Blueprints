...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Keethief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Keethief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006042", label="Incident ID", disabled=True)
