...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for revsocks
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on revsocks tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003998", label="Incident ID", disabled=True)
