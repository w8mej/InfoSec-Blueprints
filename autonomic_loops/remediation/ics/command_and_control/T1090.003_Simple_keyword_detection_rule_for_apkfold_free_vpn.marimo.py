...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for apkfold free vpn
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on apkfold free vpn tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004302", label="Incident ID", disabled=True)
