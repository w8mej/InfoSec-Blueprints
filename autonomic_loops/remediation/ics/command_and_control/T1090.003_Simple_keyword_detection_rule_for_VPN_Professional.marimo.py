...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPN Professional
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPN Professional tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902846", label="Incident ID", disabled=True)
