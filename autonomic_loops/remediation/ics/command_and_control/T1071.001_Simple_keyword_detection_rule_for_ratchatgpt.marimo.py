...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ratchatgpt
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ratchatgpt tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009071", label="Incident ID", disabled=True)
