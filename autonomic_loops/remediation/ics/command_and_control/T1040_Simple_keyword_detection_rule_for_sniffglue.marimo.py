...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sniffglue
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sniffglue tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005623", label="Incident ID", disabled=True)
