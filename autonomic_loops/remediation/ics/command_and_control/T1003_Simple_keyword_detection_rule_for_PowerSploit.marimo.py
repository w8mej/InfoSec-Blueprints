...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PowerSploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PowerSploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006942", label="Incident ID", disabled=True)
