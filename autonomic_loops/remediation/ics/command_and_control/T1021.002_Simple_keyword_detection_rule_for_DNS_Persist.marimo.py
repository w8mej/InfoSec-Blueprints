...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DNS-Persist
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DNS-Persist tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="904286", label="Incident ID", disabled=True)
