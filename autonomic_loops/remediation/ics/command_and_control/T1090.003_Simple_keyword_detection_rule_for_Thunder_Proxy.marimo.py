...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Thunder Proxy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Thunder Proxy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007156", label="Incident ID", disabled=True)
