...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for redis-rce
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on redis-rce tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003156", label="Incident ID", disabled=True)
