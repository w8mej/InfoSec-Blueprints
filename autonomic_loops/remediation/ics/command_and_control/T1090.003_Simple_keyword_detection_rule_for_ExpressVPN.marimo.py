...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ExpressVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ExpressVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003990", label="Incident ID", disabled=True)
