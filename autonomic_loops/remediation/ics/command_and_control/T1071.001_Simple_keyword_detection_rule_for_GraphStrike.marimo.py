...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GraphStrike
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GraphStrike tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008119", label="Incident ID", disabled=True)
