...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for FunctionalC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on FunctionalC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008313", label="Incident ID", disabled=True)
