...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LANs.py
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LANs.py tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008094", label="Incident ID", disabled=True)
