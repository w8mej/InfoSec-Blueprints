...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free Proxy VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free Proxy VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005986", label="Incident ID", disabled=True)
