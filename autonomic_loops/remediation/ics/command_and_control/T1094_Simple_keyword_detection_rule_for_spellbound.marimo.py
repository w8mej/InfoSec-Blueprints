...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for spellbound
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on spellbound tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005893", label="Incident ID", disabled=True)
