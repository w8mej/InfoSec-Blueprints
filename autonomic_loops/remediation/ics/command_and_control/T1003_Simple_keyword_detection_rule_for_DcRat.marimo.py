...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DcRat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DcRat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003165", label="Incident ID", disabled=True)
