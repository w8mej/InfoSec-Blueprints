...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Malus VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Malus VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007086", label="Incident ID", disabled=True)
