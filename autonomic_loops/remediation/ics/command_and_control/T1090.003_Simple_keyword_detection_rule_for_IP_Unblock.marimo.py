...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for IP Unblock
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on IP Unblock tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008200", label="Incident ID", disabled=True)
