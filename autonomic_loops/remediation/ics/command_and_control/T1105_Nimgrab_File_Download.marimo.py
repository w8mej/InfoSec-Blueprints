...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects usage of nimgrab, a tool bundled with the Nim programming framework, downloading a file. This can be normal behaviour on developer systems.
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1300801", label="Incident ID", disabled=True)
