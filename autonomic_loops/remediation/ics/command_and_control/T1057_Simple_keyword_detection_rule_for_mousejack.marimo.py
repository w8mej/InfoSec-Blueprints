...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for mousejack
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on mousejack tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000204", label="Incident ID", disabled=True)
