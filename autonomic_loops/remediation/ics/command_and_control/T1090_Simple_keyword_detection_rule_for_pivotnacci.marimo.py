...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pivotnacci
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pivotnacci tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005940", label="Incident ID", disabled=True)
