...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for SeeYouCM-Thief
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on SeeYouCM-Thief tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007017", label="Incident ID", disabled=True)
