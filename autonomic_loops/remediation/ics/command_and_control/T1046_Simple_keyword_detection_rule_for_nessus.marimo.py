...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for nessus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on nessus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000935", label="Incident ID", disabled=True)
