...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for redpill
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on redpill tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000749", label="Incident ID", disabled=True)
