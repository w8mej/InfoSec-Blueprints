...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vsftpd
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vsftpd tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002774", label="Incident ID", disabled=True)
