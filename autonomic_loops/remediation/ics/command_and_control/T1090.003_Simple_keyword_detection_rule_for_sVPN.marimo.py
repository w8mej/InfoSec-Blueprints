...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for sVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on sVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003338", label="Incident ID", disabled=True)
