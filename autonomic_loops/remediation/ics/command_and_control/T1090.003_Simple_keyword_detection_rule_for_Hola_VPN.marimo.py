...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Hola VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Hola VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000306", label="Incident ID", disabled=True)
