...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for awesome-scapy
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on awesome-scapy tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000308", label="Incident ID", disabled=True)
