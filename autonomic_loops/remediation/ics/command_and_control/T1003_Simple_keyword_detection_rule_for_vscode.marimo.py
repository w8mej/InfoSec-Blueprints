...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for vscode
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on vscode tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905551", label="Incident ID", disabled=True)
