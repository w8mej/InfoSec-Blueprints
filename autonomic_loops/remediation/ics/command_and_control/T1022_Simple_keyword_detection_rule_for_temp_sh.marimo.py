...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for temp.sh
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on temp.sh tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007102", label="Incident ID", disabled=True)
