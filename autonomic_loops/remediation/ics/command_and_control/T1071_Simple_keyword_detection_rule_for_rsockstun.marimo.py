...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rsockstun
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rsockstun tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001803", label="Incident ID", disabled=True)
