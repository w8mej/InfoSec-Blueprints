...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Invoke-TmpDavFS
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Invoke-TmpDavFS tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003380", label="Incident ID", disabled=True)
