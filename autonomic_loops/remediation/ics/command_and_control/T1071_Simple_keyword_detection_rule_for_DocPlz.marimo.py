...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for DocPlz
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on DocPlz tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009260", label="Incident ID", disabled=True)
