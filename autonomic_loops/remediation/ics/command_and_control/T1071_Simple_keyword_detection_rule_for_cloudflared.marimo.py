...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for cloudflared
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on cloudflared tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006679", label="Incident ID", disabled=True)
