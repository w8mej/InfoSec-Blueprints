...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GC2-sheet
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GC2-sheet tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001902", label="Incident ID", disabled=True)
