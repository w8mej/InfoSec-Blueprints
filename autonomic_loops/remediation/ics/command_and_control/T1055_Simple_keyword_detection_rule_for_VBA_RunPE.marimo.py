...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VBA-RunPE
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VBA-RunPE tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005242", label="Incident ID", disabled=True)
