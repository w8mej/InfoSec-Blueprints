...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Throwback
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Throwback tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004801", label="Incident ID", disabled=True)
