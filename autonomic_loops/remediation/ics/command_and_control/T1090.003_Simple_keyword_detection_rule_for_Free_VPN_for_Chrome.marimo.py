...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Free VPN for Chrome
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Free VPN for Chrome tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005230", label="Incident ID", disabled=True)
