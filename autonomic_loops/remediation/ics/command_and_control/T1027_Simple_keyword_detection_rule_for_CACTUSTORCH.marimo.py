...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for CACTUSTORCH
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on CACTUSTORCH tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006741", label="Incident ID", disabled=True)
