...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for xrdp
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on xrdp tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009176", label="Incident ID", disabled=True)
