...
def bluf(mo):
    mo.md(
        ...
        >
        > Detects scenario where a file with a ".tmp" (temporary) file extension is created remotely in the System32 folder. This Sigma query is designed to accompany the Corelight Threat Hunting Guide, which can be found here: https://www3.corelight.com/corelights-introductory-guide-to-threat-hunting-with-zeek-bro-logs
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="100017", label="Incident ID", disabled=True)
