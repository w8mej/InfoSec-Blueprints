...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for routersploit
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on routersploit tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009952", label="Incident ID", disabled=True)
