...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VPN-free.pro
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VPN-free.pro tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002304", label="Incident ID", disabled=True)
