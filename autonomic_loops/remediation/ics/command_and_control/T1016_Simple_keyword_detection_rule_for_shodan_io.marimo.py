...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for shodan.io
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on shodan.io tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="907585", label="Incident ID", disabled=True)
