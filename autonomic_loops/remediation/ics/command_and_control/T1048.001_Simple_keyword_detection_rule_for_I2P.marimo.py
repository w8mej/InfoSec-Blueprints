...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for I2P
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on I2P tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50002585", label="Incident ID", disabled=True)
