...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Greenwolf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Greenwolf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009417", label="Incident ID", disabled=True)
