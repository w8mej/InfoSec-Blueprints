...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for pywsus
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on pywsus tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004306", label="Incident ID", disabled=True)
