...
def bluf(mo):
    mo.md(
        r"""
        # Use of Anydesk Remote Access Software from Suspicious Folder
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="1306079", label="Incident ID", disabled=True)
