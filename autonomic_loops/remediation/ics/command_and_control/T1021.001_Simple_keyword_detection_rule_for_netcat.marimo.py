...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for netcat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on netcat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007428", label="Incident ID", disabled=True)
