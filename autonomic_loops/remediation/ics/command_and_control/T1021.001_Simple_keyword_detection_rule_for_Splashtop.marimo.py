...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Splashtop
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Splashtop tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003847", label="Incident ID", disabled=True)
