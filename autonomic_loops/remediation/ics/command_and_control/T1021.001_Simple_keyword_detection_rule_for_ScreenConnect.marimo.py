...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ScreenConnect
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ScreenConnect tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003798", label="Incident ID", disabled=True)
