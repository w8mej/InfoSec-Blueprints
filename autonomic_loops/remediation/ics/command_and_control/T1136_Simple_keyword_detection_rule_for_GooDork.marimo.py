...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for GooDork
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on GooDork tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50008306", label="Incident ID", disabled=True)
