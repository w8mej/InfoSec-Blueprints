...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for kali-anonsurf
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on kali-anonsurf tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001647", label="Incident ID", disabled=True)
