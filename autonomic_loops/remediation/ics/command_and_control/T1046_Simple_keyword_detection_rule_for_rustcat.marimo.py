...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for rustcat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on rustcat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000965", label="Incident ID", disabled=True)
