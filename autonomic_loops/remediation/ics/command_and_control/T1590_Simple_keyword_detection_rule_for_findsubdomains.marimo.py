...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for findsubdomains
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on findsubdomains tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50005926", label="Incident ID", disabled=True)
