...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for NovaLdr
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on NovaLdr tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007321", label="Incident ID", disabled=True)
