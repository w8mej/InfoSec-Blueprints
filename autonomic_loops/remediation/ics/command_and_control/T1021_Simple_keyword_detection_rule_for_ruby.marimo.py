...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ruby
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ruby tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="905188", label="Incident ID", disabled=True)
