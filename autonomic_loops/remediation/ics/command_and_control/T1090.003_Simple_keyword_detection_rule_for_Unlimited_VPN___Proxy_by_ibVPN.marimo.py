...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Unlimited VPN & Proxy by ibVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Unlimited VPN & Proxy by ibVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006918", label="Incident ID", disabled=True)
