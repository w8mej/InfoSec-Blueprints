...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Bomgar
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Bomgar tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001967", label="Incident ID", disabled=True)
