...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Nucleus VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Nucleus VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004919", label="Incident ID", disabled=True)
