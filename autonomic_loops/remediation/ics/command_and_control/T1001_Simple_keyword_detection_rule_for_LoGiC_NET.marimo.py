...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for LoGiC.NET
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on LoGiC.NET tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009379", label="Incident ID", disabled=True)
