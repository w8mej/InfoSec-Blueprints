...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wmic
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wmic tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="902516", label="Incident ID", disabled=True)
