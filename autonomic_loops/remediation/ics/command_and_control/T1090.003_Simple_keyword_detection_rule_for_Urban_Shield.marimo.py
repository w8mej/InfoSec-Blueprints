...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Urban Shield
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Urban Shield tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006731", label="Incident ID", disabled=True)
