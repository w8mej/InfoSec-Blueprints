...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for PureVPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on PureVPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50003836", label="Incident ID", disabled=True)
