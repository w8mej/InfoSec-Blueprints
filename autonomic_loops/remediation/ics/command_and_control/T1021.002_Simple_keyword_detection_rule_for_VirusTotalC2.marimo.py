...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for VirusTotalC2
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on VirusTotalC2 tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001741", label="Incident ID", disabled=True)
