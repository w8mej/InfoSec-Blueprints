...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Tunnello VPN
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Tunnello VPN tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50009580", label="Incident ID", disabled=True)
