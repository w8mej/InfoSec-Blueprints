...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for StarFighters
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on StarFighters tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50006217", label="Incident ID", disabled=True)
