...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Google Remote Desktop
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Google Remote Desktop tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50004476", label="Incident ID", disabled=True)
