...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ppldump
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ppldump tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000186", label="Incident ID", disabled=True)
