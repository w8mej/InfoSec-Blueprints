...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for dns
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on dns tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50000578", label="Incident ID", disabled=True)
