...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for wstunnel
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on wstunnel tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50001272", label="Incident ID", disabled=True)
