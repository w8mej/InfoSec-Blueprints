...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for ToRat
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on ToRat tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007586", label="Incident ID", disabled=True)
