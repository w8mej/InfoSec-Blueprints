...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Private Internet Access
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Private Internet Access tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="909741", label="Incident ID", disabled=True)
