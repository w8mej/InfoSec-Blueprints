...
def bluf(mo):
    mo.md(
        r"""
        # Simple keyword detection rule for Mobile-Security-Framework
        
        > [!CAUTION]
        > **MEDIUM SEVERITY** | **ASO PLAYBOOK**
        >
        > Detects interesting keywords based on Mobile-Security-Framework tool
        >
...
def params(mo):
    ...
    incident_id = mo.ui.text(value="50007245", label="Incident ID", disabled=True)
