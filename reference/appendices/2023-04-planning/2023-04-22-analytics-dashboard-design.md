...
therefore combines genuine extractable signals with deterministically-lean4 assurance so
every chart has meaningful data.
...
```jsonc
{
  ...
  "data_note": "Metrics are seeded from structural playbook characteristics.",
  "summary": {
    "total_playbooks": 998,
    "total_cacao": 426,
